...
export default function DockerNetworkTable({
  ...
  if (networks.length === 0) {
    return <div className="text-zinc-600 text-xs px-3 py-2">无网络</div>;
  }
          ...
          {networks.map((n) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-2 py-0.5 text-zinc-500">{n.driver}</td>
                <td className="px-2 py-0.5 text-zinc-600">{n.scope}</td>
                <td className="px-2 py-0.5 text-zinc-500">
                  {n.ipamSubnet || "-"}
                </td>
                <td className="px-2 py-0.5 text-zinc-600">
                  {n.ipamGateway || "-"}
                </td>

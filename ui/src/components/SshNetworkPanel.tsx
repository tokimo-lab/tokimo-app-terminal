...
const interfaceColumns: SshColumn<SshNetworkInterfaceEntry>[] = [
  {
    key: "name",
    header: "接口",
    width: "140px",
...
const listeningColumns: SshColumn<SshListeningSocketEntry>[] = [
  {
    key: "protocol",
    header: "协议",
    width: "80px",
...
const connectionColumns: SshColumn<SshConnectionEntry>[] = [
  {
    key: "protocol",
    header: "协议",
    width: "80px",
...
const routeColumns: SshColumn<SshRouteEntry>[] = [
  {
    key: "destination",
    header: "目标",

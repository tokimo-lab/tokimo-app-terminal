    ...
    async (
      ...
      const fns = {
        start: (containerId: string) =>
          terminalApi.dockerStart(terminalId, containerId),
        stop: (containerId: string) =>
          terminalApi.dockerStop(terminalId, containerId),
        restart: (containerId: string) =>
          terminalApi.dockerRestart(terminalId, containerId),
        pause: (containerId: string) =>
          terminalApi.dockerPause(terminalId, containerId),
        unpause: (containerId: string) =>
          terminalApi.dockerUnpause(terminalId, containerId),
        rm: (containerId: string) =>
          terminalApi.dockerRm(terminalId, containerId),
      };
      try {
        await fns[action](containerId);

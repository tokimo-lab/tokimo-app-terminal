import { RuntimeProvider as e, defineApp as t } from "@tokimo/sdk";
import { ConfigProvider as n, ToastProvider as r } from "@tokimo/ui";
import { StrictMode as i, createContext as a, createElement as o, forwardRef as s, useCallback as c, useContext as l, useEffect as u, useMemo as d, useRef as f, useState as p } from "react";
import { createRoot as m } from "react-dom/client";
import { jsx as h, jsxs as g } from "react/jsx-runtime";
//#region \0rolldown/runtime.js
var _ = Object.defineProperty, v = (e, t) => () => (e && (t = e(e = 0)), t), ee = (e, t) => {
	let n = {};
...
}, te = a(null).Provider, ne = "/api/apps/terminal";
async function y(e, t) {
	let n = await fetch(`${ne}${e}`, {
		credentials: "include",
		...t
	}), r = await n.text(), i = r ? JSON.parse(r) : void 0;
	if (!n.ok) throw Error(i?.error ?? `${n.status} ${n.statusText}`);
	if (!i?.success) throw Error(i?.error ?? "API request failed");
	return i.data;
}
function re(e, t) {
	return {
...
function ie(e) {
	return `${window.location.protocol === "https:" ? "wss" : "ws"}://${window.location.host}${ne}${e}`;
}
var b = {
	list: () => y("/connections"),
	create: (e) => y("/connections", re("POST", e)),
	update: (e, t) => y(`/connections/${encodeURIComponent(e)}`, re("PATCH", t)),
	delete: (e) => y(`/connections/${encodeURIComponent(e)}`, { method: "DELETE" }),
	stats: (e) => y(`/connections/${encodeURIComponent(e)}/stats`),
	ps: (e) => y(`/connections/${encodeURIComponent(e)}/ps`),
	df: (e) => y(`/connections/${encodeURIComponent(e)}/df`),
	net: (e) => y(`/connections/${encodeURIComponent(e)}/net`),
	ls: (e, t) => y(`/connections/${encodeURIComponent(e)}/ls?path=${encodeURIComponent(t)}`),
	mkdir: (e, t) => y(`/connections/${encodeURIComponent(e)}/mkdir`, re("POST", { path: t })),
	rm: (e, t) => y(`/connections/${encodeURIComponent(e)}/rm`, re("POST", { path: t })),
	readFile: (e, t) => y(`/connections/${encodeURIComponent(e)}/read-file`, re("POST", { path: t })),
	writeFile: (e, t, n) => y(`/connections/${encodeURIComponent(e)}/write-file`, re("POST", {
		path: t,
		content: n
	})),
	docker: (e, t) => y(`/connections/${encodeURIComponent(e)}/docker/${t}`)
};
//#endregion
//#region src/hooks/useAsync.ts
function ae(e, t) {
	let [n, r] = p(null), [i, a] = p(!0), [o, s] = p(null), [l, d] = p(0), f = c(() => d((e) => e + 1), []);
	return u(() => {
		let t = !1;
		return a(!0), s(null), e().then((e) => {
			t || r(e);
		}).catch((e) => {
...
//#endregion
//#region src/components/ConnectionForm.tsx
function x({ terminal: e, saving: t, onCancel: n, onSave: r }) {
	let [i, a] = p(() => oe(e));
	u(() => a(oe(e)), [e]);
	let o = (e, t) => {
		a((n) => ({
	...
	return /* @__PURE__ */ g("form", {
		...
		children: [
			/* @__PURE__ */ h("div", {
				...
				children: e ? "Edit SSH connection" : "New SSH connection"
			}),
			/* @__PURE__ */ g("label", {
			...
			/* @__PURE__ */ g("div", {
				...
				children: [/* @__PURE__ */ g("label", {
					className: "grid gap-1 text-xs text-zinc-400",
					children: ["Host", /* @__PURE__ */ h("input", {
						className: "rounded-md border border-white/10 bg-zinc-900 px-3 py-2 text-sm text-zinc-100",
						value: i.host,
						onChange: (e) => o("host", e.target.value),
						required: !0
					})]
				}), /* @__PURE__ */ g("label", {
					className: "grid gap-1 text-xs text-zinc-400",
					children: ["Port", /* @__PURE__ */ h("input", {
						className: "rounded-md border border-white/10 bg-zinc-900 px-3 py-2 text-sm text-zinc-100",
						type: "number",
						value: i.port ?? 22,
						onChange: (e) => o("port", Number(e.target.value))
					})]
				})]
			}),
			/* @__PURE__ */ g("label", {
				className: "grid gap-1 text-xs text-zinc-400",
				children: ["Username", /* @__PURE__ */ h("input", {
					className: "rounded-md border border-white/10 bg-zinc-900 px-3 py-2 text-sm text-zinc-100",
					value: i.username,
			...
			/* @__PURE__ */ g("label", {
				className: "grid gap-1 text-xs text-zinc-400",
				children: ["Auth method", /* @__PURE__ */ g("select", {
					className: "rounded-md border border-white/10 bg-zinc-900 px-3 py-2 text-sm text-zinc-100",
					value: i.authMethod ?? "password",
					onChange: (e) => o("authMethod", e.target.value),
			...
			(i.authMethod ?? "password") === "password" ? /* @__PURE__ */ g("label", {
				className: "grid gap-1 text-xs text-zinc-400",
				children: [
					"Password ",
					e ? "(leave blank to keep)" : "",
					/* @__PURE__ */ h("input", {
						className: "rounded-md border border-white/10 bg-zinc-900 px-3 py-2 text-sm text-zinc-100",
						type: "password",
						value: i.password ?? "",
						onChange: (e) => o("password", e.target.value || void 0),
						required: !e
					})
				]
			}) : /* @__PURE__ */ g("label", {
				...
				children: [
					...
					/* @__PURE__ */ h("textarea", {
						...
						value: i.privateKey ?? "",
						onChange: (e) => o("privateKey", e.target.value || void 0),
						required: !e
					})
				]
			}),
			/* @__PURE__ */ g("label", {
				className: "grid gap-1 text-xs text-zinc-400",
				children: ["Startup command", /* @__PURE__ */ h("input", {
					className: "rounded-md border border-white/10 bg-zinc-900 px-3 py-2 text-sm text-zinc-100",
					value: i.startupCommand ?? "",
					onChange: (e) => o("startupCommand", e.target.value || void 0)
				})]
			}),
			/* @__PURE__ */ g("label", {
				className: "grid gap-1 text-xs text-zinc-400",
				children: ["Notes", /* @__PURE__ */ h("textarea", {
					className: "rounded-md border border-white/10 bg-zinc-900 px-3 py-2 text-sm text-zinc-100",
					value: i.notes ?? "",
					onChange: (e) => o("notes", e.target.value || void 0)
				})]
			}),
			/* @__PURE__ */ g("div", {
...
function oe(e) {
	return {
		...
		startupCommand: e?.startupCommand ?? void 0,
...
var S = (...e) => e.filter((e, t, n) => !!e && e.trim() !== "" && n.indexOf(e) === t).join(" ").trim(), se = (e) => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase(), ce = (e) => e.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, t, n) => n ? n.toUpperCase() : t.toLowerCase()), le = (e) => {
	let t = ce(e);
	...
	return !1;
}, de = a({}), fe = () => l(de), pe = s(({ color: e, size: t, strokeWidth: n, absoluteStrokeWidth: r, className: i = "", children: a, iconNode: s, ...c }, l) => {
	let { size: u = 24, strokeWidth: d = 2, absoluteStrokeWidth: f = !1, color: p = "currentColor", className: m = "" } = fe() ?? {}, h = r ?? f ? Number(n ?? d) * 24 / Number(t ?? u) : n ?? d;
	return o("svg", {
		ref: l,
		...C,
		width: t ?? u ?? C.width,
		...
		stroke: e ?? p,
		strokeWidth: h,
		className: S("lucide", m, i),
		...!a && !ue(c) && { "aria-hidden": "true" },
		...c
	}, [...s.map(([e, t]) => o(e, t)), ...Array.isArray(a) ? a : [a]]);
}), me = (e, t) => {
	let n = s(({ className: n, ...r }, i) => o(pe, {
		ref: i,
		iconNode: t,
		className: S(`lucide-${se(le(e))}`, `lucide-${e}`, n),
		...r
	}));
...
//#endregion
//#region src/components/ConnectionList.tsx
function we({ terminals: e, selectedId: t, loading: n, onSelect: r, onCreate: i, onEdit: a, onDelete: o }) {
	return /* @__PURE__ */ g("aside", {
		className: "flex w-72 shrink-0 flex-col border-r border-white/10 bg-zinc-950/70",
		children: [/* @__PURE__ */ g("div", {
			...
			children: [/* @__PURE__ */ g("div", { children: [/* @__PURE__ */ h("div", {
				...
				children: "Local PTY and SSH"
			})] }), /* @__PURE__ */ h("button", {
				type: "button",
				className: "cursor-pointer rounded-md bg-violet-600 p-2 text-white hover:bg-violet-500",
				onClick: i,
				"aria-label": "New connection",
				children: /* @__PURE__ */ h(be, { className: "h-4 w-4" })
			})]
		}), /* @__PURE__ */ g("div", {
			className: "flex-1 overflow-auto p-2",
			children: [
				n && /* @__PURE__ */ h("div", {
					className: "p-3 text-xs text-zinc-500",
					children: "Loading…"
				}),
				e.map((e) => /* @__PURE__ */ g("div", {
					className: `group mb-1 rounded-lg border px-3 py-2 ${t === e.id ? "border-violet-500/60 bg-violet-500/10" : "border-transparent hover:bg-white/5"}`,
					children: [/* @__PURE__ */ g("button", {
						type: "button",
						className: "flex w-full cursor-pointer items-start gap-2 text-left",
						onClick: () => r(e.id),
						children: [/* @__PURE__ */ h(ve, { className: "mt-0.5 h-4 w-4 text-violet-400" }), /* @__PURE__ */ g("span", {
						...
						className: "mt-2 hidden justify-end gap-1 group-hover:flex",
						children: [/* @__PURE__ */ h("button", {
							type: "button",
							className: "cursor-pointer rounded p-1 text-zinc-400 hover:bg-white/10",
							onClick: () => a(e),
							children: /* @__PURE__ */ h(ye, { className: "h-3.5 w-3.5" })
						}), /* @__PURE__ */ h("button", {
							type: "button",
							className: "cursor-pointer rounded p-1 text-red-300 hover:bg-red-500/10",
							onClick: () => o(e),
							children: /* @__PURE__ */ h(Ce, { className: "h-3.5 w-3.5" })
						})]
					})]
				}, e.id)),
				!n && e.length === 0 && /* @__PURE__ */ h("div", {
					className: "p-3 text-xs text-zinc-500",
					children: "No SSH connections yet."
				})
			]
		})]
	});
...
var Te = /* @__PURE__ */ ee({ Terminal: () => wc });
function Ee(e) {
	return e.replace(/\r?\n/g, "\r");
}
function De(e, t) {
...
function ke(e, t, n, r) {
	e.stopPropagation(), e.clipboardData && Ae(e.clipboardData.getData("text/plain"), t, n, r);
}
function Ae(e, t, n, r) {
	e = Ee(e), e = De(e, n.decPrivateModes.bracketedPasteMode && r.rawOptions.ignoreBracketedPasteMode !== !0), n.triggerDataEvent(e, !0), t.value = "";
}
function je(e, t, n) {
	let r = n.getBoundingClientRect(), i = e.clientX - r.left - 10, a = e.clientY - r.top - 10;
	t.style.width = "20px", t.style.height = "20px", t.style.left = `${i}px`, t.style.top = `${a}px`, t.style.zIndex = "1000", t.focus();
}
function Me(e, t, n, r, i) {
	je(e, t, n), i && r.rightClickSelect(e), t.value = r.selectionText, t.select();
}
function Ne(e) {
	return e > 65535 ? (e -= 65536, String.fromCharCode((e >> 10) + 55296) + String.fromCharCode(e % 1024 + 56320)) : String.fromCharCode(e);
}
function Pe(e, t = 0, n = e.length) {
	let r = "";
	for (let i = t; i < n; ++i) {
		let t = e[i];
...
function Re(e) {
	ze(e) || rr.onUnexpectedError(e);
}
function ze(e) {
	return e instanceof ar ? !0 : e instanceof Error && e.name === ir && e.message === ir;
}
function Be(e) {
	return Error(e ? `Illegal argument: ${e}` : "Illegal argument");
}
function Ve(e, t, n = 0, r = e.length) {
	let i = n, a = r;
	for (; i < a;) {
...
function Xe(e, t) {
	if (hr) for (let n of e) hr.setParent(n, t);
}
function Ze(e) {
	return hr?.markAsSingleton(e), e;
}
function Qe(e) {
	if (pr.is(e)) {
		let t = [];
...
function rt(e) {
	...
	else if (Kr && (ci && t === 93 || !ci && t === 92)) return 57;
	return xi[t] || 0;
}
function it(e) {
...
function lt(e, t) {
	switch (typeof e) {
		case "object": return e === null ? ut(349, t) : Array.isArray(e) ? pt(e, t) : mt(e, t);
		case "string": return ft(e, t);
		case "boolean": return dt(e, t);
		case "number": return ut(e, t);
		case "undefined": return ut(937, t);
		default: return ut(617, t);
	}
}
function ut(e, t) {
	return (t << 5) - t + e | 0;
...
function ft(e, t) {
	t = ut(149417, t);
	for (let n = 0, r = e.length; n < r; n++) t = ut(e.charCodeAt(n), t);
	return t;
}
function pt(e, t) {
	return t = ut(104579, t), e.reduce((e, t) => lt(t, e), t);
}
function mt(e, t) {
	return t = ut(181387, t), Object.keys(e).sort().reduce((t, n) => (t = ft(n, t), lt(e[n], t)), t);
}
function ht(e, t, n = 32) {
	let r = n - t, i = ~((1 << r) - 1);
	return (e << t | (i & e) >>> r) >>> 0;
}
function gt(e, t = 0, n = e.byteLength, r = 0) {
...
function vt(e, t = 32) {
	return e instanceof ArrayBuffer ? Array.from(new Uint8Array(e)).map((e) => e.toString(16).padStart(2, "0")).join("") : _t((e >>> 0).toString(16), t / 4);
}
function E(e, t, n, r) {
...
function xt(e) {
	let t = e.getBoundingClientRect(), n = Ui(e);
	return {
...
function St(e, t, n, ...r) {
	...
	let a = i[1] || "div", o;
	return o = e === "http://www.w3.org/1999/xhtml" ? document.createElement(a) : document.createElementNS(e, a), i[3] && (o.id = i[3]), i[4] && (o.className = i[4].replace(/\./g, " ").trim()), n && Object.entries(n).forEach(([e, t]) => {
		typeof t > "u" || (/^on\w+$/.test(e) ? o[e] = t : e === "selected" ? t && o.setAttribute(e, "true") : o.setAttribute(e, t));
	}), o.append(...r), o;
}
function Ct(e, t, ...n) {
	return St("http://www.w3.org/1999/xhtml", e, t, ...n);
}
function D(e) {
...
function Tt(e, t, n) {
	let r = null, i = null;
	if (typeof n.value == "function" ? (r = "value", i = n.value, i.length !== 0 && console.warn("Memoize should only be used in functions with zero parameters")) : typeof n.get == "function" && (r = "get", i = n.get), !i) throw Error("not supported");
	let a = `$memoize$${t}`;
	n[r] = function(...e) {
...
function At(e) {
	...
	return t.horizontalSliderSize = typeof e.horizontalSliderSize < "u" ? e.horizontalSliderSize : t.horizontalScrollbarSize, t.verticalSliderSize = typeof e.verticalSliderSize < "u" ? e.verticalSliderSize : t.verticalScrollbarSize, ci && (t.className += " mac"), t;
}
function jt(e) {
	let t = e.toString(16);
...
function Bt(e, t, n) {
	let r = n.getBoundingClientRect(), i = e.getComputedStyle(n), a = parseInt(i.getPropertyValue("padding-left")), o = parseInt(i.getPropertyValue("padding-top"));
	return [t.clientX - r.left - a, t.clientY - r.top - o];
}
function Vt(e, t, n, r, i, a, o, s, c) {
	if (!a) return;
	let l = Bt(e, t, n);
	if (l) return l[0] = Math.ceil((l[0] + (c ? o / 2 : 0)) / o), l[1] = Math.ceil(l[1] / s), l[0] = Math.min(Math.max(l[0], 1), r + +!!c), l[1] = Math.min(Math.max(l[1], 1), i), l;
}
function Ht() {
	if (!yo) return 0;
	let e = ho.match(/Version\/(\d+)/);
	return e === null || e.length < 2 ? 0 : parseInt(e[1]);
}
function Ut(e, t, n, r) {
	let i = n.buffer.x, a = n.buffer.y;
	if (!n.buffer.hasScrollback) return Kt(i, a, e, t, n, r) + qt(a, t, n, r) + Jt(i, a, e, t, n, r);
	let o;
	if (a === t) return o = i > e ? "D" : "C", tn(Math.abs(i - e), en(o, r));
	o = a > t ? "D" : "C";
	let s = Math.abs(a - t);
	return tn(Gt(a > t ? e : i, n) + (s - 1) * n.cols + 1 + Wt(a > t ? i : e, n), en(o, r));
}
function Wt(e, t) {
	return e - 1;
}
...
function Kt(e, t, n, r, i, a) {
	return qt(t, r, i, a).length === 0 ? "" : tn($t(e, t, e, t - Xt(t, i), !1, i).length, en("D", a));
}
function qt(e, t, n, r) {
	let i = e - Xt(e, n), a = t - Xt(t, n);
	return tn(Math.abs(i - a) - Yt(e, t, n), en(Qt(e, t), r));
}
function Jt(e, t, n, r, i, a) {
	let o;
	o = qt(t, r, i, a).length > 0 ? r - Xt(r, i) : t;
	let s = r, c = Zt(e, t, n, r, i, a);
	return tn($t(e, o, n, s, c === "C", i).length, en(c, a));
}
function Yt(e, t, n) {
	let r = 0, i = e - Xt(e, n), a = t - Xt(t, n);
...
function Zt(e, t, n, r, i, a) {
	let o;
	return o = qt(n, r, i, a).length > 0 ? r - Xt(r, i) : t, e < n && o <= r || e >= n && o < r ? "C" : "D";
}
function Qt(e, t) {
	return e > t ? "A" : "B";
}
function $t(e, t, n, r, i, a) {
	let o = e, s = t, c = "";
	for (; (o !== n || s !== r) && s >= 0 && s < a.buffer.lines.length;) o += i ? 1 : -1, i && o > a.cols - 1 ? (c += a.buffer.translateBufferLineToString(s, !1, e, o), o = 0, e = 0, s++) : !i && o < 0 && (c += a.buffer.translateBufferLineToString(s, !1, 0, e + 1), o = a.cols - 1, e = o, s--);
...
function rn(e, t, n, r, i, a) {
	...
	for (let s = 0; s < e.length - 1; s++) {
		...
		let d = 0, f = cn(u, d, t), p = 1, m = 0;
		for (; p < u.length;) {
			let e = cn(u, p, t), r = e - m, a = n - f, o = Math.min(r, a);
			u[d].copyCellsFrom(u[p], m, f, o, !1), f += o, f === n && (d++, f = 0), m += o, m === e && (p++, m = 0), f === 0 && d !== 0 && u[d - 1].getWidth(n - 1) === 2 && (u[d].copyCellsFrom(u[d - 1], n - 1, f++, 1, !1), u[d - 1].setCell(n - 1, i));
		}
...
function an(e, t) {
	let n = [], r = 0, i = t[r], a = 0;
	for (let o = 0; o < e.length; o++) if (i === o) {
		let n = t[++r];
...
function sn(e, t, n) {
	let r = [], i = e.map((n, r) => cn(e, r, t)).reduce((e, t) => e + t), a = 0, o = 0, s = 0;
	for (; s < i;) {
		if (i - s < n) {
			r.push(i - s);
			break;
...
function un(e, t = 5) {
	...
	for (let r in e) n[r] = t <= 1 ? e[r] : e[r] && un(e[r], t - 1);
	return n;
}
function dn(e, t) {
...
function mn(e) {
	...
	} else if (t.indexOf("#") === 0 && (t = t.slice(1), Hs.exec(t) && [
		3,
		6,
		9,
		12
...
function gn(e, t = 16) {
	let [n, r, i] = e;
	return `rgb:${hn(n, t)}/${hn(r, t)}/${hn(i, t)}`;
}
function _n(e, t) {
...
function yn(e, t, n, r) {
	let i = {
		...
		cancel: !1,
		key: void 0
	}, a = !!e.shiftKey | (e.altKey ? 2 : 0) | (e.ctrlKey ? 4 : 0) | (e.metaKey ? 8 : 0);
	switch (e.keyCode) {
		case 0:
			e.key === "UIKeyInputUpArrow" ? t ? i.key = R.ESC + "OA" : i.key = R.ESC + "[A" : e.key === "UIKeyInputLeftArrow" ? t ? i.key = R.ESC + "OD" : i.key = R.ESC + "[D" : e.key === "UIKeyInputRightArrow" ? t ? i.key = R.ESC + "OC" : i.key = R.ESC + "[C" : e.key === "UIKeyInputDownArrow" && (t ? i.key = R.ESC + "OB" : i.key = R.ESC + "[B");
			break;
		case 8:
			i.key = e.ctrlKey ? "\b" : R.DEL, e.altKey && (i.key = R.ESC + i.key);
			break;
		case 9:
			if (e.shiftKey) {
				i.key = R.ESC + "[Z";
			...
			i.key = R.HT, i.cancel = !0;
			break;
		case 13:
			i.key = e.altKey ? R.ESC + R.CR : R.CR, i.cancel = !0;
			break;
		case 27:
			i.key = R.ESC, e.altKey && (i.key = R.ESC + R.ESC), i.cancel = !0;
			break;
		case 37:
			if (e.metaKey) break;
			a ? i.key = R.ESC + "[1;" + (a + 1) + "D" : t ? i.key = R.ESC + "OD" : i.key = R.ESC + "[D";
			break;
		case 39:
			if (e.metaKey) break;
			a ? i.key = R.ESC + "[1;" + (a + 1) + "C" : t ? i.key = R.ESC + "OC" : i.key = R.ESC + "[C";
			break;
		case 38:
			if (e.metaKey) break;
			a ? i.key = R.ESC + "[1;" + (a + 1) + "A" : t ? i.key = R.ESC + "OA" : i.key = R.ESC + "[A";
			break;
		case 40:
			if (e.metaKey) break;
			a ? i.key = R.ESC + "[1;" + (a + 1) + "B" : t ? i.key = R.ESC + "OB" : i.key = R.ESC + "[B";
			break;
		case 45:
			!e.shiftKey && !e.ctrlKey && (i.key = R.ESC + "[2~");
			break;
		case 46:
			a ? i.key = R.ESC + "[3;" + (a + 1) + "~" : i.key = R.ESC + "[3~";
			break;
		case 36:
			a ? i.key = R.ESC + "[1;" + (a + 1) + "H" : t ? i.key = R.ESC + "OH" : i.key = R.ESC + "[H";
			break;
		case 35:
			a ? i.key = R.ESC + "[1;" + (a + 1) + "F" : t ? i.key = R.ESC + "OF" : i.key = R.ESC + "[F";
			break;
		case 33:
			e.shiftKey ? i.type = 2 : e.ctrlKey ? i.key = R.ESC + "[5;" + (a + 1) + "~" : i.key = R.ESC + "[5~";
			break;
		case 34:
			e.shiftKey ? i.type = 3 : e.ctrlKey ? i.key = R.ESC + "[6;" + (a + 1) + "~" : i.key = R.ESC + "[6~";
			break;
		case 112:
			a ? i.key = R.ESC + "[1;" + (a + 1) + "P" : i.key = R.ESC + "OP";
			break;
		case 113:
			a ? i.key = R.ESC + "[1;" + (a + 1) + "Q" : i.key = R.ESC + "OQ";
			break;
		case 114:
			a ? i.key = R.ESC + "[1;" + (a + 1) + "R" : i.key = R.ESC + "OR";
			break;
		case 115:
			a ? i.key = R.ESC + "[1;" + (a + 1) + "S" : i.key = R.ESC + "OS";
			break;
		case 116:
			a ? i.key = R.ESC + "[15;" + (a + 1) + "~" : i.key = R.ESC + "[15~";
			break;
		case 117:
			a ? i.key = R.ESC + "[17;" + (a + 1) + "~" : i.key = R.ESC + "[17~";
			break;
		case 118:
			a ? i.key = R.ESC + "[18;" + (a + 1) + "~" : i.key = R.ESC + "[18~";
			break;
		case 119:
			a ? i.key = R.ESC + "[19;" + (a + 1) + "~" : i.key = R.ESC + "[19~";
			break;
		case 120:
			a ? i.key = R.ESC + "[20;" + (a + 1) + "~" : i.key = R.ESC + "[20~";
			break;
		case 121:
			a ? i.key = R.ESC + "[21;" + (a + 1) + "~" : i.key = R.ESC + "[21~";
			break;
		case 122:
			a ? i.key = R.ESC + "[23;" + (a + 1) + "~" : i.key = R.ESC + "[23~";
			break;
		case 123:
			a ? i.key = R.ESC + "[24;" + (a + 1) + "~" : i.key = R.ESC + "[24~";
			break;
		default:
			if (e.ctrlKey && !e.shiftKey && !e.altKey && !e.metaKey) e.keyCode >= 65 && e.keyCode <= 90 ? i.key = String.fromCharCode(e.keyCode - 64) : e.keyCode === 32 ? i.key = R.NUL : e.keyCode >= 51 && e.keyCode <= 55 ? i.key = String.fromCharCode(e.keyCode - 51 + 27) : e.keyCode === 56 ? i.key = R.DEL : e.keyCode === 219 ? i.key = R.ESC : e.keyCode === 220 ? i.key = R.FS : e.keyCode === 221 && (i.key = R.GS);
			else if ((!n || r) && e.altKey && !e.metaKey) {
				let t = rc[e.keyCode]?.[+!!e.shiftKey];
				if (t) i.key = R.ESC + t;
				else if (e.keyCode >= 65 && e.keyCode <= 90) {
					let t = e.ctrlKey ? e.keyCode - 64 : e.keyCode + 32, n = String.fromCharCode(t);
					e.shiftKey && (n = n.toUpperCase()), i.key = R.ESC + n;
				} else if (e.keyCode === 32) i.key = R.ESC + (e.ctrlKey ? R.NUL : " ");
				else if (e.key === "Dead" && e.code.startsWith("Key")) {
					let t = e.code.slice(3, 4);
					e.shiftKey || (t = t.toLowerCase()), i.key = R.ESC + t, i.cancel = !0;
				}
			} else n && !e.altKey && !e.ctrlKey && !e.shiftKey && e.metaKey ? e.keyCode === 65 && (i.type = 1) : e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && e.key.length === 1 ? i.key = e.key : e.key && e.ctrlKey && (e.key === "_" && (i.key = R.US), e.key === "@" && (i.key = R.NUL));
			break;
	}
	return i;
}
...
var Sn, Cn, wn, k, A, Tn, En, Dn, On, kn, An, jn, Mn, Nn, Pn, Fn, In, Ln, Rn, j, zn, Bn, Vn, Hn, Un, M, Wn, Gn, Kn, qn, Jn, Yn, Xn, Zn, Qn, $n, er, tr, nr, rr, ir, ar, or, sr, cr, lr, ur, dr, fr, pr, mr, hr, gr, _r, vr, N, yr, br, xr, P, Sr, Cr, wr, Tr, Er, Dr, F, Or, kr, Ar, jr, Mr, Nr, Pr, Fr, Ir, Lr, Rr, zr, Br, I, Vr, Hr, Ur, Wr, Gr, Kr, qr, Jr, Yr, Xr, Zr, Qr, $r, ei, ti, ni, ri, ii, ai, oi, si, ci, li, ui, di, fi, pi, mi, hi, gi, _i, vi, yi, bi, xi, Si, Ci, wi, Ti, Ei, Di, Oi, ki, Ai, ji, Mi, Ni, Pi, Fi, Ii, Li, Ri, zi, Bi, Vi, Hi, Ui, Wi, Gi, Ki, qi, Ji, Yi, Xi, Zi, Qi, $i, ea, ta, na, ra, ia, L, aa, oa, sa, ca, la, ua, da, fa, pa, ma, ha, ga, _a, va, ya, ba, xa, Sa, Ca, wa, Ta, Ea, Da, Oa, ka, Aa, ja, Ma, Na, Pa, Fa, Ia, La, Ra, R, za, Ba, Va, z, B, V, H, Ha, U, W, G, K, Ua, Wa, Ga, Ka, qa, Ja, Ya, Xa, Za, Qa, $a, eo, to, no, ro, io, ao, oo, so, co, lo, uo, fo, po, mo, ho, go, _o, vo, yo, bo, xo, So, Co, wo, To, Eo, Do, Oo, ko, Ao, jo, Mo, No, Po, Fo, Io, Lo, Ro, zo, Bo, Vo, q, Ho, Uo, Wo, Go, Ko, qo, Jo, Yo, Xo, Zo, Qo, $o, es, J, Y, ts, ns, rs, is, as, X, os, ss, cs, ls, us, ds, fs, ps, ms, hs, gs, _s, vs, ys, bs, xs, Ss, Cs, ws, Z, Ts, Es, Ds, Os, ks, As, js, Ms, Q, Ns, Ps, Fs, Is, Ls, Rs, zs, Bs, Vs, Hs, Us, Ws, Gs, Ks, qs, Js, Ys, Xs, Zs, Qs, $s, ec, tc, nc, rc, $, ic, ac, oc, sc, cc, lc, uc, dc, fc, pc, mc, hc, gc, _c, vc, yc, bc, xc, Sc, Cc, wc, Tc = v((() => {
	if (Sn = Object.defineProperty, Cn = Object.getOwnPropertyDescriptor, wn = (e, t) => {
		for (var n in t) Sn(e, n, {
			get: t[n],
			enumerable: !0
		});
	}, k = (e, t, n, r) => {
		for (var i = r > 1 ? void 0 : r ? Cn(t, n) : t, a = e.length - 1, o; a >= 0; a--) (o = e[a]) && (i = (r ? o(t, n, i) : o(i)) || i);
		return r && i && Sn(t, n, i), i;
	}, A = (e, t) => (n, r) => t(n, r, e), Tn = "Terminal input", En = {
		get: () => Tn,
		set: (e) => Tn = e
	}, Dn = "Too much output to announce, navigate to rows manually to read", On = {
		get: () => Dn,
		set: (e) => Dn = e
	}, kn = class {
		constructor() {
		...
		decode(e, t) {
			...
			for (let a = i; a < n; ++a) {
				...
				if (55296 <= i && i <= 56319) {
					...
					56320 <= o && o <= 57343 ? t[r++] = (i - 55296) * 1024 + o - 56320 + 65536 : (t[r++] = i, t[r++] = o);
					continue;
				}
				i !== 65279 && (t[r++] = i);
			}
		...
		decode(e, t) {
			let n = e.length;
			if (!n) return 0;
			let r = 0, i, a, o, s, c = 0, l = 0;
			if (this.interim[0]) {
				let i = !1, a = this.interim[0];
				a &= (a & 224) == 192 ? 31 : (a & 240) == 224 ? 15 : 7;
				let o = 0, s;
				for (; (s = this.interim[++o] & 63) && o < 4;) a <<= 6, a |= s;
				let c = (this.interim[0] & 224) == 192 ? 2 : (this.interim[0] & 240) == 224 ? 3 : 4, u = c - o;
				for (; l < u;) {
					if (l >= n) return 0;
					if (s = e[l++], (s & 192) != 128) {
						l--, i = !0;
				...
				i || (c === 2 ? a < 128 ? l-- : t[r++] = a : c === 3 ? a < 2048 || a >= 55296 && a <= 57343 || a === 65279 || (t[r++] = a) : a < 65536 || a > 1114111 || (t[r++] = a)), this.interim.fill(0);
			}
			let u = n - 4, d = l;
			for (; d < n;) {
				for (; d < u && !((i = e[d]) & 128) && !((a = e[d + 1]) & 128) && !((o = e[d + 2]) & 128) && !((s = e[d + 3]) & 128);) t[r++] = i, t[r++] = a, t[r++] = o, t[r++] = s, d += 4;
				if (i = e[d++], i < 128) t[r++] = i;
					...
					if (c = (i & 15) << 12 | (a & 63) << 6 | o & 63, c < 2048 || c >= 55296 && c <= 57343 || c === 65279) continue;
					t[r++] = c;
				} else if ((i & 248) == 240) {
					if (d >= n) return this.interim[0] = i, r;
					if (a = e[d++], (a & 192) != 128) {
					...
					if (d >= n) return this.interim[0] = i, this.interim[1] = a, this.interim[2] = o, r;
					if (s = e[d++], (s & 192) != 128) {
						d--;
						continue;
					}
					if (c = (i & 7) << 18 | (a & 63) << 12 | (o & 63) << 6 | s & 63, c < 65536 || c > 1114111) continue;
					t[r++] = c;
				}
			}
			return r;
		...
		constructor() {
			this.fg = 0, this.bg = 0, this.extended = new Pn();
		}
		static toColorRGB(e) {
			return [
				e >>> 16 & 255,
	...
	}, Fn = class e extends Nn {
		constructor() {
			super(...arguments), this.content = 0, this.fg = 0, this.bg = 0, this.extended = new Pn(), this.combinedData = "";
		}
		...
		getChars() {
			return this.content & 2097152 ? this.combinedData : this.content & 2097151 ? Ne(this.content & 2097151) : "";
		}
		getCode() {
	...
	}, In = "di$target", Ln = "di$dependencies", Rn = /* @__PURE__ */ new Map(), j = w("BufferService"), zn = w("CoreMouseService"), Bn = w("CoreService"), Vn = w("CharsetService"), Hn = w("InstantiationService"), Un = w("LogService"), M = w("OptionsService"), Wn = w("OscLinkService"), Gn = w("UnicodeService"), Kn = w("DecorationService"), qn = class {
		constructor(e, t, n) {
		...
		provideLinks(e, t) {
			...
			let r = [], i = this._optionsService.rawOptions.linkHandler, a = new Fn(), o = n.getTrimmedLength(), s = -1, c = -1, l = !1;
			for (let t = 0; t < o; t++) if (!(c === -1 && !n.hasContent(t))) {
				if (n.loadCell(t, a), a.hasExtendedAttrs() && a.extended.urlId) if (c === -1) {
				...
				if (l || c !== -1 && t === o - 1) {
					...
					if (n) {
						...
						s || r.push({
							text: n,
							range: a,
							activate: (e, t) => i ? i.activate(e, t, a) : Le(e, t),
							hover: (e, t) => i?.hover?.(e, t, a),
							leave: (e, t) => i?.leave?.(e, t, a)
						});
					}
					l = !1, a.hasExtendedAttrs() && a.extended.urlId ? (c = t, s = a.extended.urlId) : (c = -1, s = -1);
				}
			}
			t(r);
		}
		...
		A(1, M),
		A(2, Wn)
	], qn), Jn = w("CharSizeService"), Yn = w("CoreBrowserService"), Xn = w("MouseService"), Zn = w("RenderService"), Qn = w("SelectionService"), $n = w("CharacterJoinerService"), er = w("ThemeService"), tr = w("LinkProviderService"), nr = class {
		constructor() {
			this.listeners = [], this.unexpectedErrorHandler = function(e) {
				setTimeout(() => {
					throw e.stack ? or.isErrorNoTelemetry(e) ? new or(e.message + "\n\n" + e.stack) : /* @__PURE__ */ Error(e.message + "\n\n" + e.stack) : e;
				}, 0);
			};
		}
		addListener(e) {
	...
	}, rr = new nr(), ir = "Canceled", ar = class extends Error {
		constructor() {
			super(ir), this.name = this.message;
		}
	}, or = class e extends Error {
		constructor(e) {
		...
		findLastMonotonous(t) {
			...
			let n = Ve(this._array, t, this._findLastMonotonousLastIdx);
			return this._findLastMonotonousLastIdx = n + 1, n === -1 ? void 0 : this._array[n];
		}
	}, cr.assertInvariants = !1, ((e) => {
		function t(e) {
			return e < 0;
		}
		e.isLessThan = t;
		...
		findLastMaxBy(e) {
			let t, n = !0;
			return this.iterate((r) => ((n || lr.isGreaterThan(e(r, t))) && (n = !1, t = r), !0)), t;
		}
	}, dr.empty = new dr((e) => {}), fr = class {
		constructor() {
		...
		computeLeakingDisposables(e = 10, t) {
			...
			if (t) n = t;
				...
				if (n = t.filter((e) => !(e.parent && r.has(e.parent))), n.length === 0) throw Error("There are cyclic diposable chains!");
			}
			if (!n) return;
			function r(e) {
				function t(e, t) {
			...
			for (let t of n.slice(0, e)) {
				...
				for (let t = 0; t < e.length; t++) {
					...
					let o = We([...i.get(e.slice(0, t).join("\n"))].map((e) => r(e)[t]), (e) => e);
					delete o[e[t]];
					for (let [e, t] of Object.entries(o)) s.unshift(`    - stacktraces of ${t.length} other leaks continue with ${e}`);
					s.unshift(a);
				}
				a += `
...
`), {
		...
		Ke(new class {
			trackDisposable(t) {
				let n = (/* @__PURE__ */ Error("Potentially leaked disposable")).stack;
				setTimeout(() => {
					t[e] || console.log(n);
				}, 3e3);
			}
	...
	if (_r = class e {
		constructor() {
			this._toDispose = /* @__PURE__ */ new Set(), this._isDisposed = !1, qe(this);
		}
		dispose() {
			this._isDisposed || (Je(this), this._isDisposed = !0, this.clear());
		}
		get isDisposed() {
		...
		add(t) {
			...
			return Ye(t, this), this._isDisposed ? e.DISABLE_DISPOSED_WARNING || console.warn((/* @__PURE__ */ Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!")).stack) : this._toDispose.add(t), t;
		}
		delete(e) {
			if (e) {
		...
		deleteAndLeak(e) {
			e && this._toDispose.has(e) && (this._toDispose.delete(e), Ye(e, null));
		}
	}, _r.DISABLE_DISPOSED_WARNING = !1, vr = _r, N = class {
		constructor() {
			this._store = new vr(), qe(this), Ye(this._store, this);
		}
		dispose() {
			Je(this), this._store.dispose();
		}
		_register(e) {
			if (e === this) throw Error("Cannot register a disposable on itself!");
			return this._store.add(e);
		}
	}, N.None = Object.freeze({ dispose() {} }), yr = class {
		constructor() {
			this._isDisposed = !1, qe(this);
		}
		get value() {
			return this._isDisposed ? void 0 : this._value;
		}
		set value(e) {
			this._isDisposed || e === this._value || (this._value?.dispose(), e && Ye(e, this), this._value = e);
		}
		clear() {
			this.value = void 0;
		}
		dispose() {
			this._isDisposed = !0, Je(this), this._value?.dispose(), this._value = void 0;
		}
		clearAndLeak() {
			let e = this._value;
			return this._value = void 0, e && Ye(e, null), e;
		}
	}, br = typeof window == "object" ? window : globalThis, xr = class e {
		constructor(t) {
			this.element = t, this.next = e.Undefined, this.prev = e.Undefined;
		}
	}, xr.Undefined = new xr(void 0), P = xr, Sr = class {
		constructor() {
		...
		*[Symbol.iterator]() {
	...
	}, Cr = globalThis.performance && typeof globalThis.performance.now == "function", wr = class e {
		static create(t) {
			return new e(t);
		}
		constructor(e) {
			this._now = Cr && e === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
		}
		stop() {
		...
		function t(e) {
			if (Dr) {
				let { onDidAddListener: t } = e, n = Nr.create(), r = 0;
				e.onDidAddListener = () => {
					++r === 2 && (console.warn("snapshotted emitter LIKELY used public and SHOULD HAVE BEEN created with DisposableStore. snapshotted here"), n.print()), t?.();
				};
			}
		}
		function n(e, t) {
		...
		e.signal = s;
		function c(...e) {
			return (t, n = null, r) => d($e(...e.map((e) => e((e) => t.call(n, e)))), r);
		}
		e.any = c;
		function l(e, t, n, r) {
			let a = n;
		...
		function f(e, n, r = 100, i = !1, a = !1, o, s) {
			let c, l, u, d = 0, f, p = {
				...
				onWillAddFirstListener() {
					c = e((e) => {
						d++, l = n(l, e), i && !u && (m.fire(l), l = void 0), f = () => {
							let e = l;
							l = void 0, u = void 0, (!i || d > 1) && m.fire(e), d = 0;
						}, typeof r == "number" ? (clearTimeout(u), u = setTimeout(f, r)) : u === void 0 && (u = 0, queueMicrotask(f));
					});
				},
		...
		function te(e, t, n = (e) => e) {
			let r = (...e) => i.fire(n(...e)), i = new I({
				onWillAddFirstListener: () => e.on(t, r),
				onDidRemoveLastListener: () => e.removeListener(t, r)
			});
			return i.event;
		}
		e.fromNodeEventEmitter = te;
		function ne(e, t, n = (e) => e) {
			let r = (...e) => i.fire(n(...e)), i = new I({
		...
		function x(e, t) {
			return new ae(e, t).emitter.event;
		}
		e.fromObservable = x;
		function oe(e) {
			return (t, n, r) => {
				...
				return r instanceof vr ? r.add(s) : Array.isArray(r) && r.push(s), s;
			};
		}
	...
	}, Or.all = /* @__PURE__ */ new Set(), Or._idPool = 0, kr = Or, Ar = -1, jr = class e {
		...
		check(e, t) {
			...
			if (this._stacks.set(e.value, r + 1), --this._warnCountdown, this._warnCountdown <= 0) {
				...
				let [e, r] = this.getMostFrequentStack(), i = `[${this.name}] potential listener LEAK detected, having ${t} listeners already. MOST frequent listener (${r}):`;
		...
		constructor(e) {
			this.value = e, this.id = Ir++;
		}
	}, Rr = 2, zr = (e, t) => {
		if (e instanceof Lr) t(e);
		...
		let e = [];
		setInterval(() => {
			e.length !== 0 && (console.warn("[LEAKING LISTENERS] GC'ed these listeners that were NOT yet disposed:"), console.warn(e.join("\n")), e.length = 0);
		}, 3e3), Br = new FinalizationRegistry((t) => {
			typeof t == "string" && e.push(t);
		});
	}
	if (I = class {
		constructor(e) {
			this._size = 0, this._options = e, this._leakageMon = Ar > 0 || this._options?.leakWarningThreshold ? new Mr(e?.onListenerError ?? Re, this._options?.leakWarningThreshold ?? Ar) : void 0, this._perfMon = this._options?._profName ? new kr(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
		}
		dispose() {
			if (!this._disposed) {
		...
		get event() {
			return this._event ??= (e, t, n) => {
				if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
					...
					console.warn(e);
					let t = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], n = new Fr(`${e}. HINT: Stack shows most frequent listener (${t[1]}-times)`, t[0]);
					return (this._options?.onListenerError || Re)(n), N.None;
				}
				if (this._disposed) return N.None;
				t && (e = e.bind(t));
				let r = new Lr(e), i;
				this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (r.stack = Nr.create(), i = this._leakageMon.check(r.stack, this._size + 1)), Er && (r.stack = Nr.create()), this._listeners ? this._listeners instanceof Lr ? (this._deliveryQueue ??= new Vr(), this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._size++;
				let a = T(() => {
					Br?.unregister(a), i?.(), this._removeListener(r);
				});
				if (n instanceof vr ? n.add(a) : Array.isArray(n) && n.push(a), Br) {
					let e = (/* @__PURE__ */ Error()).stack.split("\n").slice(2, 3).join("\n").trim(), t = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(e);
					Br.register(a, t?.[2] ?? e, a);
				}
				return a;
			}, this._event;
		}
		_removeListener(e) {
			...
			if (n === -1) throw console.log("disposed?", this._disposed), console.log("size?", this._size), console.log("arr?", JSON.stringify(this._listeners)), /* @__PURE__ */ Error("Attempted to dispose unknown listener");
			this._size--, t[n] = void 0;
			let r = this._deliveryQueue.current === this;
			if (this._size * Rr <= t.length) {
				let e = 0;
		...
		_deliver(e, t) {
			if (!e) return;
			let n = this._options?.onListenerError || Re;
			if (!n) {
				e.value(t);
				return;
			}
		...
		fire(e) {
			if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof Lr) this._deliver(this._listeners, e);
			else {
		...
		constructor() {
			this.mapWindowIdToZoomLevel = /* @__PURE__ */ new Map(), this._onDidChangeZoomLevel = new I(), this.onDidChangeZoomLevel = this._onDidChangeZoomLevel.event, this.mapWindowIdToZoomFactor = /* @__PURE__ */ new Map(), this._onDidChangeFullscreen = new I(), this.onDidChangeFullscreen = this._onDidChangeFullscreen.event, this.mapWindowIdToFullScreen = /* @__PURE__ */ new Map();
		}
		getZoomLevel(e) {
	...
	}, Hr.INSTANCE = new Hr(), Ur = Hr, Ur.INSTANCE.onDidChangeZoomLevel, Ur.INSTANCE.onDidChangeFullscreen, Wr = typeof navigator == "object" ? navigator.userAgent : "", Gr = Wr.indexOf("Firefox") >= 0, Kr = Wr.indexOf("AppleWebKit") >= 0, qr = Wr.indexOf("Chrome") >= 0, Jr = !qr && Wr.indexOf("Safari") >= 0, Wr.indexOf("Electron/"), Wr.indexOf("Android"), Yr = !1, typeof br.matchMedia == "function") {
		let e = br.matchMedia("(display-mode: standalone) or (display-mode: window-controls-overlay)"), t = br.matchMedia("(display-mode: fullscreen)");
		Yr = e.matches, et(br, e, ({ matches: e }) => {
			Yr && t.matches || (Yr = e);
		});
	}
	if (Xr = "en", Zr = !1, Qr = !1, $r = !1, ei = !1, ti = !1, ni = Xr, ii = globalThis, typeof ii.vscode < "u" && typeof ii.vscode.process < "u" ? ai = ii.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (ai = process), oi = typeof ai?.versions?.electron == "string" && ai?.type === "renderer", typeof ai == "object") {
		Zr = ai.platform === "win32", Qr = ai.platform === "darwin", $r = ai.platform === "linux", $r && ai.env.SNAP && ai.env.SNAP_REVISION, ai.env.CI || ai.env.BUILD_ARTIFACTSTAGINGDIRECTORY, ni = Xr;
		let e = ai.env.VSCODE_NLS_CONFIG;
		if (e) try {
			let t = JSON.parse(e);
			t.userLocale, t.osLocale, ni = t.resolvedLanguage || Xr, t.languagePack?.translationsConfigFile;
		} catch {}
		ei = !0;
	} else typeof navigator == "object" && !oi ? (ri = navigator.userAgent, Zr = ri.indexOf("Windows") >= 0, Qr = ri.indexOf("Macintosh") >= 0, (ri.indexOf("Macintosh") >= 0 || ri.indexOf("iPad") >= 0 || ri.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints, $r = ri.indexOf("Linux") >= 0, ri?.indexOf("Mobi"), ti = !0, ni = globalThis._VSCODE_NLS_LANGUAGE || Xr, navigator.language.toLowerCase()) : console.error("Unable to resolve platform.");
	si = Zr, ci = Qr, li = $r, ui = ei, ti && typeof ii.importScripts == "function" && ii.origin, di = ri, fi = ni, ((e) => {
		function t() {
			return fi;
		}
		e.value = t;
		function n() {
			return fi.length === 2 ? fi === "en" : fi.length >= 3 ? fi[0] === "e" && fi[1] === "n" && fi[2] === "-" : !1;
		}
		...
		e.isDefault = r;
	})(pi ||= {}), mi = typeof ii.postMessage == "function" && !ii.importScripts, (() => {
		if (mi) {
			let e = [];
			ii.addEventListener("message", (t) => {
			...
			return (n) => {
				...
				e.push({
					id: r,
					callback: n
				}), ii.postMessage({ vscodeScheduleAsyncWork: r }, "*");
			};
		}
		return (e) => setTimeout(e);
	})(), hi = !!(di && di.indexOf("Chrome") >= 0), di && di.indexOf("Firefox"), !hi && di && di.indexOf("Safari"), di && di.indexOf("Edg/"), di && di.indexOf("Android"), gi = typeof navigator == "object" ? navigator : {}, ui || document.queryCommandSupported && document.queryCommandSupported("copy") || gi && gi.clipboard && gi.clipboard.writeText, ui || gi && gi.clipboard && gi.clipboard.readText, ui || nt() || gi.keyboard, "ontouchstart" in br || gi.maxTouchPoints, br.PointerEvent && ("ontouchstart" in br || navigator.maxTouchPoints), _i = class {
		constructor() {
	...
	}, vi = new _i(), yi = new _i(), bi = new _i(), xi = Array(230), ((e) => {
		function t(e) {
			return vi.keyCodeToStr(e);
		}
		e.toString = t;
		function n(e) {
			return vi.strToKeyCode(e);
		}
		e.fromString = n;
		function r(e) {
			return yi.keyCodeToStr(e);
		}
		e.toUserSettingsUS = r;
		function i(e) {
			return bi.keyCodeToStr(e);
		}
		e.toUserSettingsGeneral = i;
		function a(e) {
			return yi.strToKeyCode(e) || bi.strToKeyCode(e);
		}
		...
		equals(t) {
			return t instanceof e && this.ctrlKey === t.ctrlKey && this.shiftKey === t.shiftKey && this.altKey === t.altKey && this.metaKey === t.metaKey && this.keyCode === t.keyCode;
		}
		getHashCode() {
		...
		constructor(e) {
			if (e.length === 0) throw Be("chords");
			this.chords = e;
		}
		getHashCode() {
			let e = "";
			for (let t = 0, n = this.chords.length; t < n; t++) t !== 0 && (e += ";"), e += this.chords[t].getHashCode();
			return e;
		}
		equals(e) {
	...
	}, Ti = ci ? 256 : 2048, Ei = 512, Di = 1024, Oi = ci ? 2048 : 256, ki = class {
		constructor(e) {
		...
		_computeKeybinding() {
			...
			let t = 0;
			return this.ctrlKey && (t |= Ti), this.altKey && (t |= Ei), this.shiftKey && (t |= Di), this.metaKey && (t |= Oi), t |= e, t;
		}
		_computeKeyCodeChord() {
			let e = 0;
			return this.keyCode !== 5 && this.keyCode !== 4 && this.keyCode !== 6 && this.keyCode !== 57 && (e = this.keyCode), new Ci(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, e);
		}
	}, Ai = /* @__PURE__ */ new WeakMap(), ji = class {
		...
		static getPositionOfChildWindowRelativeToAncestorWindow(e, t) {
			...
			let n = 0, r = 0, i = this.getSameOriginWindowChain(e);
			for (let e of i) {
		...
		constructor(e, t) {
			...
			let n = ji.getPositionOfChildWindowRelativeToAncestorWindow(e, t.view);
		...
		constructor(e, t = 0, n = 0) {
			this.browserEvent = e || null, this.target = e ? e.target || e.targetNode || e.srcElement : null, this.deltaY = n, this.deltaX = t;
			let r = !1;
			if (qr) {
			...
			if (e) {
				...
				if (typeof t.wheelDeltaY < "u") r ? this.deltaY = t.wheelDeltaY / (120 * i) : this.deltaY = t.wheelDeltaY / 120;
					...
					let t = e;
					t.deltaMode === t.DOM_DELTA_LINE ? Gr && !ci ? this.deltaY = -e.deltaY / 3 : this.deltaY = -e.deltaY : this.deltaY = -e.deltaY / 40;
				}
				if (typeof t.wheelDeltaX < "u") Jr && si ? this.deltaX = -(t.wheelDeltaX / 120) : r ? this.deltaX = t.wheelDeltaX / (120 * i) : this.deltaX = t.wheelDeltaX / 120;
				else if (typeof n.HORIZONTAL_AXIS < "u" && n.axis === n.HORIZONTAL_AXIS) this.deltaX = -e.detail / 3;
				else if (e.type === "wheel") {
					let t = e;
					t.deltaMode === t.DOM_DELTA_LINE ? Gr && !ci ? this.deltaX = -e.deltaX / 3 : this.deltaX = -e.deltaX : this.deltaX = -e.deltaX / 40;
				}
		...
		function t(t) {
			return t === e.None || t === e.Cancelled || t instanceof Ii ? !0 : !t || typeof t != "object" ? !1 : typeof t.isCancellationRequested == "boolean" && typeof t.onCancellationRequested == "function";
		}
		e.isCancellationToken = t, e.None = Object.freeze({
			isCancellationRequested: !1,
			onCancellationRequested: F.None
		...
		get onCancellationRequested() {
			return this._isCancelled ? Pi : (this._emitter ||= new I(), this._emitter.event);
		}
		dispose() {
		...
		cancelAndSet(e, t) {
			if (this._isDisposed) throw new sr("Calling 'cancelAndSet' on a disposed TimeoutTimer");
			this.cancel(), this._token = setTimeout(() => {
				this._token = -1, e();
			}, t);
		}
		setIfNotSet(e, t) {
			if (this._isDisposed) throw new sr("Calling 'setIfNotSet' on a disposed TimeoutTimer");
		...
		cancelAndSet(e, t, n = globalThis) {
			if (this.isDisposed) throw new sr("Calling 'cancelAndSet' on a disposed IntervalTimer");
			this.cancel();
			let r = n.setInterval(() => {
				e();
			}, t);
		...
		constructor(e, t) {
			this._state = 0, this._results = [], this._error = null, this._onReturn = t, this._onStateChanged = new I(), queueMicrotask(async () => {
				let t = {
			...
			return {
				next: async () => {
					do {
						...
						await F.toPromise(this._onStateChanged.event);
					} while (!0);
				},
	...
	}, Bi.EMPTY = Bi.fromArray([]), Vi = class e {
		constructor() {
		...
		digest() {
			return this._finished || (this._finished = !0, this._leftoverHighSurrogate && (this._leftoverHighSurrogate = 0, this._buffLen = this._push(this._buff, this._buffLen, 65533)), this._totalLen += this._buffLen, this._wrapUp()), vt(this._h0) + vt(this._h1) + vt(this._h2) + vt(this._h3) + vt(this._h4);
		}
		_wrapUp() {
			this._buff[this._buffLen++] = 128, gt(this._buff, this._buffLen), this._buffLen > 56 && (this._step(), gt(this._buff));
		...
		_step() {
			...
			for (let e = 64; e < 320; e += 4) t.setUint32(e, ht(t.getUint32(e - 12, !1) ^ t.getUint32(e - 32, !1) ^ t.getUint32(e - 56, !1) ^ t.getUint32(e - 64, !1), 1), !1);
			let r = this._h0, i = this._h1, a = this._h2, o = this._h3, s = this._h4, c, l, u;
			for (let e = 0; e < 80; e++) e < 20 ? (c = i & a | ~i & o, l = 1518500249) : e < 40 ? (c = i ^ a ^ o, l = 1859775393) : e < 60 ? (c = i & a | i & o | a & o, l = 2400959708) : (c = i ^ a ^ o, l = 3395469782), u = ht(r, 5) + c + s + l + t.getUint32(e * 4, !1) & 4294967295, s = o, o = a, a = ht(i, 30), i = r, r = u;
	...
	}, Vi._bigBlock32 = /* @__PURE__ */ new DataView(/* @__PURE__ */ new ArrayBuffer(320)), {registerWindow: Hi, getWindow: Ui, getDocument: Wi, getWindows: Gi, getWindowsCount: Ki, getWindowId: qi, getWindowById: Ji, hasWindow: Yi, onDidRegisterWindow: Xi, onWillUnregisterWindow: Zi, onDidUnregisterWindow: Qi} = function() {
		let e = /* @__PURE__ */ new Map(), t = {
			window: br,
			disposables: new vr()
		};
		e.set(br.vscodeWindowId, t);
		let n = new I(), r = new I(), i = new I();
		function a(n, r) {
		...
		return {
			...
			registerWindow(t) {
				if (e.has(t.vscodeWindowId)) return N.None;
				let a = new vr(), o = {
					window: t,
					disposables: a.add(new vr())
				};
				return e.set(t.vscodeWindowId, o), a.add(T(() => {
					e.delete(t.vscodeWindowId), r.fire(t);
				})), a.add(E(t, L.BEFORE_UNLOAD, () => {
					i.fire(t);
				})), n.fire(o), a;
			},
			getWindows() {
			...
			getWindow(e) {
				...
				let n = e;
				return n?.view ? n.view.window : br;
			},
			getDocument(e) {
		...
		constructor(e, t, n, r) {
			this._node = e, this._type = t, this._handler = n, this._options = r || !1, this._node.addEventListener(this._type, this._handler, this._options);
		}
		dispose() {
			this._handler &&= (this._node.removeEventListener(this._type, this._handler, this._options), this._node = null, null);
		}
	}, ea = function(e, t, n, r) {
		let i = n;
		return t === "click" || t === "mousedown" || t === "contextmenu" ? i = yt(Ui(e), n) : (t === "keydown" || t === "keypress" || t === "keyup") && (i = bt(n)), E(e, t, i, r);
	}, na = class extends Ri {
		constructor(e) {
			super(), this.defaultTarget = e && Ui(e);
		}
		cancelAndSet(e, t, n) {
		...
		let e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), n = /* @__PURE__ */ new Map(), r = /* @__PURE__ */ new Map(), i = (i) => {
			n.set(i, !1);
			let a = e.get(i) ?? [];
			for (t.set(i, a), e.set(i, []), r.set(i, !0); a.length > 0;) a.sort(ra.sort), a.shift().execute();
			r.set(i, !1);
		};
		ta = (t, r, a = 0) => {
			let o = qi(t), s = new ra(r, a), c = e.get(o);
			return c || (c = [], e.set(o, c)), c.push(s), n.get(o) || (n.set(o, !0), t.requestAnimationFrame(() => i(o))), s;
		};
	})(), ia = class e {
		constructor(e, t) {
	...
	}, ia.None = new ia(0, 0), new class {
		constructor() {
			this.mutationObservers = /* @__PURE__ */ new Map();
		}
		observe(e, t, n) {
			let r = this.mutationObservers.get(e);
			r || (r = /* @__PURE__ */ new Map(), this.mutationObservers.set(e, r));
			let i = ct(n), a = r.get(i);
			if (a) a.users += 1;
			else {
				let o = new I(), s = new MutationObserver((e) => o.fire(e));
				s.observe(e, n);
				let c = a = {
					users: 1,
					observer: s,
				...
				t.add(T(() => {
					--c.users, c.users === 0 && (o.dispose(), s.disconnect(), r?.delete(i), r?.size === 0 && this.mutationObservers.delete(e));
				})), r.set(i, a);
			}
		...
		DROP: "drop",
		DRAG_END: "dragend",
		ANIMATION_START: Kr ? "webkitAnimationStart" : "animationstart",
		ANIMATION_END: Kr ? "webkitAnimationEnd" : "animationend",
		ANIMATION_ITERATION: Kr ? "webkitAnimationIteration" : "animationiteration"
	}, aa = /([\w\-]+)?(#([\w\-]+))?((\.([\w\-]+))*)/, Ct.SVG = function(e, t, ...n) {
		return St("http://www.w3.org/2000/svg", e, t, ...n);
	}, oa = class {
		constructor(e) {
		...
		constructor() {
			this._hooks = new vr(), this._pointerMoveCallback = null, this._onStopCallback = null;
		}
		dispose() {
		...
		startMonitoring(e, t, n, r, i) {
			...
			let a = e;
			try {
				e.setPointerCapture(t), this._hooks.add(T(() => {
					try {
			...
			this._hooks.add(E(a, L.POINTER_MOVE, (e) => {
				if (e.buttons !== n) {
					this.stopMonitoring(!0);
					return;
				}
				e.preventDefault(), this._pointerMoveCallback(e);
			})), this._hooks.add(E(a, L.POINTER_UP, (e) => this.stopMonitoring(!0)));
		}
	}, ((e) => (e.Tap = "-xterm-gesturetap", e.Change = "-xterm-gesturechange", e.Start = "-xterm-gesturestart", e.End = "-xterm-gesturesend", e.Contextmenu = "-xterm-gesturecontextmenu"))(ca ||= {}), la = class e extends N {
		constructor() {
			super(), this.dispatched = !1, this.targets = new Sr(), this.ignoreTargets = new Sr(), this.activeTouches = {}, this.handle = null, this._lastSetTapCountTime = 0, this._register(F.runAndSubscribe(Xi, ({ window: e, disposables: t }) => {
				t.add(E(e.document, "touchstart", (e) => this.onTouchStart(e), { passive: !1 })), t.add(E(e.document, "touchend", (t) => this.onTouchEnd(e, t))), t.add(E(e.document, "touchmove", (e) => this.onTouchMove(e), { passive: !1 }));
			}, {
				window: br,
		...
		static addTarget(t) {
			return e.isTouchDevice() ? (e.INSTANCE ||= Ze(new e()), T(e.INSTANCE.targets.push(t))) : N.None;
		}
		static ignoreTarget(t) {
			return e.isTouchDevice() ? (e.INSTANCE ||= Ze(new e()), T(e.INSTANCE.ignoreTargets.push(t))) : N.None;
		}
		static isTouchDevice() {
			return "ontouchstart" in br || navigator.maxTouchPoints > 0;
		}
		dispose() {
		...
		onTouchEnd(t, n) {
			...
			for (let a = 0, o = n.changedTouches.length; a < o; a++) {
				...
				let s = this.activeTouches[o.identifier], c = Date.now() - s.initialTimeStamp;
				if (c < e.HOLD_DELAY && Math.abs(s.initialPageX - He(s.rollingPageX)) < 30 && Math.abs(s.initialPageY - He(s.rollingPageY)) < 30) {
					let e = this.newGestureEvent(ca.Tap, s.initialTarget);
					e.pageX = He(s.rollingPageX), e.pageY = He(s.rollingPageY), this.dispatchEvent(e);
				} else if (c >= e.HOLD_DELAY && Math.abs(s.initialPageX - He(s.rollingPageX)) < 30 && Math.abs(s.initialPageY - He(s.rollingPageY)) < 30) {
					let e = this.newGestureEvent(ca.Contextmenu, s.initialTarget);
					e.pageX = He(s.rollingPageX), e.pageY = He(s.rollingPageY), this.dispatchEvent(e);
				} else if (i === 1) {
					let e = He(s.rollingPageX), n = He(s.rollingPageY), i = He(s.rollingTimestamps) - s.rollingTimestamps[0], a = e - s.rollingPageX[0], o = n - s.rollingPageY[0], c = [...this.targets].filter((e) => s.initialTarget instanceof Node && e.contains(s.initialTarget));
					this.inertia(t, c, r, Math.abs(a) / i, a > 0 ? 1 : -1, e, Math.abs(o) / i, o > 0 ? 1 : -1, n);
				}
				this.dispatchEvent(this.newGestureEvent(ca.End, s.initialTarget)), delete this.activeTouches[o.identifier];
			}
		...
		dispatchEvent(t) {
			if (t.type === ca.Tap) {
				let n = (/* @__PURE__ */ new Date()).getTime(), r = 0;
				r = n - this._lastSetTapCountTime > e.CLEAR_TAP_COUNT_TIME ? 1 : 2, this._lastSetTapCountTime = n, t.tapCount = r;
			} else (t.type === ca.Change || t.type === ca.Contextmenu) && (this._lastSetTapCountTime = 0);
			if (t.initialTarget instanceof Node) {
				for (let e of this.ignoreTargets) if (e.contains(t.initialTarget)) return;
				let e = [];
				for (let n of this.targets) if (n.contains(t.initialTarget)) {
		...
		inertia(t, n, r, i, a, o, s, c, l) {
			this.handle = ta(t, () => {
				let u = Date.now(), d = u - r, f = 0, p = 0, m = !0;
				i += e.SCROLL_FRICTION * d, s += e.SCROLL_FRICTION * d, i > 0 && (m = !1, f = a * i * d), s > 0 && (m = !1, p = c * s * d);
				let h = this.newGestureEvent(ca.Change);
				h.translationX = f, h.translationY = p, n.forEach((e) => e.dispatchEvent(h)), m || this.inertia(t, n, u, i, a, o + f, s, c, l + p);
			});
		}
		onTouchMove(e) {
			let t = Date.now();
			for (let n = 0, r = e.changedTouches.length; n < r; n++) {
				...
				let i = this.activeTouches[r.identifier], a = this.newGestureEvent(ca.Change, i.initialTarget);
				a.translationX = r.pageX - He(i.rollingPageX), a.translationY = r.pageY - He(i.rollingPageY), a.pageX = r.pageX, a.pageY = r.pageY, this.dispatchEvent(a), i.rollingPageX.length > 3 && (i.rollingPageX.shift(), i.rollingPageY.shift(), i.rollingTimestamps.shift()), i.rollingPageX.push(r.pageX), i.rollingPageY.push(r.pageY), i.rollingTimestamps.push(t);
			}
			this.dispatched &&= (e.preventDefault(), e.stopPropagation(), !1);
		}
	}, la.SCROLL_FRICTION = -.005, la.HOLD_DELAY = 700, la.CLEAR_TAP_COUNT_TIME = 400, k([Tt], la, "isTouchDevice", 1), ua = la, da = class extends N {
		onclick(e, t) {
			this._register(E(e, L.CLICK, (n) => t(new Mi(Ui(e), n))));
		}
		onmousedown(e, t) {
			this._register(E(e, L.MOUSE_DOWN, (n) => t(new Mi(Ui(e), n))));
		}
		onmouseover(e, t) {
			this._register(E(e, L.MOUSE_OVER, (n) => t(new Mi(Ui(e), n))));
		}
		onmouseleave(e, t) {
			this._register(E(e, L.MOUSE_LEAVE, (n) => t(new Mi(Ui(e), n))));
		}
		onkeydown(e, t) {
			this._register(E(e, L.KEY_DOWN, (e) => t(new ki(e))));
		}
		onkeyup(e, t) {
			this._register(E(e, L.KEY_UP, (e) => t(new ki(e))));
		}
		oninput(e, t) {
			this._register(E(e, L.INPUT, t));
		}
		onblur(e, t) {
			this._register(E(e, L.BLUR, t));
		}
		onfocus(e, t) {
			this._register(E(e, L.FOCUS, t));
		}
		onchange(e, t) {
			this._register(E(e, L.CHANGE, t));
		}
		ignoreGesture(e) {
			return ua.ignoreTarget(e);
		}
	}, fa = 11, pa = class extends da {
		constructor(e) {
			super(), this._onActivate = e.onActivate, this.bgDomNode = document.createElement("div"), this.bgDomNode.className = "arrow-background", this.bgDomNode.style.position = "absolute", this.bgDomNode.style.width = e.bgWidth + "px", this.bgDomNode.style.height = e.bgHeight + "px", typeof e.top < "u" && (this.bgDomNode.style.top = "0px"), typeof e.left < "u" && (this.bgDomNode.style.left = "0px"), typeof e.bottom < "u" && (this.bgDomNode.style.bottom = "0px"), typeof e.right < "u" && (this.bgDomNode.style.right = "0px"), this.domNode = document.createElement("div"), this.domNode.className = e.className, this.domNode.style.position = "absolute", this.domNode.style.width = fa + "px", this.domNode.style.height = fa + "px", typeof e.top < "u" && (this.domNode.style.top = e.top + "px"), typeof e.left < "u" && (this.domNode.style.left = e.left + "px"), typeof e.bottom < "u" && (this.domNode.style.bottom = e.bottom + "px"), typeof e.right < "u" && (this.domNode.style.right = e.right + "px"), this._pointerMoveMonitor = this._register(new sa()), this._register(ea(this.bgDomNode, L.POINTER_DOWN, (e) => this._arrowPointerDown(e))), this._register(ea(this.domNode, L.POINTER_DOWN, (e) => this._arrowPointerDown(e))), this._pointerdownRepeatTimer = this._register(new na()), this._pointerdownScheduleRepeatTimer = this._register(new Li());
		}
		_arrowPointerDown(e) {
			!e.target || !(e.target instanceof Element) || (this._onActivate(), this._pointerdownRepeatTimer.cancel(), this._pointerdownScheduleRepeatTimer.cancelAndSet(() => {
				this._pointerdownRepeatTimer.cancelAndSet(() => this._onActivate(), 1e3 / 24, Ui(e));
		...
		constructor(e, t, n, r, i, a, o) {
			this._forceIntegerValues = e, this._scrollStateBrand = void 0, this._forceIntegerValues && (t |= 0, n |= 0, r |= 0, i |= 0, a |= 0, o |= 0), this.rawScrollLeft = r, this.rawScrollTop = o, t < 0 && (t = 0), r + t > n && (r = n - t), r < 0 && (r = 0), i < 0 && (i = 0), o + i > a && (o = a - i), o < 0 && (o = 0), this.width = t, this.scrollWidth = n, this.scrollLeft = r, this.height = i, this.scrollHeight = a, this.scrollTop = o;
		}
		equals(e) {
		...
		createScrollEvent(e, t) {
			let n = this.width !== e.width, r = this.scrollWidth !== e.scrollWidth, i = this.scrollLeft !== e.scrollLeft, a = this.height !== e.height, o = this.scrollHeight !== e.scrollHeight, s = this.scrollTop !== e.scrollTop;
			return {
				inSmoothScrolling: t,
				oldWidth: e.width,
		...
		constructor(e) {
			super(), this._scrollableBrand = void 0, this._onScroll = this._register(new I()), this.onScroll = this._onScroll.event, this._smoothScrollDuration = e.smoothScrollDuration, this._scheduleAtNextAnimationFrame = e.scheduleAtNextAnimationFrame, this._state = new ma(e.forceIntegerValues, 0, 0, 0, 0, 0, 0), this._smoothScrolling = null;
		}
		dispose() {
		...
		setScrollPositionSmooth(e, t) {
			...
			if (this._smoothScrolling) {
				...
				let r;
				r = t ? new _a(this._smoothScrolling.from, n, this._smoothScrolling.startTime, this._smoothScrolling.duration) : this._smoothScrolling.combine(this._state, n, this._smoothScrollDuration), this._smoothScrolling.dispose(), this._smoothScrolling = r;
			} else {
				let t = this._state.withScrollPosition(e);
				this._smoothScrolling = _a.start(this._state, t, this._smoothScrollDuration);
			}
		...
		_initAnimation(e, t, n) {
			if (Math.abs(e - t) > 2.5 * n) {
				let r, i;
				return e < t ? (r = e + .75 * n, i = t - .75 * n) : (r = e - .75 * n, i = t + .75 * n), Dt(Et(e, r), Et(i, t), .33);
			}
			return Et(e, t);
		}
		dispose() {
		...
		_tick(e) {
			...
			return t < 1 ? new ga(this.scrollLeft(t), this.scrollTop(t), !1) : new ga(this.to.scrollLeft, this.to.scrollTop, !0);
		}
		combine(t, n, r) {
		...
		constructor(e, t, n) {
			super(), this._visibility = e, this._visibleClassName = t, this._invisibleClassName = n, this._domNode = null, this._isVisible = !1, this._isNeeded = !1, this._rawShouldBeVisible = !1, this._shouldBeVisible = !1, this._revealTimer = this._register(new Li());
		}
		setVisibility(e) {
	...
	}, ya = 140, ba = class extends da {
		constructor(e) {
			super(), this._lazyRender = e.lazyRender, this._host = e.host, this._scrollable = e.scrollable, this._scrollByPage = e.scrollByPage, this._scrollbarState = e.scrollbarState, this._visibilityController = this._register(new va(e.visibility, "visible scrollbar " + e.extraScrollbarClassName, "invisible scrollbar " + e.extraScrollbarClassName)), this._visibilityController.setIsNeeded(this._scrollbarState.isNeeded()), this._pointerMoveMonitor = this._register(new sa()), this._shouldRender = !0, this.domNode = wt(document.createElement("div")), this.domNode.setAttribute("role", "presentation"), this.domNode.setAttribute("aria-hidden", "true"), this._visibilityController.setDomNode(this.domNode), this.domNode.setPosition("absolute"), this._register(E(this.domNode.domNode, L.POINTER_DOWN, (e) => this._domNodePointerDown(e)));
		}
		_createArrow(e) {
			let t = this._register(new pa(e));
			this.domNode.domNode.appendChild(t.bgDomNode), this.domNode.domNode.appendChild(t.domNode);
		}
		_createSlider(e, t, n, r) {
			this.slider = wt(document.createElement("div")), this.slider.setClassName("slider"), this.slider.setPosition("absolute"), this.slider.setTop(e), this.slider.setLeft(t), typeof n == "number" && this.slider.setWidth(n), typeof r == "number" && this.slider.setHeight(r), this.slider.setLayerHinting(!0), this.slider.setContain("strict"), this.domNode.domNode.appendChild(this.slider.domNode), this._register(E(this.slider.domNode, L.POINTER_DOWN, (e) => {
		...
		delegatePointerDown(e) {
			...
			n <= i && i <= r ? e.button === 0 && (e.preventDefault(), this._sliderPointerDown(e)) : this._onPointerDown(e);
		}
		_onPointerDown(e) {
			let t, n;
			if (e.target === this.domNode.domNode && typeof e.offsetX == "number" && typeof e.offsetY == "number") t = e.offsetX, n = e.offsetY;
			else {
				let r = xt(this.domNode.domNode);
		...
		_sliderPointerDown(e) {
			...
			this.slider.toggleClassName("active", !0), this._pointerMoveMonitor.startMonitoring(e.target, e.pointerId, e.buttons, (e) => {
				let i = this._sliderOrthogonalPointerPosition(e), a = Math.abs(i - n);
				if (si && a > ya) {
		...
		constructor(e, t, n, r, i, a) {
			this._scrollbarSize = Math.round(t), this._oppositeScrollbarSize = Math.round(n), this._arrowSize = Math.round(e), this._visibleSize = r, this._scrollSize = i, this._scrollPosition = a, this._computedAvailableSize = 0, this._computedIsNeeded = !1, this._computedSliderSize = 0, this._computedSliderRatio = 0, this._computedSliderPosition = 0, this._refreshComputedValues();
		}
		clone() {
		...
		static _computeValues(e, t, n, r, i) {
			let a = Math.max(0, n - e), o = Math.max(0, a - 2 * t), s = r > 0 && r > n;
			if (!s) return {
			...
			let c = Math.round(Math.max(20, Math.floor(n * o / r))), l = (o - c) / (r - n), u = i * l;
			return {
				computedAvailableSize: Math.round(a),
				computedIsNeeded: s,
		...
		constructor(e, t, n) {
			...
			if (super({
				...
				host: n,
				scrollbarState: new xa(t.horizontalHasArrows ? t.arrowSize : 0, t.horizontal === 2 ? 0 : t.horizontalScrollbarSize, t.vertical === 2 ? 0 : t.verticalScrollbarSize, r.width, r.scrollWidth, i.scrollLeft),
		...
		constructor(e, t, n) {
			...
			if (super({
				lazyRender: t.lazyRender,
				host: n,
				scrollbarState: new xa(t.verticalHasArrows ? t.arrowSize : 0, t.vertical === 2 ? 0 : t.verticalScrollbarSize, 0, r.height, r.scrollHeight, i.scrollTop),
				visibility: t.vertical,
				extraScrollbarClassName: "vertical",
				scrollable: e,
				scrollByPage: t.scrollByPage
			}), t.verticalHasArrows) throw Error("horizontalHasArrows is not supported in xterm.js");
		...
		_computeScore(e, t) {
			...
			if ((!this._isAlmostInt(e.deltaX) || !this._isAlmostInt(e.deltaY)) && (n += .25), t) {
				let r = Math.abs(e.deltaX), i = Math.abs(e.deltaY), a = Math.abs(t.deltaX), o = Math.abs(t.deltaY), s = Math.max(Math.min(r, a), 1), c = Math.max(Math.min(i, o), 1), l = Math.max(r, a), u = Math.max(i, o);
				l % s === 0 && u % c === 0 && (n -= .5);
			}
	...
	}, Oa.INSTANCE = new Oa(), ka = Oa, Aa = class extends da {
		constructor(e, t, n) {
			super(), this._onScroll = this._register(new I()), this.onScroll = this._onScroll.event, this._onWillScroll = this._register(new I()), this.onWillScroll = this._onWillScroll.event, this._options = At(t), this._scrollable = n, this._register(this._scrollable.onScroll((e) => {
		...
		updateClassName(e) {
			this._options.className = e, ci && (this._options.className += " mac"), this._domNode.className = "xterm-scrollable-element " + this._options.className;
		}
		updateOptions(e) {
		...
		delegateScrollFromMouseWheelEvent(e) {
			this._onMouseWheel(new Ni(e));
		}
		_setListeningToMouseWheel(e) {
			this._mouseWheelToDispose.length > 0 !== e && (this._mouseWheelToDispose = Qe(this._mouseWheelToDispose), e) && this._mouseWheelToDispose.push(E(this._listenOnDomNode, L.MOUSE_WHEEL, (e) => {
				this._onMouseWheel(new Ni(e));
			}, { passive: !1 }));
		}
		_onMouseWheel(e) {
			...
			let t = ka.INSTANCE;
			Ea && t.acceptStandardWheelEvent(e);
			let n = !1;
			if (e.deltaY || e.deltaX) {
				...
				let a = !ci && e.browserEvent && e.browserEvent.shiftKey;
				(this._options.scrollYToX || a) && !i && (i = r, r = 0), e.browserEvent && e.browserEvent.altKey && (i *= this._options.fastScrollSensitivity, r *= this._options.fastScrollSensitivity);
				let o = this._scrollable.getFutureScrollPosition(), s = {};
				if (r) {
					let e = Ta * r, t = o.scrollTop - (e < 0 ? Math.floor(e) : Math.ceil(e));
					this._verticalScrollbar.writeScrollPosition(s, t);
				}
				if (i) {
					let e = Ta * i, t = o.scrollLeft - (e < 0 ? Math.floor(e) : Math.ceil(e));
					this._horizontalScrollbar.writeScrollPosition(s, t);
				}
				s = this._scrollable.validateScrollPosition(s), (o.scrollLeft !== s.scrollLeft || o.scrollTop !== s.scrollTop) && (Ea && this._options.mouseWheelSmoothScroll && t.isPhysicalMouseWheel() ? this._scrollable.setScrollPositionSmooth(s) : this._scrollable.setScrollPositionNow(s), n = !0);
			}
			let r = n;
		...
		_render() {
			if (this._shouldRender && (this._shouldRender = !1, this._horizontalScrollbar.render(), this._verticalScrollbar.render(), this._options.useShadows)) {
				let e = this._scrollable.getCurrentScrollPosition(), t = e.scrollTop > 0, n = e.scrollLeft > 0, r = n ? " left" : "", i = t ? " top" : "", a = n || t ? " top-left-corner" : "";
				this._leftShadowDomNode.setClassName(`shadow${r}`), this._topShadowDomNode.setClassName(`shadow${i}`), this._topLeftShadowDomNode.setClassName(`shadow${a}${i}${r}`);
			}
		}
		_onDragStart() {
		...
		_scheduleHide() {
			!this._mouseIsOver && !this._isDragging && this._hideTimeout.cancelAndSet(() => this._hide(), wa);
		}
	}, ja = class extends Aa {
		constructor(e, t, n) {
			super(e, t, n);
		...
		constructor(e, t, n, r, i, a, o, s) {
			super(), this._bufferService = n, this._optionsService = o, this._renderService = s, this._onRequestScrollLines = this._register(new I()), this.onRequestScrollLines = this._onRequestScrollLines.event, this._isSyncing = !1, this._isHandlingScroll = !1, this._suppressOnScrollHandler = !1;
			let c = this._register(new ha({
				forceIntegerValues: !1,
				smoothScrollDuration: this._optionsService.rawOptions.smoothScrollDuration,
				scheduleAtNextAnimationFrame: (e) => ta(r.window, e)
			}));
			...
			})), this._scrollableElement = this._register(new ja(t, {
				vertical: 1,
				horizontal: 2,
				useShadows: !1,
				mouseWheelSmoothScroll: !0,
				...this._getChangeOptions()
			}, c)), this._register(this._optionsService.onMultipleOptionChange([
				"scrollSensitivity",
				"fastScrollSensitivity",
				"overviewRuler"
			], () => this._scrollableElement.updateOptions(this._getChangeOptions()))), this._register(i.onProtocolChange((e) => {
				this._scrollableElement.updateOptions({ handleMouseWheel: !(e & 16) });
			})), this._scrollableElement.setScrollDimensions({
				height: 0,
				scrollHeight: 0
			}), this._register(F.runAndSubscribe(a.onChangeColors, () => {
				this._scrollableElement.getDomNode().style.backgroundColor = a.colors.background.css;
			})), e.appendChild(this._scrollableElement.getDomNode()), this._register(T(() => this._scrollableElement.getDomNode().remove())), this._styleElement = r.mainDocument.createElement("style"), t.appendChild(this._styleElement), this._register(T(() => this._styleElement.remove())), this._register(F.runAndSubscribe(a.onChangeColors, () => {
		...
		constructor(e, t, n, r, i) {
			...
			})), this._register(this._decorationService.onDecorationRegistered(() => this._queueRefresh())), this._register(this._decorationService.onDecorationRemoved((e) => this._removeDecoration(e))), this._register(T(() => {
		...
		constructor(e, t, n, r, i, a, o, s) {
			super(), this._viewportElement = e, this._screenElement = t, this._bufferService = n, this._decorationService = r, this._renderService = i, this._optionsService = a, this._themeService = o, this._coreBrowserService = s, this._colorZoneStore = new Pa(), this._shouldUpdateDimensions = !0, this._shouldUpdateAnchor = !0, this._lastKnownBufferLength = 0, this._canvas = this._coreBrowserService.mainDocument.createElement("canvas"), this._canvas.classList.add("xterm-decoration-overview-ruler"), this._refreshCanvasDimensions(), this._viewportElement.parentElement?.insertBefore(this._canvas, this._viewportElement), this._register(T(() => this._canvas?.remove()));
		...
		_refreshDrawConstants() {
			...
			Ia.full = this._canvas.width, Ia.left = e, Ia.center = t, Ia.right = e, this._refreshDrawHeightConstants(), La.full = 1, La.left = 1, La.center = 1 + Ia.left, La.right = 1 + Ia.left + Ia.center;
		}
		_refreshDrawHeightConstants() {
			Fa.full = Math.round(2 * this._coreBrowserService.dpr);
			...
			Fa.left = t, Fa.center = t, Fa.right = t;
		}
		_refreshColorZonePadding() {
			this._colorZoneStore.setPadding({
				full: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Fa.full),
				left: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Fa.left),
				center: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Fa.center),
				right: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * Fa.right)
		...
		_renderColorZone(e) {
			this._ctx.fillStyle = e.color, this._ctx.fillRect(La[e.position || "full"], Math.round((this._canvas.height - 1) * (e.startBufferLine / this._bufferService.buffers.active.lines.length) - Fa[e.position || "full"] / 2), Ia[e.position || "full"], Math.round((this._canvas.height - 1) * ((e.endBufferLine - e.startBufferLine) / this._bufferService.buffers.active.lines.length) + Fa[e.position || "full"]));
		}
		_queueRefresh(e, t) {
		...
		A(6, er),
		A(7, Yn)
	], Ra), ((e) => (e.NUL = "\0", e.SOH = "", e.STX = "", e.ETX = "", e.EOT = "", e.ENQ = "", e.ACK = "", e.BEL = "\x07", e.BS = "\b", e.HT = "	", e.LF = "\n", e.VT = "\v", e.FF = "\f", e.CR = "\r", e.SO = "", e.SI = "", e.DLE = "", e.DC1 = "", e.DC2 = "", e.DC3 = "", e.DC4 = "", e.NAK = "", e.SYN = "", e.ETB = "", e.CAN = "", e.EM = "", e.SUB = "", e.ESC = "\x1B", e.FS = "", e.GS = "", e.RS = "", e.US = "", e.SP = " ", e.DEL = ""))(R ||= {}), ((e) => (e.PAD = "", e.HOP = "", e.BPH = "", e.NBH = "", e.IND = "", e.NEL = "", e.SSA = "", e.ESA = "", e.HTS = "", e.HTJ = "", e.VTS = "", e.PLD = "", e.PLU = "", e.RI = "", e.SS2 = "", e.SS3 = "", e.DCS = "", e.PU1 = "", e.PU2 = "", e.STS = "", e.CCH = "", e.MW = "", e.SPA = "", e.EPA = "", e.SOS = "", e.SGCI = "", e.SCI = "", e.CSI = "", e.ST = "", e.OSC = "", e.PM = "", e.APC = ""))(za ||= {}), ((e) => e.ST = `${R.ESC}\\`)(Ba ||= {}), Va = class {
		constructor(e, t, n, r, i, a) {
			this._textarea = e, this._compositionView = t, this._bufferService = n, this._optionsService = r, this._coreService = i, this._renderService = a, this._isComposing = !1, this._isSendingComposition = !1, this._compositionPosition = {
				start: 0,
				end: 0
			...
			if (this._compositionView.classList.remove("active"), this._isComposing = !1, e) {
				...
				this._isSendingComposition = !0, setTimeout(() => {
					if (this._isSendingComposition) {
						...
						let t;
						e.start += this._dataAlreadySent.length, t = this._isComposing ? this._textarea.value.substring(e.start, this._compositionPosition.start) : this._textarea.value.substring(e.start), t.length > 0 && this._coreService.triggerDataEvent(t, !0);
					}
				}, 0);
			} else {
				this._isSendingComposition = !1;
		...
		_handleAnyTextareaChanges() {
			...
			setTimeout(() => {
				if (!this._isComposing) {
					...
					this._dataAlreadySent = n, t.length > e.length ? this._coreService.triggerDataEvent(n, !0) : t.length < e.length ? this._coreService.triggerDataEvent(`${R.DEL}`, !0) : t.length === e.length && t !== e && this._coreService.triggerDataEvent(t, !0);
				}
			}, 0);
		}
		updateCompositionElements(e) {
			if (this._isComposing) {
				if (this._bufferService.buffer.isCursorInViewport) {
					...
					this._textarea.style.left = r + "px", this._textarea.style.top = n + "px", this._textarea.style.width = Math.max(i.width, 1) + "px", this._textarea.style.height = Math.max(i.height, 1) + "px", this._textarea.style.lineHeight = i.height + "px";
				}
		...
		A(4, Bn),
		A(5, Zn)
	], Va), z = 0, B = 0, V = 0, H = 0, Ha = {
		css: "#00000000",
		rgba: 0
	}, ((e) => {
		function t(e, t, n, r) {
			return r === void 0 ? `#${jt(e)}${jt(t)}${jt(n)}` : `#${jt(e)}${jt(t)}${jt(n)}${jt(r)}`;
		}
		e.toCss = t;
		...
		function t(e, t) {
			if (H = (t.rgba & 255) / 255, H === 1) return {
				css: t.css,
				rgba: t.rgba
			};
			let n = t.rgba >> 24 & 255, r = t.rgba >> 16 & 255, i = t.rgba >> 8 & 255, a = e.rgba >> 24 & 255, o = e.rgba >> 16 & 255, s = e.rgba >> 8 & 255;
			return z = a + Math.round((n - a) * H), B = o + Math.round((r - o) * H), V = s + Math.round((i - s) * H), {
				css: U.toCss(z, B, V),
				rgba: U.toRgba(z, B, V)
			};
		}
		...
		e.isOpaque = n;
		function r(e, t, n) {
			let r = Ua.ensureContrastRatio(e.rgba, t.rgba, n);
			if (r) return U.toColor(r >> 24 & 255, r >> 16 & 255, r >> 8 & 255);
		}
		e.ensureContrastRatio = r;
		function i(e) {
			let t = (e.rgba | 255) >>> 0;
			return [z, B, V] = Ua.toChannels(t), {
				css: U.toCss(z, B, V),
				rgba: t
			};
		}
		e.opaque = i;
		function a(e, t) {
			return H = Math.round(t * 255), [z, B, V] = Ua.toChannels(e.rgba), {
				css: U.toCss(z, B, V, H),
				rgba: U.toRgba(z, B, V, H)
			};
		}
		e.opacity = a;
		function o(e, t) {
			return H = e.rgba & 255, a(e, H * t / 255);
		}
		e.multiplyOpacity = o;
		function s(e) {
			return [
		...
		function r(e) {
			if (e.match(/#[\da-f]{3,8}/i)) switch (e.length) {
				case 4: return z = parseInt(e.slice(1, 2).repeat(2), 16), B = parseInt(e.slice(2, 3).repeat(2), 16), V = parseInt(e.slice(3, 4).repeat(2), 16), U.toColor(z, B, V);
				case 5: return z = parseInt(e.slice(1, 2).repeat(2), 16), B = parseInt(e.slice(2, 3).repeat(2), 16), V = parseInt(e.slice(3, 4).repeat(2), 16), H = parseInt(e.slice(4, 5).repeat(2), 16), U.toColor(z, B, V, H);
				case 7: return {
					css: e,
			...
			if (r) return z = parseInt(r[1]), B = parseInt(r[2]), V = parseInt(r[3]), H = Math.round((r[5] === void 0 ? 1 : parseFloat(r[5])) * 255), U.toColor(z, B, V, H);
			if (!t || !n || (t.fillStyle = n, t.fillStyle = e, typeof t.fillStyle != "string") || (t.fillRect(0, 0, 1, 1), [z, B, V, H] = t.getImageData(0, 0, 1, 1).data, H !== 255)) throw Error("css.toColor: Unsupported css format");
			return {
				rgba: U.toRgba(z, B, V, H),
				css: e
			};
		...
		function n(e, t, n) {
			let r = e / 255, i = t / 255, a = n / 255, o = r <= .03928 ? r / 12.92 : ((r + .055) / 1.055) ** 2.4, s = i <= .03928 ? i / 12.92 : ((i + .055) / 1.055) ** 2.4, c = a <= .03928 ? a / 12.92 : ((a + .055) / 1.055) ** 2.4;
			return o * .2126 + s * .7152 + c * .0722;
		}
		e.relativeLuminance2 = n;
	})(K ||= {}), ((e) => {
		function t(e, t) {
			if (H = (t & 255) / 255, H === 1) return t;
			let n = t >> 24 & 255, r = t >> 16 & 255, i = t >> 8 & 255, a = e >> 24 & 255, o = e >> 16 & 255, s = e >> 8 & 255;
			return z = a + Math.round((n - a) * H), B = o + Math.round((r - o) * H), V = s + Math.round((i - s) * H), U.toRgba(z, B, V);
		}
		e.blend = t;
		function n(e, t, n) {
			let a = K.relativeLuminance(e >> 8), o = K.relativeLuminance(t >> 8);
			if (Mt(a, o) < n) {
				if (o < a) {
					let o = r(e, t, n), s = Mt(a, K.relativeLuminance(o >> 8));
					if (s < n) {
						let r = i(e, t, n);
						return s > Mt(a, K.relativeLuminance(r >> 8)) ? o : r;
					}
					return o;
				}
				let s = i(e, t, n), c = Mt(a, K.relativeLuminance(s >> 8));
				if (c < n) {
					let i = r(e, t, n);
					return c > Mt(a, K.relativeLuminance(i >> 8)) ? s : i;
				}
				return s;
			}
		}
		...
		function r(e, t, n) {
			let r = e >> 24 & 255, i = e >> 16 & 255, a = e >> 8 & 255, o = t >> 24 & 255, s = t >> 16 & 255, c = t >> 8 & 255, l = Mt(K.relativeLuminance2(o, s, c), K.relativeLuminance2(r, i, a));
			for (; l < n && (o > 0 || s > 0 || c > 0);) o -= Math.max(0, Math.ceil(o * .1)), s -= Math.max(0, Math.ceil(s * .1)), c -= Math.max(0, Math.ceil(c * .1)), l = Mt(K.relativeLuminance2(o, s, c), K.relativeLuminance2(r, i, a));
			return (o << 24 | s << 16 | c << 8 | 255) >>> 0;
		}
		e.reduceLuminance = r;
		function i(e, t, n) {
			let r = e >> 24 & 255, i = e >> 16 & 255, a = e >> 8 & 255, o = t >> 24 & 255, s = t >> 16 & 255, c = t >> 8 & 255, l = Mt(K.relativeLuminance2(o, s, c), K.relativeLuminance2(r, i, a));
			for (; l < n && (o < 255 || s < 255 || c < 255);) o = Math.min(255, o + Math.ceil((255 - o) * .1)), s = Math.min(255, s + Math.ceil((255 - s) * .1)), c = Math.min(255, c + Math.ceil((255 - c) * .1)), l = Mt(K.relativeLuminance2(o, s, c), K.relativeLuminance2(r, i, a));
			return (o << 24 | s << 16 | c << 8 | 255) >>> 0;
		}
		...
		constructor(e) {
			this._bufferService = e, this._characterJoiners = [], this._nextCharacterJoinerId = 0, this._workCell = new Fn();
		}
		register(e) {
			let t = {
		...
		getJoinedCharacters(e) {
			...
			let n = [], r = t.translateToString(!0), i = 0, a = 0, o = 0, s = t.getFg(0), c = t.getBg(0);
			for (let e = 0; e < t.getTrimmedLength(); e++) if (t.loadCell(e, this._workCell), this._workCell.getWidth() !== 0) {
				...
				a += this._workCell.getChars().length || Mn.length;
			}
		...
		_getJoinedRanges(e, t, n, r, i) {
			...
			for (let e = 1; e < this._characterJoiners.length; e++) try {
				...
				for (let e = 0; e < t.length; e++) Ga._mergeRanges(o, t[e]);
			} catch (e) {
				console.error(e);
			}
		...
		_stringRangesToCellRanges(e, t, n) {
			let r = 0, i = !1, a = 0, o = e[r];
			if (o) {
				for (let s = n; s < this._bufferService.cols; s++) {
					let n = t.getWidth(s), c = t.getString(s).length || Mn.length;
					if (n !== 0) {
	...
	}, Ga = k([A(0, j)], Ga), Ka = class {
		constructor(e, t, n, r, i, a, o) {
			this._document = e, this._characterJoinerService = t, this._optionsService = n, this._coreBrowserService = r, this._coreService = i, this._decorationService = a, this._themeService = o, this._workCell = new Fn(), this._columnSelectMode = !1, this.defaultSpacing = 0;
		}
		...
		createRow(e, t, n, r, i, a, o, s, c, l, u) {
			let d = [], f = this._characterJoinerService.getJoinedCharacters(t), p = this._themeService.colors, m = e.getNoBgTrimmedLength();
			n && m < a + 1 && (m = a + 1);
			let h, g = 0, _ = "", v = 0, ee = 0, te = 0, ne = 0, y = !1, re = 0, ie = !1, b = 0, ae = 0, x = [], oe = l !== -1 && u !== -1;
			for (let S = 0; S < m; S++) {
				e.loadCell(S, this._workCell);
				let m = this._workCell.getWidth();
				if (m === 0) continue;
				let se = !1, ce = S >= ae, le = S, C = this._workCell;
				if (f.length > 0 && S === f[0][0] && ce) {
					let r = f.shift(), i = this._isCellInSelection(r[0], t);
					for (v = r[0] + 1; v < r[1]; v++) ce &&= i === this._isCellInSelection(v, t);
					ce &&= !n || a < r[0] || a >= r[1], ce ? (se = !0, C = new Wa(this._workCell, e.translateToString(!0, r[0], r[1]), r[1] - r[0]), le = r[1] - 1, m = C.getWidth()) : ae = r[1];
				}
				let ue = this._isCellInSelection(S, t), de = n && S === a, fe = oe && S >= l && S <= u, pe = !1;
				this._decorationService.forEachDecorationAtCell(S, t, void 0, (e) => {
					pe = !0;
				});
				let me = C.getChars() || Mn;
				if (me === " " && (C.isUnderline() || C.isOverline()) && (me = "\xA0"), b = m * s - c.get(me, C.isBold(), C.isItalic()), !h) h = this._document.createElement("span");
				else if (g && (ue && ie || !ue && !ie && C.bg === ee) && (ue && ie && p.selectionForeground || C.fg === te) && C.extended.ext === ne && fe === y && b === re && !de && !se && !pe && ce) {
					C.isInvisible() ? _ += Mn : _ += me, g++;
					continue;
				} else g && (h.textContent = _), h = this._document.createElement("span"), g = 0, _ = "";
				if (ee = C.bg, te = C.fg, ne = C.extended.ext, y = fe, re = b, ie = ue, se && a >= S && a <= le && (a = S), !this._coreService.isCursorHidden && de && this._coreService.isCursorInitialized) {
					if (x.push("xterm-cursor"), this._coreBrowserService.isFocused) o && x.push("xterm-cursor-blink"), x.push(r === "bar" ? "xterm-cursor-bar" : r === "underline" ? "xterm-cursor-underline" : "xterm-cursor-block");
					else if (i) switch (i) {
						case "outline":
				...
				if (C.isBold() && x.push("xterm-bold"), C.isItalic() && x.push("xterm-italic"), C.isDim() && x.push("xterm-dim"), _ = C.isInvisible() ? Mn : C.getChars() || Mn, C.isUnderline() && (x.push(`xterm-underline-${C.extended.underlineStyle}`), _ === " " && (_ = "\xA0"), !C.isUnderlineColorDefault())) if (C.isUnderlineColorRGB()) h.style.textDecorationColor = `rgb(${Nn.toColorRGB(C.getUnderlineColor()).join(",")})`;
				else {
					let e = C.getUnderlineColor();
					this._optionsService.rawOptions.drawBoldTextInBrightColors && C.isBold() && e < 8 && (e += 8), h.style.textDecorationColor = p.ansi[e].css;
				}
				C.isOverline() && (x.push("xterm-overline"), _ === " " && (_ = "\xA0")), C.isStrikethrough() && x.push("xterm-strikethrough"), fe && (h.style.textDecoration = "underline");
				let he = C.getFgColor(), ge = C.getFgColorMode(), _e = C.getBgColor(), ve = C.getBgColorMode(), ye = !!C.isInverse();
				if (ye) {
					let e = he;
					he = _e, _e = e;
					let t = ge;
				...
				let be, xe, Se = !1;
				this._decorationService.forEachDecorationAtCell(S, t, void 0, (e) => {
					e.options.layer !== "top" && Se || (e.backgroundColorRGB && (ve = 50331648, _e = e.backgroundColorRGB.rgba >> 8 & 16777215, be = e.backgroundColorRGB), e.foregroundColorRGB && (ge = 50331648, he = e.foregroundColorRGB.rgba >> 8 & 16777215, xe = e.foregroundColorRGB), Se = e.options.layer === "top");
				}), !Se && ue && (be = this._coreBrowserService.isFocused ? p.selectionBackgroundOpaque : p.selectionInactiveBackgroundOpaque, _e = be.rgba >> 8 & 16777215, ve = 50331648, Se = !0, p.selectionForeground && (ge = 50331648, he = p.selectionForeground.rgba >> 8 & 16777215, xe = p.selectionForeground)), Se && x.push("xterm-decoration-top");
				let Ce;
				switch (ve) {
					case 16777216:
					case 33554432:
						Ce = p.ansi[_e], x.push(`xterm-bg-${_e}`);
						break;
					case 50331648:
						Ce = U.toColor(_e >> 16, _e >> 8 & 255, _e & 255), this._addStyle(h, `background-color:#${Rt((_e >>> 0).toString(16), "0", 6)}`);
						break;
					default: ye ? (Ce = p.foreground, x.push("xterm-bg-257")) : Ce = p.background;
				}
				switch (be || C.isDim() && (be = W.multiplyOpacity(Ce, .5)), ge) {
					case 16777216:
					case 33554432:
						C.isBold() && he < 8 && this._optionsService.rawOptions.drawBoldTextInBrightColors && (he += 8), this._applyMinimumContrast(h, Ce, p.ansi[he], C, be, void 0) || x.push(`xterm-fg-${he}`);
						break;
					case 50331648:
						let e = U.toColor(he >> 16 & 255, he >> 8 & 255, he & 255);
						this._applyMinimumContrast(h, Ce, e, C, be, xe) || this._addStyle(h, `color:#${Rt(he.toString(16), "0", 6)}`);
						break;
					default: this._applyMinimumContrast(h, Ce, p.foreground, C, be, xe) || ye && x.push("xterm-fg-257");
				}
				x.length &&= (h.className = x.join(" "), 0), !de && !se && !pe && ce ? g++ : h.textContent = _, b !== this.defaultSpacing && (h.style.letterSpacing = `${b}px`), d.push(h), S = le;
			}
			return h && g && (h.textContent = _), d;
		}
		_applyMinimumContrast(e, t, n, r, i, a) {
			if (this._optionsService.rawOptions.minimumContrastRatio === 1 || Ft(r.getCode())) return !1;
			let o = this._getContrastCache(r), s;
			if (!i && !a && (s = o.getColor(t.rgba, n.rgba)), s === void 0) {
				let e = this._optionsService.rawOptions.minimumContrastRatio / (r.isDim() ? 2 : 1);
				s = W.ensureContrastRatio(i || t, a || n, e), o.setColor((i || t).rgba, (a || n).rgba, s ?? null);
			}
		...
		constructor(e, t) {
			...
			a.classList.add("xterm-char-measure-element"), a.style.fontWeight = "bold", a.style.fontStyle = "italic", this._measureElements = [
				n,
				r,
				i,
				a
			], this._container.appendChild(n), this._container.appendChild(r), this._container.appendChild(i), this._container.appendChild(a), t.appendChild(this._container), this.clear();
		}
		dispose() {
		...
		get(e, t, n) {
			...
			if (a === void 0) {
				let r = 0;
				t && (r |= 1), n && (r |= 2), a = this._measure(e, r), a > 0 && this._holey.set(i, a);
			}
			return a;
		}
		_measure(e, t) {
		...
		update(e, t, n, r = !1) {
			...
			let i = e.buffers.active.ydisp, a = t[1] - i, o = n[1] - i, s = Math.max(a, 0), c = Math.min(o, e.rows - 1);
			if (s >= e.rows || c < 0) {
				this.clear();
				return;
			}
			this.hasSelection = !0, this.columnSelectMode = r, this.viewportStartRow = a, this.viewportEndRow = o, this.viewportCappedStartRow = s, this.viewportCappedEndRow = c, this.startCol = t[0], this.endCol = n[0];
		}
	...
	}, Ya = "xterm-dom-renderer-owner-", Xa = "xterm-rows", Za = "xterm-fg-", Qa = "xterm-bg-", $a = "xterm-focus", eo = "xterm-selection", to = 1, no = class extends N {
		constructor(e, t, n, r, i, a, o, s, c, l, u, d, f, p) {
			super(), this._terminal = e, this._document = t, this._element = n, this._screenElement = r, this._viewportElement = i, this._helperContainer = a, this._linkifier2 = o, this._charSizeService = c, this._optionsService = l, this._bufferService = u, this._coreService = d, this._coreBrowserService = f, this._themeService = p, this._terminalClass = to++, this._rowElements = [], this._selectionRenderModel = zt(), this.onRequestRedraw = this._register(new I()).event, this._rowContainer = this._document.createElement("div"), this._rowContainer.classList.add(Xa), this._rowContainer.style.lineHeight = "normal", this._rowContainer.setAttribute("aria-hidden", "true"), this._refreshRowElements(this._bufferService.cols, this._bufferService.rows), this._selectionContainer = this._document.createElement("div"), this._selectionContainer.classList.add(eo), this._selectionContainer.setAttribute("aria-hidden", "true"), this.dimensions = It(), this._updateDimensions(), this._register(this._optionsService.onOptionChange(() => this._handleOptionsChanged())), this._register(this._themeService.onChangeColors((e) => this._injectCss(e))), this._injectCss(this._themeService.colors), this._rowFactory = s.createInstance(Ka, document), this._element.classList.add(Ya + this._terminalClass), this._screenElement.appendChild(this._rowContainer), this._screenElement.appendChild(this._selectionContainer), this._register(this._linkifier2.onShowLinkUnderline((e) => this._handleLinkHover(e))), this._register(this._linkifier2.onHideLinkUnderline((e) => this._handleLinkLeave(e))), this._register(T(() => {
				this._element.classList.remove(Ya + this._terminalClass), this._rowContainer.remove(), this._selectionContainer.remove(), this._widthCache.dispose(), this._themeStyleElement.remove(), this._dimensionsStyleElement.remove();
			})), this._widthCache = new qa(this._document, this._helperContainer), this._widthCache.setFont(this._optionsService.rawOptions.fontFamily, this._optionsService.rawOptions.fontSize, this._optionsService.rawOptions.fontWeight, this._optionsService.rawOptions.fontWeightBold), this._setDefaultSpacing();
		}
		_updateDimensions() {
			...
			let t = `${this._terminalSelector} .${Xa} span { display: inline-block; height: 100%; vertical-align: top;}`;
		...
		_injectCss(e) {
			...
			let t = `${this._terminalSelector} .${Xa} { pointer-events: none; color: ${e.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
			t += `${this._terminalSelector} .${Xa} .xterm-dim { color: ${W.multiplyOpacity(e.foreground, .5).css};}`, t += `${this._terminalSelector} span:not(.xterm-bold) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.xterm-bold { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.xterm-italic { font-style: italic;}`;
			let n = `blink_underline_${this._terminalClass}`, r = `blink_bar_${this._terminalClass}`, i = `blink_block_${this._terminalClass}`;
			t += `@keyframes ${n} { 50% {  border-bottom-style: hidden; }}`, t += `@keyframes ${r} { 50% {  box-shadow: none; }}`, t += `@keyframes ${i} { 0% {  background-color: ${e.cursor.css};  color: ${e.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${e.cursor.css}; }}`, t += `${this._terminalSelector} .${Xa}.${$a} .xterm-cursor.xterm-cursor-blink.xterm-cursor-underline { animation: ${n} 1s step-end infinite;}${this._terminalSelector} .${Xa}.${$a} .xterm-cursor.xterm-cursor-blink.xterm-cursor-bar { animation: ${r} 1s step-end infinite;}${this._terminalSelector} .${Xa}.${$a} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: ${i} 1s step-end infinite;}${this._terminalSelector} .${Xa} .xterm-cursor.xterm-cursor-block { background-color: ${e.cursor.css}; color: ${e.cursorAccent.css};}${this._terminalSelector} .${Xa} .xterm-cursor.xterm-cursor-block:not(.xterm-cursor-blink) { background-color: ${e.cursor.css} !important; color: ${e.cursorAccent.css} !important;}${this._terminalSelector} .${Xa} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${e.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${Xa} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${e.cursor.css} inset;}${this._terminalSelector} .${Xa} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${e.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`, t += `${this._terminalSelector} .${eo} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${eo} div { position: absolute; background-color: ${e.selectionBackgroundOpaque.css};}${this._terminalSelector} .${eo} div { position: absolute; background-color: ${e.selectionInactiveBackgroundOpaque.css};}`;
			for (let [n, r] of e.ansi.entries()) t += `${this._terminalSelector} .${Za}${n} { color: ${r.css}; }${this._terminalSelector} .${Za}${n}.xterm-dim { color: ${W.multiplyOpacity(r, .5).css}; }${this._terminalSelector} .${Qa}${n} { background-color: ${r.css}; }`;
			t += `${this._terminalSelector} .${Za}257 { color: ${W.opaque(e.background).css}; }${this._terminalSelector} .${Za}257.xterm-dim { color: ${W.multiplyOpacity(W.opaque(e.background), .5).css}; }${this._terminalSelector} .${Qa}257 { background-color: ${e.foreground.css}; }`, this._themeStyleElement.textContent = t;
		}
		_setDefaultSpacing() {
		...
		handleSelectionChanged(e, t, n) {
			if (this._selectionContainer.replaceChildren(), this._rowFactory.handleSelectionChanged(e, t, n), this.renderRows(0, this._bufferService.rows - 1), !e || !t || (this._selectionRenderModel.update(this._terminal, e, t, n), !this._selectionRenderModel.hasSelection)) return;
			let r = this._selectionRenderModel.viewportStartRow, i = this._selectionRenderModel.viewportEndRow, a = this._selectionRenderModel.viewportCappedStartRow, o = this._selectionRenderModel.viewportCappedEndRow, s = this._document.createDocumentFragment();
			if (n) {
				let n = e[0] > t[0];
				s.appendChild(this._createSelectionElement(a, n ? t[0] : e[0], n ? e[0] : t[0], o - a + 1));
			} else {
				let n = r === a ? e[0] : 0, c = a === i ? t[0] : this._bufferService.cols;
				s.appendChild(this._createSelectionElement(a, n, c));
				let l = o - a - 1;
				if (s.appendChild(this._createSelectionElement(a + 1, 0, this._bufferService.cols, l)), a !== o) {
		...
		_createSelectionElement(e, t, n, r = 1) {
			let i = this._document.createElement("div"), a = t * this.dimensions.css.cell.width, o = this.dimensions.css.cell.width * (n - t);
			return a + o > this.dimensions.css.canvas.width && (o = this.dimensions.css.canvas.width - a), i.style.height = `${r * this.dimensions.css.cell.height}px`, i.style.top = `${e * this.dimensions.css.cell.height}px`, i.style.left = `${a}px`, i.style.width = `${o}px`, i;
		}
		handleCursorMove() {}
		...
		renderRows(e, t) {
			let n = this._bufferService.buffer, r = n.ybase + n.y, i = Math.min(n.x, this._bufferService.cols - 1), a = this._coreService.decPrivateModes.cursorBlink ?? this._optionsService.rawOptions.cursorBlink, o = this._coreService.decPrivateModes.cursorStyle ?? this._optionsService.rawOptions.cursorStyle, s = this._optionsService.rawOptions.cursorInactiveStyle;
			for (let c = e; c <= t; c++) {
				let e = c + n.ydisp, t = this._rowElements[c], l = n.lines.get(e);
				if (!t || !l) break;
				t.replaceChildren(...this._rowFactory.createRow(l, e, e === r, o, s, i, a, this.dimensions.css.cell.width, this._widthCache, -1, -1));
			}
		}
		get _terminalSelector() {
			return `.${Ya}${this._terminalClass}`;
		}
		_handleLinkHover(e) {
		...
		_setCellUnderline(e, t, n, r, i, a) {
			...
			n = Math.max(Math.min(n, o), 0), r = Math.max(Math.min(r, o), 0), i = Math.min(i, this._bufferService.cols);
			let s = this._bufferService.buffer, c = s.ybase + s.y, l = Math.min(s.x, i - 1), u = this._optionsService.rawOptions.cursorBlink, d = this._optionsService.rawOptions.cursorStyle, f = this._optionsService.rawOptions.cursorInactiveStyle;
			for (let o = n; o <= r; ++o) {
				let p = o + s.ydisp, m = this._rowElements[o], h = s.lines.get(p);
				if (!m || !h) break;
				m.replaceChildren(...this._rowFactory.createRow(h, p, p === c, d, f, l, u, this.dimensions.css.cell.width, this._widthCache, a ? o === n ? e : 0 : -1, a ? (o === r ? t : i) - 1 : -1));
			}
		}
	}, no = k([
		A(7, Hn),
		...
		A(12, Yn),
		A(13, er)
	], no), ro = class extends N {
		constructor(e, t, n) {
			super(), this._optionsService = n, this.width = 0, this.height = 0, this._onCharSizeChange = this._register(new I()), this.onCharSizeChange = this._onCharSizeChange.event;
			try {
				this._measureStrategy = this._register(new oo(this._optionsService));
			} catch {
				this._measureStrategy = this._register(new ao(e, t, this._optionsService));
			}
	...
	}, ro = k([A(2, M)], ro), io = class extends N {
		constructor() {
		...
		constructor(e, t, n) {
			super(), this._textarea = e, this._window = t, this.mainDocument = n, this._isFocused = !1, this._cachedIsFocused = void 0, this._screenDprMonitor = this._register(new co(this._window)), this._onDprChange = this._register(new I()), this.onDprChange = this._onDprChange.event, this._onWindowChange = this._register(new I()), this.onWindowChange = this._onWindowChange.event, this._register(this.onWindowChange((e) => this._screenDprMonitor.setWindow(e))), this._register(F.forward(this._screenDprMonitor.onDprChange, this._onDprChange)), this._register(E(this._textarea, "focus", () => this._isFocused = !0)), this._register(E(this._textarea, "blur", () => this._isFocused = !1));
		}
		get window() {
			return this._window;
		}
		...
		constructor(e) {
			super(), this._parentWindow = e, this._windowResizeListener = this._register(new yr()), this._onDprChange = this._register(new I()), this.onDprChange = this._onDprChange.event, this._outerListener = () => this._setDprAndFireIfDiffers(), this._currentDevicePixelRatio = this._parentWindow.devicePixelRatio, this._updateDpr(), this._setWindowResizeListener(), this._register(T(() => this.clearListener()));
		}
		setWindow(e) {
			this._parentWindow = e, this._setWindowResizeListener(), this._setDprAndFireIfDiffers();
		}
		_setWindowResizeListener() {
			this._windowResizeListener.value = E(this._parentWindow, "resize", () => this._setDprAndFireIfDiffers());
		}
		...
		constructor() {
			super(), this.linkProviders = [], this._register(T(() => this.linkProviders.length = 0));
		}
		...
		getCoords(e, t, n, r, i) {
			return Vt(window, e, t, n, r, this._charSizeService.hasValidSize, this._renderService.dimensions.css.cell.width, this._renderService.dimensions.css.cell.height, i);
		}
	...
	}, uo = k([A(0, Zn), A(1, Jn)], uo), fo = class {
		constructor(e, t) {
			this._renderCallback = e, this._coreBrowserService = t, this._refreshCallbacks = [];
		}
		dispose() {
			this._animationFrame &&= (this._coreBrowserService.window.cancelAnimationFrame(this._animationFrame), void 0);
		}
		...
		refresh(e, t, n) {
			this._rowCount = n, e = e === void 0 ? 0 : e, t = t === void 0 ? this._rowCount - 1 : t, this._rowStart = this._rowStart === void 0 ? e : Math.min(this._rowStart, e), this._rowEnd = this._rowEnd === void 0 ? t : Math.max(this._rowEnd, t), !this._animationFrame && (this._animationFrame = this._coreBrowserService.window.requestAnimationFrame(() => this._innerRefresh()));
		}
		_innerRefresh() {
		...
		isSafari: () => yo,
		isWindows: () => Co
	}), mo = typeof process < "u" && "title" in process, ho = mo ? "node" : navigator.userAgent, go = mo ? "node" : navigator.platform, _o = ho.includes("Firefox"), vo = ho.includes("Edge"), yo = /^((?!chrome|android).)*safari/i.test(ho), bo = [
		"Macintosh",
		"MacIntel",
		"MacPPC",
		"Mac68K"
	].includes(go), xo = go === "iPad", So = go === "iPhone", Co = [
		"Windows",
		"Win16",
		"Win32",
		"WinCE"
	].includes(go), wo = go.indexOf("Linux") >= 0, To = /\bCrOS\b/.test(ho), Eo = class {
		constructor() {
		...
		_process(e) {
			...
			let t = 0, n = 0, r = e.timeRemaining(), i = 0;
	...
	}, ko = !mo && "requestIdleCallback" in window ? Oo : Do, Ao = class {
		constructor() {
			this._queue = new ko();
		}
		set(e) {
		...
		constructor(e, t, n, r, i, a, o, s, c) {
			super(), this._rowCount = e, this._optionsService = n, this._charSizeService = r, this._coreService = i, this._coreBrowserService = s, this._renderer = this._register(new yr()), this._pausedResizeTask = new Ao(), this._observerDisposable = this._register(new yr()), this._isPaused = !1, this._needsFullRefresh = !1, this._isNextRenderRedrawOnly = !0, this._needsSelectionRefresh = !1, this._canvasWidth = 0, this._canvasHeight = 0, this._selectionState = {
				start: void 0,
				end: void 0,
				columnSelectMode: !1
			}, this._onDimensionsChange = this._register(new I()), this.onDimensionsChange = this._onDimensionsChange.event, this._onRenderedViewportChange = this._register(new I()), this.onRenderedViewportChange = this._onRenderedViewportChange.event, this._onRender = this._register(new I()), this.onRender = this._onRender.event, this._onRefreshRequest = this._register(new I()), this.onRefreshRequest = this._onRefreshRequest.event, this._renderDebouncer = new fo((e, t) => this._renderRows(e, t), this._coreBrowserService), this._register(this._renderDebouncer), this._syncOutputHandler = new Mo(this._coreBrowserService, this._coreService, () => this._fullRefresh()), this._register(T(() => this._syncOutputHandler.dispose())), this._register(this._coreBrowserService.onDprChange(() => this.handleDevicePixelRatioChange())), this._register(o.onResize(() => this._fullRefresh())), this._register(o.buffers.onBufferActivate(() => this._renderer.value?.clear())), this._register(this._optionsService.onOptionChange(() => this._handleOptionsChanged())), this._register(this._charSizeService.onCharSizeChange(() => this.handleCharSizeChanged())), this._register(a.onDecorationRegistered(() => this._fullRefresh())), this._register(a.onDecorationRemoved(() => this._fullRefresh())), this._register(this._optionsService.onMultipleOptionChange([
				"customGlyphs",
		...
		_registerIntersectionObserver(e, t) {
			if ("IntersectionObserver" in e) {
				...
				n.observe(t), this._observerDisposable.value = T(() => n.disconnect());
			}
		}
		...
		refreshRows(e, t, n = !1) {
			...
			r && (e = Math.min(e, r.start), t = Math.max(t, r.end)), n || (this._isNextRenderRedrawOnly = !1), this._renderDebouncer.refresh(e, t, this._rowCount);
		}
		_renderRows(e, t) {
	...
	}, Po = 50, Fo = 15, Io = 50, Lo = 500, Ro = /* @__PURE__ */ RegExp("\xA0", "g"), zo = class extends N {
		constructor(e, t, n, r, i, a, o, s, c) {
			super(), this._element = e, this._screenElement = t, this._linkifier = n, this._bufferService = r, this._coreService = i, this._mouseService = a, this._optionsService = o, this._renderService = s, this._coreBrowserService = c, this._dragScrollAmount = 0, this._enabled = !0, this._workCell = new Fn(), this._mouseDownTimeStamp = 0, this._oldHasSelection = !1, this._oldSelectionStart = void 0, this._oldSelectionEnd = void 0, this._onLinuxMouseSelection = this._register(new I()), this.onLinuxMouseSelection = this._onLinuxMouseSelection.event, this._onRedrawRequest = this._register(new I()), this.onRequestRedraw = this._onRedrawRequest.event, this._onSelectionChange = this._register(new I()), this.onSelectionChange = this._onSelectionChange.event, this._onRequestScrollLines = this._register(new I()), this.onRequestScrollLines = this._onRequestScrollLines.event, this._mouseMoveListener = (e) => this._handleMouseMove(e), this._mouseUpListener = (e) => this._handleMouseUp(e), this._coreService.onUserInput(() => {
				this.hasSelection && this.clearSelection();
			}), this._trimListener = this._bufferService.buffer.lines.onTrim((e) => this._handleTrim(e)), this._register(this._bufferService.buffers.onBufferActivate((e) => this._handleBufferActivate(e))), this.enable(), this._model = new No(this._bufferService), this._activeSelectionMode = 0, this._register(T(() => {
		...
		get selectionText() {
			...
			if (this._activeSelectionMode === 3) {
				if (e[0] === t[0]) return "";
				let i = e[0] < t[0] ? e[0] : t[0], a = e[0] < t[0] ? t[0] : e[0];
			...
			return r.map((e) => e.replace(Ro, " ")).join(Co ? "\r\n" : "\n");
		}
		clearSelection() {
			this._model.clearSelection(), this._removeMouseDownListeners(), this.refresh(), this._onSelectionChange.fire();
		}
		refresh(e) {
			this._refreshAnimationFrame ||= this._coreBrowserService.window.requestAnimationFrame(() => this._refresh()), wo && e && this.selectionText.length && this._onLinuxMouseSelection.fire(this.selectionText);
		}
		_refresh() {
		...
		_selectWordAtCursor(e, t) {
			...
			if (n) return this._model.selectionStart = [n.start.x - 1, n.start.y - 1], this._model.selectionStartLength = nn(n, this._bufferService.cols), this._model.selectionEnd = void 0, !0;
		...
		_getMouseEventScrollAmount(e) {
			let t = Bt(this._coreBrowserService.window, e, this._screenElement)[1], n = this._renderService.dimensions.css.canvas.height;
			return t >= 0 && t <= n ? 0 : (t > n && (t -= n), t = Math.min(Math.max(t, -Po), Po), t /= Po, t / Math.abs(t) + Math.round(t * (Fo - 1)));
		}
		shouldForceSelection(e) {
			return bo ? e.altKey && this._optionsService.rawOptions.macOptionClickForcesSelection : e.shiftKey;
		}
		handleMouseDown(e) {
		...
		_addMouseDownListeners() {
			this._screenElement.ownerDocument && (this._screenElement.ownerDocument.addEventListener("mousemove", this._mouseMoveListener), this._screenElement.ownerDocument.addEventListener("mouseup", this._mouseUpListener)), this._dragScrollIntervalTimer = this._coreBrowserService.window.setInterval(() => this._dragScroll(), Io);
		}
		...
		shouldColumnSelect(e) {
			return e.altKey && !(bo && this._optionsService.rawOptions.macOptionClickForcesSelection);
		}
		_handleMouseMove(e) {
		...
		_handleMouseUp(e) {
			...
			if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && t < Lo && e.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
				if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
					let t = this._mouseService.getCoords(e, this._element, this._bufferService.cols, this._bufferService.rows, !1);
					if (t && t[0] !== void 0 && t[1] !== void 0) {
						let e = Ut(t[0] - 1, t[1] - 1, this._bufferService, this._coreService.decPrivateModes.applicationCursorKeys);
						this._coreService.triggerDataEvent(e, !0);
					}
				}
		...
		_getWordAt(e, t, n = !0, r = !0) {
			...
			let i = this._bufferService.buffer, a = i.lines.get(e[1]);
			if (!a) return;
			let o = i.translateBufferLineToString(e[1], !1), s = this._convertViewportColToCharacterIndex(a, e[0]), c = s, l = e[0] - s, u = 0, d = 0, f = 0, p = 0;
			if (o.charAt(s) === " ") {
				...
				for (r > 1 && (p += r - 1, c += r - 1); t > 0 && s > 0 && !this._isCharWordSeparator(a.loadCell(t - 1, this._workCell));) {
					a.loadCell(t - 1, this._workCell);
					let e = this._workCell.getChars().length;
					this._workCell.getWidth() === 0 ? (u++, t--) : e > 1 && (f += e - 1, s -= e - 1), s--, t--;
				}
				for (; n < a.length && c + 1 < o.length && !this._isCharWordSeparator(a.loadCell(n + 1, this._workCell));) {
					a.loadCell(n + 1, this._workCell);
					let e = this._workCell.getChars().length;
					this._workCell.getWidth() === 2 ? (d++, n++) : e > 1 && (p += e - 1, c += e - 1), c++, n++;
				}
			}
			c++;
			let m = s + l - u + f, h = Math.min(this._bufferService.cols, c - s + u + d - f - p);
			if (!(!t && o.slice(s, c).trim() === "")) {
				...
				if (r && m + h === this._bufferService.cols && a.getCodePoint(this._bufferService.cols - 1) !== 32) {
					let t = i.lines.get(e[1] + 1);
		...
		_selectLineAt(e) {
			...
			this._model.selectionStart = [0, t.first], this._model.selectionEnd = void 0, this._model.selectionStartLength = nn(n, this._bufferService.cols);
		}
	}, zo = k([
		A(3, j),
		A(4, Bn),
		...
		for (let n = 0; n < 216; n++) {
			let r = t[n / 36 % 6 | 0], i = t[n / 6 % 6 | 0], a = t[n % 6];
			e.push({
				css: U.toCss(r, i, a),
				rgba: U.toRgba(r, i, a)
			});
		...
		return e;
	})()), Ho = G.toColor("#ffffff"), Uo = G.toColor("#000000"), Wo = G.toColor("#ffffff"), Go = Uo, Ko = {
		css: "rgba(255, 255, 255, 0.3)",
		rgba: 4294967117
	}, qo = Ho, Jo = class extends N {
		constructor(e) {
			super(), this._optionsService = e, this._contrastCache = new Vo(), this._halfContrastCache = new Vo(), this._onChangeColors = this._register(new I()), this.onChangeColors = this._onChangeColors.event, this._colors = {
				foreground: Ho,
				background: Uo,
				cursor: Wo,
				cursorAccent: Go,
				selectionForeground: void 0,
				selectionBackgroundTransparent: Ko,
				selectionBackgroundOpaque: W.blend(Uo, Ko),
				selectionInactiveBackgroundTransparent: Ko,
				selectionInactiveBackgroundOpaque: W.blend(Uo, Ko),
				scrollbarSliderBackground: W.opacity(Ho, .2),
				scrollbarSliderHoverBackground: W.opacity(Ho, .4),
				scrollbarSliderActiveBackground: W.opacity(Ho, .5),
				overviewRulerBorder: Ho,
				ansi: q.slice(),
		...
		_setTheme(e = {}) {
			let t = this._colors;
			if (t.foreground = O(e.foreground, Ho), t.background = O(e.background, Uo), t.cursor = W.blend(t.background, O(e.cursor, Wo)), t.cursorAccent = W.blend(t.background, O(e.cursorAccent, Go)), t.selectionBackgroundTransparent = O(e.selectionBackground, Ko), t.selectionBackgroundOpaque = W.blend(t.background, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundTransparent = O(e.selectionInactiveBackground, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundOpaque = W.blend(t.background, t.selectionInactiveBackgroundTransparent), t.selectionForeground = e.selectionForeground ? O(e.selectionForeground, Ha) : void 0, t.selectionForeground === Ha && (t.selectionForeground = void 0), W.isOpaque(t.selectionBackgroundTransparent) && (t.selectionBackgroundTransparent = W.opacity(t.selectionBackgroundTransparent, .3)), W.isOpaque(t.selectionInactiveBackgroundTransparent) && (t.selectionInactiveBackgroundTransparent = W.opacity(t.selectionInactiveBackgroundTransparent, .3)), t.scrollbarSliderBackground = O(e.scrollbarSliderBackground, W.opacity(t.foreground, .2)), t.scrollbarSliderHoverBackground = O(e.scrollbarSliderHoverBackground, W.opacity(t.foreground, .4)), t.scrollbarSliderActiveBackground = O(e.scrollbarSliderActiveBackground, W.opacity(t.foreground, .5)), t.overviewRulerBorder = O(e.overviewRulerBorder, qo), t.ansi = q.slice(), t.ansi[0] = O(e.black, q[0]), t.ansi[1] = O(e.red, q[1]), t.ansi[2] = O(e.green, q[2]), t.ansi[3] = O(e.yellow, q[3]), t.ansi[4] = O(e.blue, q[4]), t.ansi[5] = O(e.magenta, q[5]), t.ansi[6] = O(e.cyan, q[6]), t.ansi[7] = O(e.white, q[7]), t.ansi[8] = O(e.brightBlack, q[8]), t.ansi[9] = O(e.brightRed, q[9]), t.ansi[10] = O(e.brightGreen, q[10]), t.ansi[11] = O(e.brightYellow, q[11]), t.ansi[12] = O(e.brightBlue, q[12]), t.ansi[13] = O(e.brightMagenta, q[13]), t.ansi[14] = O(e.brightCyan, q[14]), t.ansi[15] = O(e.brightWhite, q[15]), e.extendedAnsi) {
				let n = Math.min(t.ansi.length - 16, e.extendedAnsi.length);
				for (let r = 0; r < n; r++) t.ansi[r + 16] = O(e.extendedAnsi[r], q[r + 16]);
			}
		...
		constructor() {
			this._services = new Yo(), this._services.set(Hn, this);
		}
		setService(e, t) {
		...
		createInstance(e, ...t) {
			let n = Fe(e).sort((e, t) => e.index - t.index), r = [];
			for (let t of n) {
		...
		error: 4,
		off: 5
	}, Qo = "xterm.js: ", $o = class extends N {
		constructor(e) {
			super(), this._optionsService = e, this._logLevel = 5, this._updateLogLevel(), this._register(this._optionsService.onSpecificOptionChange("logLevel", () => this._updateLogLevel())), this;
		}
		get logLevel() {
			return this._logLevel;
		}
		_updateLogLevel() {
			this._logLevel = Zo[this._optionsService.rawOptions.logLevel];
		}
		_evalLazyOptionalParams(e) {
			for (let t = 0; t < e.length; t++) typeof e[t] == "function" && (e[t] = e[t]());
		}
		_log(e, t, n) {
			this._evalLazyOptionalParams(n), e.call(console, (this._optionsService.options.logger ? "" : Qo) + t, ...n);
		}
		trace(e, ...t) {
	...
	}, $o = k([A(0, M)], $o), es = class extends N {
		constructor(e) {
			super(), this._maxLength = e, this.onDeleteEmitter = this._register(new I()), this.onDelete = this.onDeleteEmitter.event, this.onInsertEmitter = this._register(new I()), this.onInsert = this.onInsertEmitter.event, this.onTrimEmitter = this._register(new I()), this.onTrim = this.onTrimEmitter.event, this._array = Array(this._maxLength), this._startIndex = 0, this._length = 0;
		}
		get maxLength() {
	...
	}, J = 3, Y = Object.freeze(new Nn()), ts = 0, ns = 2, rs = class e {
		constructor(e, t, n = !1) {
			this.isWrapped = n, this._combined = {}, this._extendedAttrs = {}, this._data = new Uint32Array(e * J);
			let r = t || Fn.fromCharData([
				0,
				jn,
				1,
				0
		...
		get(e) {
			let t = this._data[e * J + 0], n = t & 2097151;
			return [
				this._data[e * J + 1],
				t & 2097152 ? this._combined[e] : n ? Ne(n) : "",
				t >> 22,
				t & 2097152 ? this._combined[e].charCodeAt(this._combined[e].length - 1) : n
			];
		}
		set(e, t) {
			this._data[e * J + 1] = t[0], t[1].length > 1 ? (this._combined[e] = t[1], this._data[e * J + 0] = e | 2097152 | t[2] << 22) : this._data[e * J + 0] = t[1].charCodeAt(0) | t[2] << 22;
		}
		getWidth(e) {
			return this._data[e * J + 0] >> 22;
		}
		hasWidth(e) {
			return this._data[e * J + 0] & 12582912;
		}
		getFg(e) {
			return this._data[e * J + 1];
		}
		getBg(e) {
			return this._data[e * J + 2];
		}
		hasContent(e) {
			return this._data[e * J + 0] & 4194303;
		}
		getCodePoint(e) {
			let t = this._data[e * J + 0];
			return t & 2097152 ? this._combined[e].charCodeAt(this._combined[e].length - 1) : t & 2097151;
		}
		isCombined(e) {
			return this._data[e * J + 0] & 2097152;
		}
		getString(e) {
			let t = this._data[e * J + 0];
			return t & 2097152 ? this._combined[e] : t & 2097151 ? Ne(t & 2097151) : "";
		}
		isProtected(e) {
			return this._data[e * J + 2] & 536870912;
		}
		loadCell(e, t) {
			return ts = e * J, t.content = this._data[ts + 0], t.fg = this._data[ts + 1], t.bg = this._data[ts + 2], t.content & 2097152 && (t.combinedData = this._combined[e]), t.bg & 268435456 && (t.extended = this._extendedAttrs[e]), t;
		}
		setCell(e, t) {
			t.content & 2097152 && (this._combined[e] = t.combinedData), t.bg & 268435456 && (this._extendedAttrs[e] = t.extended), this._data[e * J + 0] = t.content, this._data[e * J + 1] = t.fg, this._data[e * J + 2] = t.bg;
		}
		setCellFromCodepoint(e, t, n, r) {
			r.bg & 268435456 && (this._extendedAttrs[e] = r.extended), this._data[e * J + 0] = t | n << 22, this._data[e * J + 1] = r.fg, this._data[e * J + 2] = r.bg;
		}
		addCodepointToCell(e, t, n) {
			let r = this._data[e * J + 0];
			r & 2097152 ? this._combined[e] += Ne(t) : r & 2097151 ? (this._combined[e] = Ne(r & 2097151) + Ne(t), r &= -2097152, r |= 2097152) : r = t | 1 << 22, n && (r &= -12582913, r |= n << 22), this._data[e * J + 0] = r;
		}
		insertCells(e, t, n) {
			if (e %= this.length, e && this.getWidth(e - 1) === 2 && this.setCellFromCodepoint(e - 1, 0, 1, n), t < this.length - e) {
				let r = new Fn();
				for (let n = this.length - e - t - 1; n >= 0; --n) this.setCell(e + t + n, this.loadCell(e + n, r));
		...
		deleteCells(e, t, n) {
			if (e %= this.length, t < this.length - e) {
				let r = new Fn();
				for (let n = 0; n < this.length - e - t; ++n) this.setCell(e + n, this.loadCell(e + t + n, r));
		...
		resize(e, t) {
			if (e === this.length) return this._data.length * 4 * ns < this._data.buffer.byteLength;
			let n = e * J;
			if (e > this.length) {
			...
			return this.length = e, n * 4 * ns < this._data.buffer.byteLength;
		}
		cleanupMemory() {
			if (this._data.length * 4 * ns < this._data.buffer.byteLength) {
		...
		copyFrom(e) {
			this.length === e.length ? this._data.set(e._data) : this._data = new Uint32Array(e._data), this.length = e.length, this._combined = {};
		...
		getTrimmedLength() {
			for (let e = this.length - 1; e >= 0; --e) if (this._data[e * J + 0] & 4194303) return e + (this._data[e * J + 0] >> 22);
			return 0;
		}
		getNoBgTrimmedLength() {
			for (let e = this.length - 1; e >= 0; --e) if (this._data[e * J + 0] & 4194303 || this._data[e * J + 2] & 50331648) return e + (this._data[e * J + 0] >> 22);
			return 0;
		}
		copyCellsFrom(e, t, n, r, i) {
			let a = e._data;
			if (i) for (let i = r - 1; i >= 0; i--) {
				for (let e = 0; e < J; e++) this._data[(n + i) * J + e] = a[(t + i) * J + e];
				a[(t + i) * J + 2] & 268435456 && (this._extendedAttrs[n + i] = e._extendedAttrs[t + i]);
			}
		...
		translateToString(e, t, n, r) {
			...
			let i = "";
			for (; t < n;) {
				let e = this._data[t * J + 0], n = e & 2097151, a = e & 2097152 ? this._combined[t] : n ? Ne(n) : Mn;
		...
		constructor(t) {
			this.line = t, this.isDisposed = !1, this._disposables = [], this._id = e._nextId++, this._onDispose = this.register(new I()), this.onDispose = this._onDispose.event;
		}
		get id() {
			return this._id;
		}
		dispose() {
			this.isDisposed || (this.isDisposed = !0, this.line = -1, this._onDispose.fire(), Qe(this._disposables), this._disposables.length = 0);
		}
		register(e) {
			return this._disposables.push(e), e;
		}
	}, is._nextId = 1, as = is, X = {}, os = X.B, X[0] = {
		"`": "◆",
		a: "▒",
		b: "␉",
		c: "␌",
		...
		"}": "ü",
		"~": "û"
	}, ss = 4294967295, cs = class {
		constructor(e, t, n) {
			this._hasScrollback = e, this._optionsService = t, this._bufferService = n, this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.tabs = {}, this.savedY = 0, this.savedX = 0, this.savedCurAttrData = Y.clone(), this.savedCharset = os, this.markers = [], this._nullCell = Fn.fromCharData([
				0,
				jn,
				1,
				0
			]), this._whitespaceCell = Fn.fromCharData([
				0,
				Mn,
				1,
				32
			]), this._isClearing = !1, this._memoryCleanupQueue = new ko(), this._memoryCleanupPosition = 0, this._cols = this._bufferService.cols, this._rows = this._bufferService.rows, this.lines = new es(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
		}
		getNullCell(e) {
			return e ? (this._nullCell.fg = e.fg, this._nullCell.bg = e.bg, this._nullCell.extended = e.extended) : (this._nullCell.fg = 0, this._nullCell.bg = 0, this._nullCell.extended = new Pn()), this._nullCell;
		}
		getWhitespaceCell(e) {
			return e ? (this._whitespaceCell.fg = e.fg, this._whitespaceCell.bg = e.bg, this._whitespaceCell.extended = e.extended) : (this._whitespaceCell.fg = 0, this._whitespaceCell.bg = 0, this._whitespaceCell.extended = new Pn()), this._whitespaceCell;
		}
		getBlankLine(e, t) {
			return new rs(this._bufferService.cols, this.getNullCell(e), t);
		}
		get hasScrollback() {
		...
		clear() {
			this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.lines = new es(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
		}
		resize(e, t) {
			let n = this.getNullCell(Y), r = 0, i = this._getCorrectBufferLength(t);
			if (i > this.lines.maxLength && (this.lines.maxLength = i), this.lines.length > 0) {
				...
				let a = 0;
				if (this._rows < t) for (let r = this._rows; r < t; r++) this.lines.length < t + this.ybase && (this._optionsService.rawOptions.windowsMode || this._optionsService.rawOptions.windowsPty.backend !== void 0 || this._optionsService.rawOptions.windowsPty.buildNumber !== void 0 ? this.lines.push(new rs(e, n)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + a + 1 ? (this.ybase--, a++, this.ydisp > 0 && this.ydisp--) : this.lines.push(new rs(e, n)));
		...
		_reflowLarger(e, t) {
			let n = this._optionsService.rawOptions.reflowCursorLine, r = rn(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(Y), n);
			if (r.length > 0) {
				let n = an(this.lines, r);
				on(this.lines, n.layout), this._reflowLargerAdjustViewport(e, t, n.countRemoved);
			}
		}
		_reflowLargerAdjustViewport(e, t, n) {
			let r = this.getNullCell(Y), i = n;
			for (; i-- > 0;) this.ybase === 0 ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new rs(e, r))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
			this.savedY = Math.max(this.savedY - n, 0);
		}
		_reflowSmaller(e, t) {
			let n = this._optionsService.rawOptions.reflowCursorLine, r = this.getNullCell(Y), i = [], a = 0;
			for (let o = this.lines.length - 1; o >= 0; o--) {
				...
				let l = c[c.length - 1].getTrimmedLength(), u = sn(c, this._cols, e), d = u.length - c.length, f;
				f = this.ybase === 0 && this.y !== this.lines.length - 1 ? Math.max(0, this.y - this.lines.maxLength + d) : Math.max(0, this.lines.length - this.lines.maxLength + d);
				let p = [];
				for (let e = 0; e < d; e++) {
					let e = this.getBlankLine(Y, !0);
					p.push(e);
				}
				p.length > 0 && (i.push({
					start: o + c.length + a,
				...
				let m = u.length - 1, h = u[m];
				h === 0 && (m--, h = u[m]);
				let g = c.length - d - 1, _ = l;
				for (; g >= 0;) {
					let e = Math.min(_, h);
					if (c[m] === void 0) break;
					c[m].copyCellsFrom(c[g], _ - e, h - e, e, !0), h -= e, h === 0 && (m--, h = u[m]), _ -= e, _ === 0 && (g--, _ = cn(c, Math.max(g, 0), this._cols));
				}
				for (let t = 0; t < c.length; t++) u[t] < e && c[t].setCell(u[t], r);
				let v = d - f;
				for (; v-- > 0;) this.ybase === 0 ? this.y < t - 1 ? (this.y++, this.lines.pop()) : (this.ybase++, this.ydisp++) : this.ybase < Math.min(this.lines.maxLength, this.lines.length + a) - t && (this.ybase === this.ydisp && this.ydisp++, this.ybase++);
				this.savedY = Math.min(this.savedY + d, this.ybase + t - 1);
			}
			if (i.length > 0) {
				let e = [], t = [];
				for (let e = 0; e < this.lines.length; e++) t.push(this.lines.get(e));
				let n = this.lines.length, r = n - 1, o = 0, s = i[o];
				this.lines.length = Math.min(this.lines.maxLength, this.lines.length + a);
				let c = 0;
				for (let l = Math.min(this.lines.maxLength - 1, n + a - 1); l >= 0; l--) if (s && s.start > r + c) {
					for (let e = s.newLines.length - 1; e >= 0; e--) this.lines.set(l--, s.newLines[e]);
					l++, e.push({
						index: r + 1,
						amount: s.newLines.length
					}), c += s.newLines.length, s = i[++o];
		...
		reset() {
			this._normal = new cs(!0, this._optionsService, this._bufferService), this._normal.fillViewportRows(), this._alt = new cs(!1, this._optionsService, this._bufferService), this._activeBuffer = this._normal, this._onBufferActivate.fire({
	...
	}, us = 2, ds = 1, fs = class extends N {
		constructor(e) {
			super(), this.isUserScrolling = !1, this._onResize = this._register(new I()), this.onResize = this._onResize.event, this._onScroll = this._register(new I()), this.onScroll = this._onScroll.event, this.cols = Math.max(e.rawOptions.cols || 0, us), this.rows = Math.max(e.rawOptions.rows || 0, ds), this.buffers = this._register(new ls(e, this)), this._register(this.buffers.onBufferActivate((e) => {
		...
		scroll(e, t = !1) {
			...
			let i = n.ybase + n.scrollTop, a = n.ybase + n.scrollBottom;
			if (n.scrollTop === 0) {
				let e = n.lines.isFull;
				a === n.lines.length - 1 ? e ? n.lines.recycle().copyFrom(r) : n.lines.push(r.clone()) : n.lines.splice(a + 1, 0, r.clone()), e ? this.isUserScrolling && (n.ydisp = Math.max(n.ydisp - 1, 0)) : (n.ybase++, this.isUserScrolling || n.ydisp++);
			} else {
				let e = a - i + 1;
		...
		constructor(e) {
			super(), this._onOptionChange = this._register(new I()), this.onOptionChange = this._onOptionChange.event;
			let t = { ...ps };
			...
			this.rawOptions = t, this.options = { ...t }, this._setupOptions(), this._register(T(() => {
		...
		_setupOptions() {
			let e = (e) => {
				if (!(e in ps)) throw Error(`No option with key "${e}"`);
		...
		_sanitizeAndValidateOption(e, t) {
			switch (e) {
				case "cursorStyle":
					if (t ||= ps[e], !ln(t)) throw Error(`"${t}" is not a valid value for ${e}`);
					break;
				case "wordSeparator":
					t ||= ps[e];
					break;
	...
	}, gs = Object.freeze({ insertMode: !1 }), _s = Object.freeze({
		...
		constructor(e, t, n) {
			super(), this._bufferService = e, this._logService = t, this._optionsService = n, this.isCursorInitialized = !1, this.isCursorHidden = !1, this._onData = this._register(new I()), this.onData = this._onData.event, this._onUserInput = this._register(new I()), this.onUserInput = this._onUserInput.event, this._onBinary = this._register(new I()), this.onBinary = this._onBinary.event, this._onRequestScrollToBottom = this._register(new I()), this.onRequestScrollToBottom = this._onRequestScrollToBottom.event, this.modes = un(gs), this.decPrivateModes = un(_s);
		}
		reset() {
			this.modes = un(gs), this.decPrivateModes = un(_s);
		}
		...
		SGR: (e) => {
			...
			return `\x1B[<${dn(e, !0)};${e.col};${e.row}${t}`;
		},
		SGR_PIXELS: (e) => {
			let t = e.action === 0 && e.button !== 4 ? "m" : "M";
			return `\x1B[<${dn(e, !0)};${e.x};${e.y}${t}`;
		}
	}, Ss = class extends N {
		constructor(e, t, n) {
			super(), this._bufferService = e, this._coreService = t, this._optionsService = n, this._protocols = {}, this._encodings = {}, this._activeProtocol = "", this._activeEncoding = "", this._lastEvent = null, this._wheelPartialScroll = 0, this._onProtocolChange = this._register(new I()), this.onProtocolChange = this._onProtocolChange.event;
			for (let e of Object.keys(ys)) this.addProtocol(e, ys[e]);
			for (let e of Object.keys(xs)) this.addEncoding(e, xs[e]);
			this.reset();
		}
		addProtocol(e, t) {
			this._protocols[e] = t;
		...
		constructor() {
			if (this.version = "6", !Z) {
				...
				for (let e = 0; e < Cs.length; ++e) Z.fill(0, Cs[e][0], Cs[e][1] + 1);
			}
		}
		wcwidth(e) {
			return e < 32 ? 0 : e < 127 ? 1 : e < 65536 ? Z[e] : fn(e, ws) ? 0 : e >= 131072 && e <= 196605 || e >= 196608 && e <= 262141 ? 2 : 1;
		}
		charProperties(e, t) {
			let n = this.wcwidth(e), r = n === 0 && t !== 0;
			if (r) {
				let e = Es.extractWidth(t);
				e === 0 ? r = !1 : e > n && (n = e);
			}
			return Es.createPropertyValue(0, n, r);
		}
	}, Es = class e {
		constructor() {
			this._providers = Object.create(null), this._active = "", this._onChange = new I(), this.onChange = this._onChange.event;
			let e = new Ts();
		...
		getStringCellWidth(t) {
			...
			for (let a = 0; a < i; ++a) {
				...
				if (55296 <= o && o <= 56319) {
					...
					56320 <= e && e <= 57343 ? o = (o - 55296) * 1024 + e - 56320 + 65536 : n += this.wcwidth(e);
				}
				let s = this.charProperties(o, r), c = e.extractWidth(s);
	...
	}, Os = 2147483647, ks = 256, As = class e {
		constructor(e = 32, t = 32) {
			if (this.maxLength = e, this.maxSubParamsLength = t, t > ks) throw Error("maxSubParamsLength must not be greater than 256");
		...
		static fromArray(t) {
			...
			for (let e = +!!Array.isArray(t[0]); e < t.length; ++e) {
				let r = t[e];
		...
		addParam(e) {
			...
			this._subParamsIdx[this.length] = this._subParamsLength << 8 | this._subParamsLength, this.params[this.length++] = e > Os ? Os : e;
		}
		addSubParam(e) {
			if (this._digitIsSub = !0, this.length) {
				...
				if (e < -1) throw Error("values lesser than -1 are not allowed");
				this._subParams[this._subParamsLength++] = e > Os ? Os : e, this._subParamsIdx[this.length - 1]++;
			}
		}
		hasSubParams(e) {
		...
		addDigit(e) {
			...
			n[t - 1] = ~r ? Math.min(r * 10 + e, Os) : e;
		}
	}, js = [], Ms = class {
		constructor() {
			this._state = 0, this._active = js, this._id = -1, this._handlers = Object.create(null), this._handlerFb = () => {}, this._stack = {
				paused: !1,
				loopPosition: 0,
				fallThrough: !1
			};
		...
		dispose() {
			this._handlers = Object.create(null), this._handlerFb = () => {}, this._active = js;
		}
		reset() {
			...
			this._stack.paused = !1, this._active = js, this._id = -1, this._state = 0;
		}
		_start() {
			if (this._active = this._handlers[this._id] || js, !this._active.length) this._handlerFb(this._id, "START");
			else for (let e = this._active.length - 1; e >= 0; e--) this._active[e].start();
		}
		_put(e, t, n) {
			if (!this._active.length) this._handlerFb(this._id, "PUT", Pe(e, t, n));
		...
		put(e, t, n) {
			...
			if (this._state !== 0) {
				...
				this._active = js, this._id = -1, this._state = 0;
			}
		}
	}, Q = class {
		constructor(e) {
		...
		put(e, t, n) {
			this._hitLimit || (this._data += Pe(e, t, n), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
		}
		end(e) {
			let t = !1;
		...
		constructor() {
			this._handlers = Object.create(null), this._active = Ns, this._ident = 0, this._handlerFb = () => {}, this._stack = {
				paused: !1,
				loopPosition: 0,
				fallThrough: !1
			};
		...
		dispose() {
			this._handlers = Object.create(null), this._handlerFb = () => {}, this._active = Ns;
		}
		registerHandler(e, t) {
			this._handlers[e] === void 0 && (this._handlers[e] = []);
			let n = this._handlers[e];
		...
		reset() {
			...
			this._stack.paused = !1, this._active = Ns, this._ident = 0;
		}
		hook(e, t) {
			if (this.reset(), this._ident = e, this._active = this._handlers[e] || Ns, !this._active.length) this._handlerFb(this._ident, "HOOK", t);
			else for (let e = this._active.length - 1; e >= 0; e--) this._active[e].hook(t);
		}
		put(e, t, n) {
			if (!this._active.length) this._handlerFb(this._ident, "PUT", Pe(e, t, n));
			else for (let r = this._active.length - 1; r >= 0; r--) this._active[r].put(e, t, n);
		}
		unhook(e, t = !0) {
			...
			this._active = Ns, this._ident = 0;
		}
	}, Fs = new As(), Fs.addParam(0), Is = class {
		constructor(e) {
		...
		unhook(e) {
			let t = !1;
			if (this._hitLimit) t = !1;
			else if (e && (t = this._handler(this._data, this._params), t instanceof Promise)) return t.then((e) => (this._params = Fs, this._data = "", this._hitLimit = !1, e));
		...
		let e = new Ls(4095), t = Array.apply(null, Array(256)).map((e, t) => t), n = (e, n) => t.slice(e, n), r = n(32, 127), i = n(0, 24);
		i.push(25), i.push.apply(i, n(28, 32));
		let a = n(0, 14), o;
		for (o in e.setDefault(1, 0), e.addMany(r, 0, 2, 0), a) e.addMany([
			24,
			26,
			153,
			154
		], o, 3, 0), e.addMany(n(128, 144), o, 3, 0), e.addMany(n(144, 152), o, 3, 0), e.add(156, o, 0, 0), e.add(27, o, 11, 1), e.add(157, o, 4, 8), e.addMany([
			152,
			158,
			159
		...
		return e.addMany(i, 0, 3, 0), e.addMany(i, 1, 3, 1), e.add(127, 1, 0, 1), e.addMany(i, 8, 0, 8), e.addMany(i, 3, 3, 3), e.add(127, 3, 0, 3), e.addMany(i, 4, 3, 4), e.add(127, 4, 0, 4), e.addMany(i, 6, 3, 6), e.addMany(i, 5, 3, 5), e.add(127, 5, 0, 5), e.addMany(i, 2, 3, 2), e.add(127, 2, 0, 2), e.add(93, 1, 4, 8), e.addMany(r, 8, 5, 8), e.add(127, 8, 5, 8), e.addMany([
			...
			26,
			7
		], 8, 6, 0), e.addMany(n(28, 32), 8, 0, 8), e.addMany([
			88,
			94,
			95
		], 1, 0, 7), e.addMany(r, 7, 0, 7), e.addMany(i, 7, 0, 7), e.add(156, 7, 0, 0), e.add(127, 7, 0, 7), e.add(91, 1, 11, 3), e.addMany(n(64, 127), 3, 7, 0), e.addMany(n(48, 60), 3, 8, 4), e.addMany([
			60,
			61,
			62,
			63
			...
			90,
			92
		], 1, 10, 0), e.addMany(n(96, 127), 1, 10, 0), e.add(80, 1, 11, 9), e.addMany(i, 9, 0, 9), e.add(127, 9, 0, 9), e.addMany(n(28, 32), 9, 0, 9), e.addMany(n(32, 48), 9, 9, 12), e.addMany(n(48, 60), 9, 8, 10), e.addMany([
			60,
			61,
			62,
			63
		], 9, 9, 10), e.addMany(i, 11, 0, 11), e.addMany(n(32, 128), 11, 0, 11), e.addMany(n(28, 32), 11, 0, 11), e.addMany(i, 10, 0, 10), e.add(127, 10, 0, 10), e.addMany(n(28, 32), 10, 0, 10), e.addMany(n(48, 60), 10, 8, 10), e.addMany([
			60,
			61,
			62,
			63
		], 10, 0, 11), e.addMany(n(32, 48), 10, 9, 12), e.addMany(i, 12, 0, 12), e.add(127, 12, 0, 12), e.addMany(n(28, 32), 12, 0, 12), e.addMany(n(32, 48), 12, 9, 12), e.addMany(n(48, 64), 12, 0, 11), e.addMany(n(64, 127), 12, 12, 13), e.addMany(n(64, 127), 10, 12, 13), e.addMany(n(64, 127), 9, 12, 13), e.addMany(i, 13, 13, 13), e.addMany(r, 13, 13, 13), e.add(127, 13, 0, 13), e.addMany([
			27,
			156,
			24,
			26
		], 13, 14, 0), e.add(Rs, 0, 2, 0), e.add(Rs, 8, 5, 8), e.add(Rs, 6, 0, 6), e.add(Rs, 11, 0, 11), e.add(Rs, 13, 13, 13), e;
	}(), Bs = class extends N {
		constructor(e = zs) {
			super(), this._transitions = e, this._parseStack = {
				...
				transition: 0,
				chunkPos: 0
			}, this.initialState = 0, this.currentState = this.initialState, this._params = new As(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0, this._printHandlerFb = (e, t, n) => {}, this._executeHandlerFb = (e) => {}, this._csiHandlerFb = (e, t) => {}, this._escHandlerFb = (e) => {}, this._errorHandlerFb = (e) => e, this._printHandler = this._printHandlerFb, this._executeHandlers = Object.create(null), this._csiHandlers = Object.create(null), this._escHandlers = Object.create(null), this._register(T(() => {
				this._csiHandlers = Object.create(null), this._executeHandlers = Object.create(null), this._escHandlers = Object.create(null);
			})), this._oscParser = this._register(new Ms()), this._dcsParser = this._register(new Ps()), this._errorHandler = this._errorHandlerFb, this.registerEscHandler({ final: "\\" }, () => !0);
		}
		_identifier(e, t = [64, 126]) {
			let n = 0;
			if (e.prefix) {
				if (e.prefix.length > 1) throw Error("only one byte as prefix supported");
				if (n = e.prefix.charCodeAt(0), n && 60 > n || n > 63) throw Error("prefix must be in range 0x3c .. 0x3f");
			}
			if (e.intermediates) {
		...
		parse(e, t, n) {
			...
			if (this._parseStack.state) if (this._parseStack.state === 2) this._parseStack.state = 0, a = this._parseStack.chunkPos + 1;
				...
				switch (this._parseStack.state) {
					case 3:
						if (n === !1 && i > -1) {
							for (; i >= 0 && (o = t[i](this._params), o !== !0); i--) if (o instanceof Promise) return this._parseStack.handlerPos = i, o;
						}
						this._parseStack.handlers = [];
						break;
					case 4:
						if (n === !1 && i > -1) {
							for (; i >= 0 && (o = t[i](), o !== !0); i--) if (o instanceof Promise) return this._parseStack.handlerPos = i, o;
						}
						this._parseStack.handlers = [];
						break;
					case 6:
						if (r = e[this._parseStack.chunkPos], o = this._dcsParser.unhook(r !== 24 && r !== 26, n), o) return o;
						r === 27 && (this._parseStack.transition |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0;
						break;
					case 5:
						if (r = e[this._parseStack.chunkPos], o = this._oscParser.end(r !== 24 && r !== 26, n), o) return o;
						r === 27 && (this._parseStack.transition |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0;
						break;
				}
				this._parseStack.state = 0, a = this._parseStack.chunkPos + 1, this.precedingJoinState = 0, this.currentState = this._parseStack.transition & 15;
			}
			for (let n = a; n < t; ++n) {
				switch (r = e[n], i = this._transitions.table[this.currentState << 8 | (r < 160 ? r : Rs)], i >> 4) {
					case 2:
						for (let i = n + 1;; ++i) {
							if (i >= t || (r = e[i]) < 32 || r > 126 && r < Rs) {
					...
					case 1:
						...
						break;
					case 7:
						let a = this._csiHandlers[this._collect << 8 | r], s = a ? a.length - 1 : -1;
						for (; s >= 0 && (o = a[s](this._params), o !== !0); s--) if (o instanceof Promise) return this._preserveStack(3, a, s, i, n), o;
						s < 0 && this._csiHandlerFb(this._collect << 8 | r, this._params), this.precedingJoinState = 0;
						break;
					case 8:
						do
							switch (r) {
					...
					case 9:
						...
						break;
					case 10:
						let c = this._escHandlers[this._collect << 8 | r], l = c ? c.length - 1 : -1;
						for (; l >= 0 && (o = c[l](), o !== !0); l--) if (o instanceof Promise) return this._preserveStack(4, c, l, i, n), o;
					...
					case 12:
						...
						break;
					case 13:
						for (let i = n + 1;; ++i) if (i >= t || (r = e[i]) === 24 || r === 26 || r === 27 || r > 127 && r < Rs) {
							this._dcsParser.put(e, n, i), n = i - 1;
							break;
						}
						break;
					case 14:
						if (o = this._dcsParser.unhook(r !== 24 && r !== 26), o) return this._preserveStack(6, [], 0, i, n), o;
						r === 27 && (i |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0;
						break;
					case 4:
						this._oscParser.start();
						break;
					case 5:
						for (let i = n + 1;; i++) if (i >= t || (r = e[i]) < 32 || r > 127 && r < Rs) {
							this._oscParser.put(e, n, i), n = i - 1;
							break;
						}
						break;
					case 6:
						if (o = this._oscParser.end(r !== 24 && r !== 26), o) return this._preserveStack(5, [], 0, i, n), o;
						r === 27 && (i |= 1), this._params.reset(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0;
						break;
				}
	...
	}, Vs = /^([\da-f])\/([\da-f])\/([\da-f])$|^([\da-f]{2})\/([\da-f]{2})\/([\da-f]{2})$|^([\da-f]{3})\/([\da-f]{3})\/([\da-f]{3})$|^([\da-f]{4})\/([\da-f]{4})\/([\da-f]{4})$/, Hs = /^[\da-f]+$/, Us = {
		"(": 0,
		")": 1,
		"*": 2,
		"+": 3,
		"-": 1,
		".": 2
	}, Ws = 131072, Gs = 10, Ks = 5e3, qs = 0, Js = class extends N {
		constructor(e, t, n, r, i, a, o, s, c = new Bs()) {
			super(), this._bufferService = e, this._charsetService = t, this._coreService = n, this._logService = r, this._optionsService = i, this._oscLinkService = a, this._coreMouseService = o, this._unicodeService = s, this._parser = c, this._parseBuffer = new Uint32Array(4096), this._stringDecoder = new kn(), this._utf8Decoder = new An(), this._windowTitle = "", this._iconName = "", this._windowTitleStack = [], this._iconNameStack = [], this._curAttrData = Y.clone(), this._eraseAttrDataInternal = Y.clone(), this._onRequestBell = this._register(new I()), this.onRequestBell = this._onRequestBell.event, this._onRequestRefreshRows = this._register(new I()), this.onRequestRefreshRows = this._onRequestRefreshRows.event, this._onRequestReset = this._register(new I()), this.onRequestReset = this._onRequestReset.event, this._onRequestSendFocus = this._register(new I()), this.onRequestSendFocus = this._onRequestSendFocus.event, this._onRequestSyncScrollBar = this._register(new I()), this.onRequestSyncScrollBar = this._onRequestSyncScrollBar.event, this._onRequestWindowsOptionsReport = this._register(new I()), this.onRequestWindowsOptionsReport = this._onRequestWindowsOptionsReport.event, this._onA11yChar = this._register(new I()), this.onA11yChar = this._onA11yChar.event, this._onA11yTab = this._register(new I()), this.onA11yTab = this._onA11yTab.event, this._onCursorMove = this._register(new I()), this.onCursorMove = this._onCursorMove.event, this._onLineFeed = this._register(new I()), this.onLineFeed = this._onLineFeed.event, this._onScroll = this._register(new I()), this.onScroll = this._onScroll.event, this._onTitleChange = this._register(new I()), this.onTitleChange = this._onTitleChange.event, this._onColor = this._register(new I()), this.onColor = this._onColor.event, this._parseStack = {
				paused: !1,
				cursorStartX: 0,
				cursorStartY: 0,
				decodedLength: 0,
				...
				257,
				258
			], this._register(this._parser), this._dirtyRowTracker = new Ys(this._bufferService), this._activeBuffer = this._bufferService.buffer, this._register(this._bufferService.buffers.onBufferActivate((e) => this._activeBuffer = e.activeBuffer)), this._parser.setCsiHandlerFallback((e, t) => {
				...
				intermediates: "$",
				final: "p"
			}, (e) => this.requestMode(e, !1)), this._parser.setExecuteHandler(R.BEL, () => this.bell()), this._parser.setExecuteHandler(R.LF, () => this.lineFeed()), this._parser.setExecuteHandler(R.VT, () => this.lineFeed()), this._parser.setExecuteHandler(R.FF, () => this.lineFeed()), this._parser.setExecuteHandler(R.CR, () => this.carriageReturn()), this._parser.setExecuteHandler(R.BS, () => this.backspace()), this._parser.setExecuteHandler(R.HT, () => this.tab()), this._parser.setExecuteHandler(R.SO, () => this.shiftOut()), this._parser.setExecuteHandler(R.SI, () => this.shiftIn()), this._parser.setExecuteHandler(za.IND, () => this.index()), this._parser.setExecuteHandler(za.NEL, () => this.nextLine()), this._parser.setExecuteHandler(za.HTS, () => this.tabSet()), this._parser.registerOscHandler(0, new Q((e) => (this.setTitle(e), this.setIconName(e), !0))), this._parser.registerOscHandler(1, new Q((e) => this.setIconName(e))), this._parser.registerOscHandler(2, new Q((e) => this.setTitle(e))), this._parser.registerOscHandler(4, new Q((e) => this.setOrReportIndexedColor(e))), this._parser.registerOscHandler(8, new Q((e) => this.setHyperlink(e))), this._parser.registerOscHandler(10, new Q((e) => this.setOrReportFgColor(e))), this._parser.registerOscHandler(11, new Q((e) => this.setOrReportBgColor(e))), this._parser.registerOscHandler(12, new Q((e) => this.setOrReportCursorColor(e))), this._parser.registerOscHandler(104, new Q((e) => this.restoreIndexedColor(e))), this._parser.registerOscHandler(110, new Q((e) => this.restoreFgColor(e))), this._parser.registerOscHandler(111, new Q((e) => this.restoreBgColor(e))), this._parser.registerOscHandler(112, new Q((e) => this.restoreCursorColor(e))), this._parser.registerEscHandler({ final: "7" }, () => this.saveCursor()), this._parser.registerEscHandler({ final: "8" }, () => this.restoreCursor()), this._parser.registerEscHandler({ final: "D" }, () => this.index()), this._parser.registerEscHandler({ final: "E" }, () => this.nextLine()), this._parser.registerEscHandler({ final: "H" }, () => this.tabSet()), this._parser.registerEscHandler({ final: "M" }, () => this.reverseIndex()), this._parser.registerEscHandler({ final: "=" }, () => this.keypadApplicationMode()), this._parser.registerEscHandler({ final: ">" }, () => this.keypadNumericMode()), this._parser.registerEscHandler({ final: "c" }, () => this.fullReset()), this._parser.registerEscHandler({ final: "n" }, () => this.setgLevel(2)), this._parser.registerEscHandler({ final: "o" }, () => this.setgLevel(3)), this._parser.registerEscHandler({ final: "|" }, () => this.setgLevel(3)), this._parser.registerEscHandler({ final: "}" }, () => this.setgLevel(2)), this._parser.registerEscHandler({ final: "~" }, () => this.setgLevel(1)), this._parser.registerEscHandler({
				intermediates: "%",
				final: "@"
			...
			for (let e in X) this._parser.registerEscHandler({
				intermediates: "(",
				final: e
			...
			this._parser.registerEscHandler({
				...
				intermediates: "$",
				final: "q"
			}, new Is((e, t) => this.requestStatusString(e, t)));
		}
		getAttrData() {
		...
		_logSlowResolvingAsync(e) {
			this._logService.logLevel <= 3 && Promise.race([e, new Promise((e, t) => setTimeout(() => t("#SLOW_TIMEOUT"), Ks))]).catch((e) => {
				if (e !== "#SLOW_TIMEOUT") throw e;
				console.warn(`async parser handler taking longer than ${Ks} ms`);
			});
		}
		_getCurrentLinkId() {
		...
		parse(e, t) {
			let n, r = this._activeBuffer.x, i = this._activeBuffer.y, a = 0, o = this._parseStack.paused;
			if (o) {
				if (n = this._parser.parse(this._parseBuffer, this._parseStack.decodedLength, t)) return this._logSlowResolvingAsync(n), n;
				r = this._parseStack.cursorStartX, i = this._parseStack.cursorStartY, this._parseStack.paused = !1, e.length > Ws && (a = this._parseStack.position + Ws);
			}
			if (this._logService.logLevel <= 1 && this._logService.debug(`parsing data ${typeof e == "string" ? ` "${e}"` : ` "${Array.prototype.map.call(e, (e) => String.fromCharCode(e)).join("")}"`}`), this._logService.logLevel === 0 && this._logService.trace("parsing data (codes)", typeof e == "string" ? e.split("").map((e) => e.charCodeAt(0)) : e), this._parseBuffer.length < e.length && this._parseBuffer.length < Ws && (this._parseBuffer = new Uint32Array(Math.min(e.length, Ws))), o || this._dirtyRowTracker.clearRange(), e.length > Ws) for (let t = a; t < e.length; t += Ws) {
				let a = t + Ws < e.length ? t + Ws : e.length, o = typeof e == "string" ? this._stringDecoder.decode(e.substring(t, a), this._parseBuffer) : this._utf8Decoder.decode(e.subarray(t, a), this._parseBuffer);
				if (n = this._parser.parse(this._parseBuffer, o)) return this._preserveStack(r, i, o, t), this._logSlowResolvingAsync(n), n;
			}
			else if (!o) {
			...
			let s = this._dirtyRowTracker.end + (this._bufferService.buffer.ybase - this._bufferService.buffer.ydisp), c = this._dirtyRowTracker.start + (this._bufferService.buffer.ybase - this._bufferService.buffer.ydisp);
			c < this._bufferService.rows && this._onRequestRefreshRows.fire({
				start: Math.min(c, this._bufferService.rows - 1),
				end: Math.min(s, this._bufferService.rows - 1)
			});
		}
		print(e, t, n) {
			let r, i, a = this._charsetService.charset, o = this._optionsService.rawOptions.screenReaderMode, s = this._bufferService.cols, c = this._coreService.decPrivateModes.wraparound, l = this._coreService.modes.insertMode, u = this._curAttrData, d = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y);
			this._dirtyRowTracker.markDirty(this._activeBuffer.y), this._activeBuffer.x && n - t > 0 && d.getWidth(this._activeBuffer.x - 1) === 2 && d.setCellFromCodepoint(this._activeBuffer.x - 1, 0, 1, u);
			...
			for (let p = t; p < n; ++p) {
				...
				if (n && this._activeBuffer.x) {
					...
					for (let e = i - m; --e >= 0;) d.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, u);
					continue;
				}
				if (l && (d.insertCells(this._activeBuffer.x, i - m, this._activeBuffer.getNullCell(u)), d.getWidth(s - 1) === 2 && d.setCellFromCodepoint(s - 1, 0, 1, u)), d.setCellFromCodepoint(this._activeBuffer.x++, r, i, u), i > 0) for (; --i;) d.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, u);
			}
			this._parser.precedingJoinState = f, this._activeBuffer.x < s && n - t > 0 && d.getWidth(this._activeBuffer.x) === 0 && !d.hasContent(this._activeBuffer.x) && d.setCellFromCodepoint(this._activeBuffer.x, 0, 1, u), this._dirtyRowTracker.markDirty(this._activeBuffer.y);
		}
		registerCsiHandler(e, t) {
			return e.final === "t" && !e.prefix && !e.intermediates ? this._parser.registerCsiHandler(e, (e) => _n(e.params[0], this._optionsService.rawOptions.windowOptions) ? t(e) : !0) : this._parser.registerCsiHandler(e, t);
		}
		registerDcsHandler(e, t) {
			return this._parser.registerDcsHandler(e, new Is(t));
		}
		registerEscHandler(e, t) {
			return this._parser.registerEscHandler(e, t);
		}
		registerOscHandler(e, t) {
			return this._parser.registerOscHandler(e, new Q(t));
		}
		bell() {
		...
		_eraseInBufferLine(e, t, n, r = !1, i = !1) {
			...
			a.replaceCells(t, n, this._activeBuffer.getNullCell(this._eraseAttrData()), i), r && (a.isWrapped = !1);
		}
		...
		eraseInDisplay(e, t = !1) {
			...
			switch (e.params[0]) {
				case 0:
					...
					break;
				case 1:
					for (n = this._activeBuffer.y, this._dirtyRowTracker.markDirty(n), this._eraseInBufferLine(n, 0, this._activeBuffer.x + 1, !0, t), this._activeBuffer.x + 1 >= this._bufferService.cols && (this._activeBuffer.lines.get(n + 1).isWrapped = !1); n--;) this._resetBufferLine(n, t);
		...
		scrollDown(e) {
			let t = e.params[0] || 1;
			for (; t--;) this._activeBuffer.lines.splice(this._activeBuffer.ybase + this._activeBuffer.scrollBottom, 1), this._activeBuffer.lines.splice(this._activeBuffer.ybase + this._activeBuffer.scrollTop, 0, this._activeBuffer.getBlankLine(Y));
			return this._dirtyRowTracker.markRangeDirty(this._activeBuffer.scrollTop, this._activeBuffer.scrollBottom), !0;
		}
		scrollLeft(e) {
			if (this._activeBuffer.y > this._activeBuffer.scrollBottom || this._activeBuffer.y < this._activeBuffer.scrollTop) return !0;
		...
		repeatPrecedingCharacter(e) {
			...
			if (!t) return !0;
			let n = e.params[0] || 1, r = Es.extractWidth(t), i = this._activeBuffer.x - r, a = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).getString(i), o = new Uint32Array(a.length * n), s = 0;
		...
		sendDeviceAttributesPrimary(e) {
			return e.params[0] > 0 || (this._is("xterm") || this._is("rxvt-unicode") || this._is("screen") ? this._coreService.triggerDataEvent(R.ESC + "[?1;2c") : this._is("linux") && this._coreService.triggerDataEvent(R.ESC + "[?6c")), !0;
		}
		sendDeviceAttributesSecondary(e) {
			return e.params[0] > 0 || (this._is("xterm") ? this._coreService.triggerDataEvent(R.ESC + "[>0;276;0c") : this._is("rxvt-unicode") ? this._coreService.triggerDataEvent(R.ESC + "[>85;95;0c") : this._is("linux") ? this._coreService.triggerDataEvent(e.params[0] + "c") : this._is("screen") && this._coreService.triggerDataEvent(R.ESC + "[>83;40003;0c")), !0;
		}
		_is(e) {
		...
		setModePrivate(e) {
			for (let t = 0; t < e.length; t++) switch (e.params[t]) {
				case 1:
					...
					break;
				case 2:
					this._charsetService.setgCharset(0, os), this._charsetService.setgCharset(1, os), this._charsetService.setgCharset(2, os), this._charsetService.setgCharset(3, os);
					break;
				case 3:
		...
		_extractColor(e, t, n) {
			...
			do {
				if (r[a + i] = e.params[t + a], e.hasSubParams(t + a)) {
					let n = e.getSubParams(t + a), o = 0;
					do
						r[1] === 5 && (i = 1), r[a + o + 1 + i] = n[o];
		...
		_processSGR0(e) {
			e.fg = Y.fg, e.bg = Y.bg, e.extended = e.extended.clone(), e.extended.underlineStyle = 0, e.extended.underlineColor &= -67108864, e.updateExtended();
		}
		charAttributes(e) {
		...
		deviceStatus(e) {
			switch (e.params[0]) {
				case 5:
					this._coreService.triggerDataEvent(`${R.ESC}[0n`);
					break;
				case 6:
					let e = this._activeBuffer.y + 1, t = this._activeBuffer.x + 1;
					this._coreService.triggerDataEvent(`${R.ESC}[${e};${t}R`);
					break;
			}
			return !0;
		}
		...
		windowOptions(e) {
			if (!_n(e.params[0], this._optionsService.rawOptions.windowOptions)) return !0;
			...
			switch (e.params[0]) {
				...
				case 16:
					...
					break;
				case 18:
					this._bufferService && this._coreService.triggerDataEvent(`${R.ESC}[8;${this._bufferService.rows};${this._bufferService.cols}t`);
					break;
				case 22:
					(t === 0 || t === 2) && (this._windowTitleStack.push(this._windowTitle), this._windowTitleStack.length > Gs && this._windowTitleStack.shift()), (t === 0 || t === 1) && (this._iconNameStack.push(this._iconName), this._iconNameStack.length > Gs && this._iconNameStack.shift());
					break;
				case 23:
		...
		selectDefaultCharset() {
			return this._charsetService.setgLevel(0), this._charsetService.setgCharset(0, os), !0;
		}
		selectCharset(e) {
			return e.length === 2 ? (e[0] === "/" || this._charsetService.setgCharset(Us[e[0]], X[e[1]] || os), !0) : (this.selectDefaultCharset(), !0);
		}
		index() {
		...
		reset() {
			this._curAttrData = Y.clone(), this._eraseAttrDataInternal = Y.clone();
		}
		_eraseAttrData() {
		...
		requestStatusString(e, t) {
			let n = (e) => (this._coreService.triggerDataEvent(`${R.ESC}${e}${R.ESC}\\`), !0), r = this._bufferService.buffer, i = this._optionsService.rawOptions;
			return n(e === "\"q" ? `P1$r${+!!this._curAttrData.isProtected()}"q` : e === "\"p" ? "P1$r61;1\"p" : e === "r" ? `P1$r${r.scrollTop + 1};${r.scrollBottom + 1}r` : e === "m" ? "P1$r0m" : e === " q" ? `P1$r${{
				block: 2,
				underline: 4,
				bar: 6
			}[i.cursorStyle] - +!!i.cursorBlink} q` : "P0$r");
		}
		markRangeDirty(e, t) {
		...
		markRangeDirty(e, t) {
			e > t && (qs = e, e = t, t = qs), e < this.start && (this.start = e), t > this.end && (this.end = t);
		}
		markAllDirty() {
			this.markRangeDirty(0, this._bufferService.rows - 1);
		}
	}, Ys = k([A(0, j)], Ys), Xs = 5e7, Zs = 12, Qs = 50, $s = class extends N {
		constructor(e) {
			super(), this._action = e, this._writeBuffer = [], this._callbacks = [], this._pendingData = 0, this._bufferOffset = 0, this._isSyncWriting = !1, this._syncCalls = 0, this._didUserInput = !1, this._onWriteParsed = this._register(new I()), this.onWriteParsed = this._onWriteParsed.event;
		}
		handleUserInput() {
		...
		write(e, t) {
			if (this._pendingData > Xs) throw Error("write data discarded, use flow control to avoid losing data");
			...
			for (; this._writeBuffer.length > this._bufferOffset;) {
				...
				if (r) {
					r.catch((e) => (queueMicrotask(() => {
						throw e;
					}), Promise.resolve(!1))).then((e) => performance.now() - n >= Zs ? setTimeout(() => this._innerWrite(0, e)) : this._innerWrite(n, e));
					return;
				}
				let i = this._callbacks[this._bufferOffset];
				if (i && i(), this._bufferOffset++, this._pendingData -= e.length, performance.now() - n >= Zs) break;
			}
			this._writeBuffer.length > this._bufferOffset ? (this._bufferOffset > Qs && (this._writeBuffer = this._writeBuffer.slice(this._bufferOffset), this._callbacks = this._callbacks.slice(this._bufferOffset), this._bufferOffset = 0), setTimeout(() => this._innerWrite())) : (this._writeBuffer.length = 0, this._callbacks.length = 0, this._pendingData = 0, this._bufferOffset = 0), this._onWriteParsed.fire();
		}
	}, ec = class {
		constructor(e) {
		...
		registerLink(e) {
			...
			let a = t.addMarker(t.ybase + t.y), o = {
				id: this._nextId++,
				key: this._getEntryIdKey(n),
				data: n,
				lines: [a]
			};
			return a.onDispose(() => this._removeMarkerFromLink(o, a)), this._entriesWithId.set(o.key, o), this._dataByLinkId.set(o.id, o), o.id;
		}
		addLineToLink(e, t) {
	...
	}, ec = k([A(0, j)], ec), tc = !1, nc = class extends N {
		constructor(e) {
			super(), this._windowsWrappingHeuristics = this._register(new yr()), this._onBinary = this._register(new I()), this.onBinary = this._onBinary.event, this._onData = this._register(new I()), this.onData = this._onData.event, this._onLineFeed = this._register(new I()), this.onLineFeed = this._onLineFeed.event, this._onResize = this._register(new I()), this.onResize = this._onResize.event, this._onWriteParsed = this._register(new I()), this.onWriteParsed = this._onWriteParsed.event, this._onScroll = this._register(new I()), this._instantiationService = new Xo(), this.optionsService = this._register(new hs(e)), this._instantiationService.setService(M, this.optionsService), this._bufferService = this._register(this._instantiationService.createInstance(fs)), this._instantiationService.setService(j, this._bufferService), this._logService = this._register(this._instantiationService.createInstance($o)), this._instantiationService.setService(Un, this._logService), this.coreService = this._register(this._instantiationService.createInstance(vs)), this._instantiationService.setService(Bn, this.coreService), this.coreMouseService = this._register(this._instantiationService.createInstance(Ss)), this._instantiationService.setService(zn, this.coreMouseService), this.unicodeService = this._register(this._instantiationService.createInstance(Es)), this._instantiationService.setService(Gn, this.unicodeService), this._charsetService = this._instantiationService.createInstance(Ds), this._instantiationService.setService(Vn, this._charsetService), this._oscLinkService = this._instantiationService.createInstance(ec), this._instantiationService.setService(Wn, this._oscLinkService), this._inputHandler = this._register(new Js(this._bufferService, this._charsetService, this.coreService, this._logService, this.optionsService, this._oscLinkService, this.coreMouseService, this.unicodeService)), this._register(F.forward(this._inputHandler.onLineFeed, this._onLineFeed)), this._register(this._inputHandler), this._register(F.forward(this._bufferService.onResize, this._onResize)), this._register(F.forward(this.coreService.onData, this._onData)), this._register(F.forward(this.coreService.onBinary, this._onBinary)), this._register(this.coreService.onRequestScrollToBottom(() => this.scrollToBottom(!0))), this._register(this.coreService.onUserInput(() => this._writeBuffer.handleUserInput())), this._register(this.optionsService.onMultipleOptionChange(["windowsMode", "windowsPty"], () => this._handleWindowsPtyOptionChange())), this._register(this._bufferService.onScroll(() => {
			...
			})), this._writeBuffer = this._register(new $s((e, t) => this._inputHandler.parse(e, t))), this._register(F.forward(this._writeBuffer.onWriteParsed, this._onWriteParsed));
		}
		get onScroll() {
			return this._onScrollApi || (this._onScrollApi = this._register(new I()), this._onScroll.event((e) => {
		...
		writeSync(e, t) {
			this._logService.logLevel <= 3 && !tc && (this._logService.warn("writeSync is unreliable and will be removed soon."), tc = !0), this._writeBuffer.writeSync(e, t);
		}
		input(e, t = !0) {
			this.coreService.triggerDataEvent(e, t);
		}
		resize(e, t) {
			isNaN(e) || isNaN(t) || (e = Math.max(e, us), t = Math.max(t, ds), this._bufferService.resize(e, t));
		}
		scroll(e, t = !1) {
		...
		_enableWindowsWrappingHeuristics() {
			if (!this._windowsWrappingHeuristics.value) {
				let e = [];
				e.push(this.onLineFeed(pn.bind(null, this._bufferService))), e.push(this.registerCsiHandler({ final: "H" }, () => (pn(this._bufferService), !1))), this._windowsWrappingHeuristics.value = T(() => {
		...
		constructor(e) {
			this._getKey = e, this._array = [], this._insertedValues = [], this._flushInsertedTask = new ko(), this._isFlushingInserted = !1, this._deletedIndices = [], this._flushDeletedTask = new ko(), this._isFlushingDeleted = !1;
		}
		clear() {
		...
		delete(e) {
			...
			if (t === void 0 || ($ = this._search(t), $ === -1) || this._getKey(this._array[$]) !== t) return !1;
			do
				if (this._array[$] === e) return this._deletedIndices.length === 0 && this._flushDeletedTask.enqueue(() => this._flushDeleted()), this._deletedIndices.push($), !0;
			while (++$ < this._array.length && this._getKey(this._array[$]) === t);
			return !1;
		}
		_flushDeleted() {
			this._isFlushingDeleted = !0;
			let e = this._deletedIndices.sort((e, t) => e - t), t = 0, n = Array(this._array.length - e.length), r = 0;
		...
		*getKeyIterator(e) {
			if (this._flushCleanupInserted(), this._flushCleanupDeleted(), this._array.length !== 0 && ($ = this._search(e), !($ < 0 || $ >= this._array.length) && this._getKey(this._array[$]) === e)) do
				yield this._array[$];
	...
	}, ac = 0, oc = 0, sc = class extends N {
		constructor() {
			super(), this._decorations = new ic((e) => e?.marker.line), this._onDecorationRegistered = this._register(new I()), this.onDecorationRegistered = this._onDecorationRegistered.event, this._onDecorationRemoved = this._register(new I()), this.onDecorationRemoved = this._onDecorationRemoved.event, this._register(T(() => this.reset()));
		}
		get decorations() {
		...
		registerDecoration(e) {
			...
			if (t) {
				let e = t.marker.onDispose(() => t.dispose()), n = t.onDispose(() => {
					n.dispose(), t && (this._decorations.delete(t) && this._onDecorationRemoved.fire(t), e.dispose());
				});
		...
		*getDecorationsAtCell(e, t, n) {
			let r = 0, i = 0;
			for (let a of this._decorations.getKeyIterator(t)) r = a.options.x ?? 0, i = r + (a.options.width ?? 1), e >= r && e < i && (!n || (a.options.layer ?? "bottom") === n) && (yield a);
		}
		forEachDecorationAtCell(e, t, n, r) {
			this._decorations.forEachByKey(t, (t) => {
				ac = t.options.x ?? 0, oc = ac + (t.options.width ?? 1), e >= ac && e < oc && (!n || (t.options.layer ?? "bottom") === n) && r(t);
			});
		}
	}, cc = class extends vr {
		constructor(e) {
			super(), this.options = e, this.onRenderEmitter = this.add(new I()), this.onRender = this.onRenderEmitter.event, this._onDispose = this.add(new I()), this.onDispose = this._onDispose.event, this._cachedBg = null, this._cachedFg = null, this.marker = e.marker, this.options.overviewRulerOptions && !this.options.overviewRulerOptions.position && (this.options.overviewRulerOptions.position = "full");
		}
		...
		refresh(e, t, n) {
			this._rowCount = n, e = e === void 0 ? 0 : e, t = t === void 0 ? this._rowCount - 1 : t, this._rowStart = this._rowStart === void 0 ? e : Math.min(this._rowStart, e), this._rowEnd = this._rowEnd === void 0 ? t : Math.max(this._rowEnd, t);
		...
		constructor(e, t, n, r) {
			...
			if (this._topBoundaryFocusListener = (e) => this._handleBoundaryFocus(e, 0), this._bottomBoundaryFocusListener = (e) => this._handleBoundaryFocus(e, 1), this._rowElements[0].addEventListener("focus", this._topBoundaryFocusListener), this._rowElements[this._rowElements.length - 1].addEventListener("focus", this._bottomBoundaryFocusListener), this._accessibilityContainer.appendChild(this._rowContainer), this._liveRegion = i.createElement("div"), this._liveRegion.classList.add("live-region"), this._liveRegion.setAttribute("aria-live", "assertive"), this._accessibilityContainer.appendChild(this._liveRegion), this._liveRegionDebouncer = this._register(new uc(this._renderRows.bind(this))), !this._terminal.element) throw Error("Cannot enable accessibility before Terminal.open");
			fc ? (this._accessibilityContainer.classList.add("debug"), this._rowContainer.classList.add("debug"), this._debugRootContainer = i.createElement("div"), this._debugRootContainer.classList.add("xterm"), this._debugRootContainer.appendChild(i.createTextNode("------start a11y------")), this._debugRootContainer.appendChild(this._accessibilityContainer), this._debugRootContainer.appendChild(i.createTextNode("------end a11y------")), this._terminal.element.insertAdjacentElement("afterend", this._debugRootContainer)) : this._terminal.element.insertAdjacentElement("afterbegin", this._accessibilityContainer), this._register(this._terminal.onResize((e) => this._handleResize(e.rows))), this._register(this._terminal.onRender((e) => this._refreshRows(e.start, e.end))), this._register(this._terminal.onScroll(() => this._refreshRows())), this._register(this._terminal.onA11yChar((e) => this._handleChar(e))), this._register(this._terminal.onLineFeed(() => this._handleChar("\n"))), this._register(this._terminal.onA11yTab((e) => this._handleTab(e))), this._register(this._terminal.onKey((e) => this._handleKey(e.key))), this._register(this._terminal.onBlur(() => this._clearLiveRegion())), this._register(this._renderService.onDimensionsChange(() => this._refreshRowsDimensions())), this._register(E(i, "selectionchange", () => this._handleSelectionChange())), this._register(this._coreBrowserService.onDprChange(() => this._refreshRowsDimensions())), this._refreshRowsDimensions(), this._refreshRows(), this._register(T(() => {
				fc ? this._debugRootContainer.remove() : this._accessibilityContainer.remove(), this._rowElements.length = 0;
			}));
		}
		_handleTab(e) {
		...
		_handleChar(e) {
			this._liveRegionLineCount < dc + 1 && (this._charsToConsume.length > 0 ? this._charsToConsume.shift() !== e && (this._charsToAnnounce += e) : this._charsToAnnounce += e, e === "\n" && (this._liveRegionLineCount++, this._liveRegionLineCount === dc + 1 && (this._liveRegion.textContent += On.get())));
		}
		_clearLiveRegion() {
		...
		_renderRows(e, t) {
			...
			for (let i = e; i <= t; i++) {
				let e = n.lines.get(n.ydisp + i), t = [], a = e?.translateToString(!0, void 0, void 0, t) || "", o = (n.ydisp + i + 1).toString(), s = this._rowElements[i];
				s && (a.length === 0 ? (s.textContent = "\xA0", this._rowColumns.set(s, [0, 1])) : (s.textContent = a, this._rowColumns.set(s, t)), s.setAttribute("aria-posinset", o), s.setAttribute("aria-setsize", r), this._alignRowWidth(s));
			}
		...
		_handleBoundaryFocus(e, t) {
			...
			let i, a;
			if (t === 0 ? (i = n, a = this._rowElements.pop(), this._rowContainer.removeChild(a)) : (i = this._rowElements.shift(), a = n, this._rowContainer.removeChild(i)), i.removeEventListener("focus", this._topBoundaryFocusListener), a.removeEventListener("focus", this._bottomBoundaryFocusListener), t === 0) {
		...
		_handleSelectionChange() {
			...
			let i = ({ node: e, offset: t }) => {
				...
				return a >= this._terminal.cols && (++r, a = 0), {
					row: r,
					column: a
				};
			}, a = i(t), o = i(n);
			if (!(!a || !o)) {
				if (a.row > o.row || a.row === o.row && a.column >= o.column) throw Error("invalid range");
				this._terminal.select(a.column, a.row, (o.row - a.row) * this._terminal.cols - a.column + o.column);
			}
		}
		_handleResize(e) {
		...
		A(2, Yn),
		A(3, Zn)
	], pc), mc = class extends N {
		constructor(e, t, n, r, i) {
			super(), this._element = e, this._mouseService = t, this._renderService = n, this._bufferService = r, this._linkProviderService = i, this._linkCacheDisposables = [], this._isMouseOut = !0, this._wasResized = !1, this._activeLine = -1, this._onShowLinkUnderline = this._register(new I()), this.onShowLinkUnderline = this._onShowLinkUnderline.event, this._onHideLinkUnderline = this._register(new I()), this.onHideLinkUnderline = this._onHideLinkUnderline.event, this._register(T(() => {
			...
			})), this._register(E(this._element, "mouseleave", () => {
				this._isMouseOut = !0, this._clearCurrentLink();
			})), this._register(E(this._element, "mousemove", this._handleMouseMove.bind(this))), this._register(E(this._element, "mousedown", this._handleMouseDown.bind(this))), this._register(E(this._element, "mouseup", this._handleMouseUp.bind(this)));
		}
		get currentLink() {
		...
		_removeIntersectingLinks(e, t) {
			...
			for (let r = 0; r < t.size; r++) {
				...
				if (i) for (let t = 0; t < i.length; t++) {
					let r = i[t], a = r.link.range.start.y < e ? 0 : r.link.range.start.x, o = r.link.range.end.y > e ? this._bufferService.cols : r.link.range.end.x;
					for (let e = a; e <= o; e++) {
						if (n.has(e)) {
							i.splice(t--, 1);
							break;
		...
		_handleMouseUp(e) {
			...
			let t = this._positionFromMouseEvent(e, this._element, this._mouseService);
			t && this._mouseDownLink && bn(this._mouseDownLink.link, this._currentLink.link) && this._linkAtPosition(this._currentLink.link, t) && this._currentLink.link.activate(e, this._currentLink.link.text);
		}
		_clearCurrentLink(e, t) {
			!this._currentLink || !this._lastMouseEvent || (!e || !t || this._currentLink.link.range.start.y >= e && this._currentLink.link.range.end.y <= t) && (this._linkLeave(this._element, this._currentLink.link, this._lastMouseEvent), this._currentLink = void 0, Qe(this._linkCacheDisposables), this._linkCacheDisposables.length = 0);
		}
		_handleNewLink(e) {
		...
		A(3, j),
		A(4, tr)
	], mc), hc = class extends nc {
		constructor(e = {}) {
			super(e), this._linkifier = this._register(new yr()), this.browser = po, this._keyDownHandled = !1, this._keyDownSeen = !1, this._keyPressHandled = !1, this._unprocessedDeadKey = !1, this._accessibilityManager = this._register(new yr()), this._onCursorMove = this._register(new I()), this.onCursorMove = this._onCursorMove.event, this._onKey = this._register(new I()), this.onKey = this._onKey.event, this._onRender = this._register(new I()), this.onRender = this._onRender.event, this._onSelectionChange = this._register(new I()), this.onSelectionChange = this._onSelectionChange.event, this._onTitleChange = this._register(new I()), this.onTitleChange = this._onTitleChange.event, this._onBell = this._register(new I()), this.onBell = this._onBell.event, this._onFocus = this._register(new I()), this._onBlur = this._register(new I()), this._onA11yCharEmitter = this._register(new I()), this._onA11yTabEmitter = this._register(new I()), this._onWillOpen = this._register(new I()), this._setup(), this._decorationService = this._instantiationService.createInstance(sc), this._instantiationService.setService(Kn, this._decorationService), this._linkProviderService = this._instantiationService.createInstance(lo), this._instantiationService.setService(tr, this._linkProviderService), this._linkProviderService.registerLinkProvider(this._instantiationService.createInstance(qn)), this._register(this._inputHandler.onRequestBell(() => this._onBell.fire())), this._register(this._inputHandler.onRequestRefreshRows((e) => this.refresh(e?.start ?? 0, e?.end ?? this.rows - 1))), this._register(this._inputHandler.onRequestSendFocus(() => this._reportFocus())), this._register(this._inputHandler.onRequestReset(() => this.reset())), this._register(this._inputHandler.onRequestWindowsOptionsReport((e) => this._reportWindowsOptions(e))), this._register(this._inputHandler.onColor((e) => this._handleColorEvent(e))), this._register(F.forward(this._inputHandler.onCursorMove, this._onCursorMove)), this._register(F.forward(this._inputHandler.onTitleChange, this._onTitleChange)), this._register(F.forward(this._inputHandler.onA11yChar, this._onA11yCharEmitter)), this._register(F.forward(this._inputHandler.onA11yTab, this._onA11yTabEmitter)), this._register(this._bufferService.onResize((e) => this._afterResize(e.cols, e.rows))), this._register(T(() => {
		...
		_handleColorEvent(e) {
			if (this._themeService) for (let t of e) {
				...
				switch (t.type) {
					case 0:
						let r = W.toColorRGB(e === "ansi" ? this._themeService.colors.ansi[t.index] : this._themeService.colors[e]);
						this.coreService.triggerDataEvent(`${R.ESC}]${n};${gn(r)}${Ba.ST}`);
						break;
					case 1:
						if (e === "ansi") this._themeService.modifyColors((e) => e.ansi[t.index] = U.toColor(...t.color));
						else {
							let n = e;
							this._themeService.modifyColors((e) => e[n] = U.toColor(...t.color));
						}
						break;
					case 2:
		...
		_handleScreenReaderModeOptionChange(e) {
			e ? !this._accessibilityManager.value && this._renderService && (this._accessibilityManager.value = this._instantiationService.createInstance(pc, this)) : this._accessibilityManager.clear();
		}
		_handleTextAreaFocus(e) {
			this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(R.ESC + "[I"), this.element.classList.add("focus"), this._showCursor(), this._onFocus.fire();
		}
		blur() {
			return this.textarea?.blur();
		}
		_handleTextAreaBlur() {
			this.textarea.value = "", this.refresh(this.buffer.y, this.buffer.y), this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(R.ESC + "[O"), this.element.classList.remove("focus"), this._onBlur.fire();
		}
		_syncTextArea() {
			if (!this.textarea || !this.buffer.isCursorInViewport || this._compositionHelper.isComposing || !this._renderService) return;
			let e = this.buffer.ybase + this.buffer.y, t = this.buffer.lines.get(e);
			if (!t) return;
			let n = Math.min(this.buffer.x, this.cols - 1), r = this._renderService.dimensions.css.cell.height, i = t.getWidth(n), a = this._renderService.dimensions.css.cell.width * i, o = this.buffer.y * this._renderService.dimensions.css.cell.height, s = n * this._renderService.dimensions.css.cell.width;
			this.textarea.style.left = s + "px", this.textarea.style.top = o + "px", this.textarea.style.width = a + "px", this.textarea.style.height = r + "px", this.textarea.style.lineHeight = r + "px", this.textarea.style.zIndex = "-5";
		}
		_initGlobal() {
			this._bindKeys(), this._register(E(this.element, "copy", (e) => {
				this.hasSelection() && Oe(e, this._selectionService);
			}));
			let e = (e) => ke(e, this.textarea, this.coreService, this.optionsService);
			this._register(E(this.textarea, "paste", e)), this._register(E(this.element, "paste", e)), _o ? this._register(E(this.element, "mousedown", (e) => {
				e.button === 2 && Me(e, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
			})) : this._register(E(this.element, "contextmenu", (e) => {
				Me(e, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
			})), wo && this._register(E(this.element, "auxclick", (e) => {
				e.button === 1 && je(e, this.textarea, this.screenElement);
			}));
		}
		_bindKeys() {
			this._register(E(this.textarea, "keyup", (e) => this._keyUp(e), !0)), this._register(E(this.textarea, "keydown", (e) => this._keyDown(e), !0)), this._register(E(this.textarea, "keypress", (e) => this._keyPress(e), !0)), this._register(E(this.textarea, "compositionstart", () => this._compositionHelper.compositionstart())), this._register(E(this.textarea, "compositionupdate", (e) => this._compositionHelper.compositionupdate(e))), this._register(E(this.textarea, "compositionend", () => this._compositionHelper.compositionend())), this._register(E(this.textarea, "input", (e) => this._inputEvent(e), !0)), this._register(this.onRender(() => this._compositionHelper.updateCompositionElements()));
		}
		open(e) {
			...
			this._viewportElement = this._document.createElement("div"), this._viewportElement.classList.add("xterm-viewport"), t.appendChild(this._viewportElement), this.screenElement = this._document.createElement("div"), this.screenElement.classList.add("xterm-screen"), this._register(E(this.screenElement, "mousemove", (e) => this.updateCursorStyle(e))), this._helperContainer = this._document.createElement("div"), this._helperContainer.classList.add("xterm-helpers"), this.screenElement.appendChild(this._helperContainer), t.appendChild(this.screenElement);
			let n = this.textarea = this._document.createElement("textarea");
			this.textarea.classList.add("xterm-helper-textarea"), this.textarea.setAttribute("aria-label", En.get()), To || this.textarea.setAttribute("aria-multiline", "false"), this.textarea.setAttribute("autocorrect", "off"), this.textarea.setAttribute("autocapitalize", "off"), this.textarea.setAttribute("spellcheck", "false"), this.textarea.tabIndex = 0, this._register(this.optionsService.onSpecificOptionChange("disableStdin", () => n.readOnly = this.optionsService.rawOptions.disableStdin)), this.textarea.readOnly = this.optionsService.rawOptions.disableStdin, this._coreBrowserService = this._register(this._instantiationService.createInstance(so, this.textarea, e.ownerDocument.defaultView ?? window, this._document ?? typeof window < "u" ? window.document : null)), this._instantiationService.setService(Yn, this._coreBrowserService), this._register(E(this.textarea, "focus", (e) => this._handleTextAreaFocus(e))), this._register(E(this.textarea, "blur", () => this._handleTextAreaBlur())), this._helperContainer.appendChild(this.textarea), this._charSizeService = this._instantiationService.createInstance(ro, this._document, this._helperContainer), this._instantiationService.setService(Jn, this._charSizeService), this._themeService = this._instantiationService.createInstance(Jo), this._instantiationService.setService(er, this._themeService), this._characterJoinerService = this._instantiationService.createInstance(Ga), this._instantiationService.setService($n, this._characterJoinerService), this._renderService = this._register(this._instantiationService.createInstance(jo, this.rows, this.screenElement)), this._instantiationService.setService(Zn, this._renderService), this._register(this._renderService.onRenderedViewportChange((e) => this._onRender.fire(e))), this.onResize((e) => this._renderService.resize(e.cols, e.rows)), this._compositionView = this._document.createElement("div"), this._compositionView.classList.add("composition-view"), this._compositionHelper = this._instantiationService.createInstance(Va, this.textarea, this._compositionView), this._helperContainer.appendChild(this._compositionView), this._mouseService = this._instantiationService.createInstance(uo), this._instantiationService.setService(Xn, this._mouseService);
			let r = this._linkifier.value = this._register(this._instantiationService.createInstance(mc, this.screenElement));
			...
			})), this._register(this.onResize(() => this._renderService.handleResize(this.cols, this.rows))), this._register(this.onBlur(() => this._renderService.handleBlur())), this._register(this.onFocus(() => this._renderService.handleFocus())), this._viewport = this._register(this._instantiationService.createInstance(Ma, this.element, this.screenElement)), this._register(this._viewport.onRequestScrollLines((e) => {
				super.scrollLines(e, !1), this.refresh(0, this.rows - 1);
			})), this._selectionService = this._register(this._instantiationService.createInstance(zo, this.element, this.screenElement, r)), this._instantiationService.setService(Qn, this._selectionService), this._register(this._selectionService.onRequestScrollLines((e) => this.scrollLines(e.amount, e.suppressScrollEvent))), this._register(this._selectionService.onSelectionChange(() => this._onSelectionChange.fire())), this._register(this._selectionService.onRequestRedraw((e) => this._renderService.handleSelectionChanged(e.start, e.end, e.columnSelectMode))), this._register(this._selectionService.onLinuxMouseSelection((e) => {
				this.textarea.value = e, this.textarea.focus(), this.textarea.select();
			})), this._register(F.any(this._onScroll.event, this._inputHandler.onScroll)(() => {
				this._selectionService.refresh(), this._viewport?.queueSync();
			})), this._register(this._instantiationService.createInstance(Na, this.screenElement)), this._register(E(this.element, "mousedown", (e) => this._selectionService.handleMouseDown(e))), this.coreMouseService.areMouseEventsActive ? (this._selectionService.disable(), this.element.classList.add("enable-mouse-events")) : this._selectionService.enable(), this.options.screenReaderMode && (this._accessibilityManager.value = this._instantiationService.createInstance(pc, this)), this._register(this.optionsService.onSpecificOptionChange("screenReaderMode", (e) => this._handleScreenReaderModeOptionChange(e))), this.options.overviewRuler.width && (this._overviewRulerRenderer = this._register(this._instantiationService.createInstance(Ra, this._viewportElement, this.screenElement))), this.optionsService.onSpecificOptionChange("overviewRuler", (e) => {
				!this._overviewRulerRenderer && e && this._viewportElement && this.screenElement && (this._overviewRulerRenderer = this._register(this._instantiationService.createInstance(Ra, this._viewportElement, this.screenElement)));
			}), this._charSizeService.measure(), this.refresh(0, this.rows - 1), this._initGlobal(), this.bindMouse();
		}
		_createRenderer() {
			return this._instantiationService.createInstance(no, this, this._document, this.element, this.screenElement, this._viewportElement, this._helperContainer, this.linkifier);
		}
		bindMouse() {
			...
			function n(t) {
				...
				switch (t.overrideType || t.type) {
					...
					case "wheel":
						...
						let n = t.deltaY;
						if (n === 0 || e.coreMouseService.consumeWheelEvent(t, e._renderService?.dimensions?.device?.cell?.height, e._coreBrowserService?.dpr) === 0) return !1;
						i = n < 0 ? 0 : 1, r = 4;
						break;
					default: return !1;
				}
				return i === void 0 || r === void 0 || r > 4 ? !1 : e.coreMouseService.triggerMouseEvent({
					col: n.col,
					row: n.row,
					x: n.x,
					y: n.y,
			...
			let r = {
				...
				mouseup: (e) => (n(e), e.buttons || (this._document.removeEventListener("mouseup", r.mouseup), r.mousedrag && this._document.removeEventListener("mousemove", r.mousedrag)), this.cancel(e)),
			...
			this._register(this.coreMouseService.onProtocolChange((e) => {
				e ? (this.optionsService.rawOptions.logLevel === "debug" && this._logService.debug("Binding to mouse events:", this.coreMouseService.explainEvents(e)), this.element.classList.add("enable-mouse-events"), this._selectionService.disable()) : (this._logService.debug("Unbinding from mouse events."), this.element.classList.remove("enable-mouse-events"), this._selectionService.enable()), e & 8 ? r.mousemove ||= (t.addEventListener("mousemove", i.mousemove), i.mousemove) : (t.removeEventListener("mousemove", r.mousemove), r.mousemove = null), e & 16 ? r.wheel ||= (t.addEventListener("wheel", i.wheel, { passive: !1 }), i.wheel) : (t.removeEventListener("wheel", r.wheel), r.wheel = null), e & 2 ? r.mouseup ||= i.mouseup : (this._document.removeEventListener("mouseup", r.mouseup), r.mouseup = null), e & 4 ? r.mousedrag ||= i.mousedrag : (this._document.removeEventListener("mousemove", r.mousedrag), r.mousedrag = null);
			})), this.coreMouseService.activeProtocol = this.coreMouseService.activeProtocol, this._register(E(t, "mousedown", (e) => {
				if (e.preventDefault(), this.focus(), !(!this.coreMouseService.areMouseEventsActive || this._selectionService.shouldForceSelection(e))) return n(e), r.mouseup && this._document.addEventListener("mouseup", r.mouseup), r.mousedrag && this._document.addEventListener("mousemove", r.mousedrag), this.cancel(e);
			})), this._register(E(t, "wheel", (t) => {
				if (!r.wheel) {
					if (this._customWheelEventHandler && this._customWheelEventHandler(t) === !1) return !1;
					if (!this.buffer.hasScrollback) {
						if (t.deltaY === 0) return !1;
						if (e.coreMouseService.consumeWheelEvent(t, e._renderService?.dimensions?.device?.cell?.height, e._coreBrowserService?.dpr) === 0) return this.cancel(t, !0);
						let n = R.ESC + (this.coreService.decPrivateModes.applicationCursorKeys ? "O" : "[") + (t.deltaY < 0 ? "A" : "B");
		...
		paste(e) {
			Ae(e, this.textarea, this.coreService, this.optionsService);
		}
		...
		_keyDown(e) {
			...
			let n = yn(e, this.coreService.decPrivateModes.applicationCursorKeys, this.browser.isMac, this.options.macOptionIsMeta);
			if (this.updateCursorStyle(e), n.type === 3 || n.type === 2) {
				let t = this.rows - 1;
				return this.scrollLines(n.type === 2 ? -t : t), this.cancel(e, !0);
			}
			if (n.type === 1 && this.selectAll(), this._isThirdLevelShift(this.browser, e) || (n.cancel && this.cancel(e, !0), !n.key) || e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.key.length === 1 && e.key.charCodeAt(0) >= 65 && e.key.charCodeAt(0) <= 90) return !0;
			if (this._unprocessedDeadKey) return this._unprocessedDeadKey = !1, !0;
			if ((n.key === R.ETX || n.key === R.CR) && (this.textarea.value = ""), this._onKey.fire({
				key: n.key,
				domEvent: e
			}), this._showCursor(), this.coreService.triggerDataEvent(n.key, !0), !this.optionsService.rawOptions.screenReaderMode || e.altKey || e.ctrlKey) return this.cancel(e, !0);
		...
		_keyUp(e) {
			this._keyDownSeen = !1, !(this._customKeyEventHandler && this._customKeyEventHandler(e) === !1) && (xn(e) || this.focus(), this.updateCursorStyle(e), this._keyPressHandled = !1);
		}
		_keyPress(e) {
			let t;
		...
		clear() {
			if (!(this.buffer.ybase === 0 && this.buffer.y === 0)) {
				...
				for (let e = 1; e < this.rows; e++) this.buffer.lines.push(this.buffer.getBlankLine(Y));
		...
		_reportFocus() {
			this.element?.classList.contains("focus") ? this.coreService.triggerDataEvent(R.ESC + "[I") : this.coreService.triggerDataEvent(R.ESC + "[O");
		}
		...
		getCell(e, t) {
			if (!(e < 0 || e >= this._line.length)) return t ? (this._line.loadCell(e, t), t) : this._line.loadCell(e, new Fn());
		}
		...
		constructor(e) {
			super(), this._core = e, this._onBufferChange = this._register(new I()), this.onBufferChange = this._onBufferChange.event, this._normal = new vc(this._core.buffers.normal, "normal"), this._alternate = new vc(this._core.buffers.alt, "alternate"), this._core.buffers.onBufferActivate(() => this._onBufferChange.fire(this.active));
		}
		get active() {
	...
	}, Sc = ["cols", "rows"], Cc = 0, wc = class extends N {
		constructor(e) {
			super(), this._core = this._register(new hc(e)), this._addonManager = this._register(new gc()), this._publicOptions = { ...this._core.options };
		...
		_checkReadonlyOptions(e) {
			if (Sc.includes(e)) throw Error(`Option "${e}" can only be set in the constructor`);
		}
		_checkProposedApi() {
		...
		get parser() {
			return this._parser ||= new bc(this._core), this._parser;
		}
		get unicode() {
			return this._checkProposedApi(), new xc(this._core);
		}
		get textarea() {
		...
		get buffer() {
			return this._buffer ||= this._register(new yc(this._core)), this._buffer;
		}
		get markers() {
		...
		_verifyIntegers(...e) {
			for (Cc of e) if (Cc === Infinity || isNaN(Cc) || Cc % 1 != 0) throw Error("This API only accepts integers");
		}
		_verifyPositiveIntegers(...e) {
			for (Cc of e) if (Cc && (Cc === Infinity || isNaN(Cc) || Cc % 1 != 0 || Cc < 0)) throw Error("This API only accepts positive integers");
		}
	};
})), Ec = /* @__PURE__ */ ee({ FitAddon: () => kc }), Dc, Oc, kc, Ac = v((() => {
	Dc = 2, Oc = 1, kc = class {
		activate(e) {
			this._terminal = e;
		}
		...
		proposeDimensions() {
			...
			let t = this._terminal.options.scrollback === 0 ? 0 : this._terminal.options.overviewRuler?.width || 14, n = window.getComputedStyle(this._terminal.element.parentElement), r = parseInt(n.getPropertyValue("height")), i = Math.max(0, parseInt(n.getPropertyValue("width"))), a = window.getComputedStyle(this._terminal.element), o = {
			...
			}, s = o.top + o.bottom, c = o.right + o.left, l = r - s, u = i - c - t;
			return {
				cols: Math.max(Dc, Math.floor(u / e.css.cell.width)),
				rows: Math.max(Oc, Math.floor(l / e.css.cell.height))
			};
		}
	};
})), jc = /* @__PURE__ */ ee({ WebLinksAddon: () => Lc });
function Mc(e) {
	try {
...
var Pc, Fc, Ic, Lc, Rc = v((() => {
	Pc = class {
		constructor(e, t, n, r = {}) {
			this._terminal = e, this._regex = t, this._handler = n, this._options = r;
		}
		provideLinks(e, t) {
			let n = Fc.computeLink(e, this._regex, this._terminal, this._handler);
		...
		static computeLink(t, n, r, i) {
			let a = new RegExp(n.source, (n.flags || "") + "g"), [o, s] = e._getWindowedLineStrings(t - 1, r), c = o.join(""), l, u = [];
			for (; l = a.exec(c);) {
				let t = l[0];
				if (!Mc(t)) continue;
				let [n, a] = e._mapStrIdx(r, s, 0, l.index), [o, c] = e._mapStrIdx(r, n, a, t.length);
		...
		static _getWindowedLineStrings(e, t) {
			let n, r = e, i = e, a = 0, o = "", s = [];
			if (n = t.buffer.active.getLine(e)) {
				let e = n.translateToString(!0);
				if (n.isWrapped && e[0] !== " ") {
					for (a = 0; (n = t.buffer.active.getLine(--r)) && a < 2048 && (o = n.translateToString(!0), a += o.length, s.push(o), !(!n.isWrapped || o.indexOf(" ") !== -1)););
					s.reverse();
				}
				for (s.push(e), a = 0; (n = t.buffer.active.getLine(++i)) && n.isWrapped && a < 2048 && (o = n.translateToString(!0), a += o.length, s.push(o), o.indexOf(" ") === -1););
			}
			return [s, r];
		}
		static _mapStrIdx(e, t, n, r) {
			let i = e.buffer.active, a = i.getNullCell(), o = n;
			for (; r;) {
				let e = i.getLine(t);
				if (!e) return [-1, -1];
				for (let n = o; n < e.length; ++n) {
					e.getCell(n, a);
					let o = a.getChars();
					if (a.getWidth() && (r -= o.length || 1, n === e.length - 1 && o === "")) {
						let e = i.getLine(t + 1);
						e && e.isWrapped && (e.getCell(0, a), a.getWidth() === 2 && (r += 1));
					}
					if (r < 0) return [t, n];
				}
				t++, o = 0;
	...
	}, Ic = /(https?|HTTPS?):[/]{2}[^\s"'!*(){}|\\\^<>`]*[^\s"':,.!?{}|\\\^~\[\]`()<>]/, Lc = class {
		constructor(e = Nc, t = {}) {
			this._handler = e, this._options = t;
		}
		activate(e) {
			this._terminal = e;
			let t = this._options, n = t.urlRegex || Ic;
			this._linkProvider = this._terminal.registerLinkProvider(new Pc(this._terminal, n, this._handler, t));
		}
		dispose() {
...
//#endregion
//#region ../../../packages/tokimo-package-terminal/dist/index.js
function zc(e) {
	var t;
	(t = navigator.clipboard) == null || t.writeText(e).catch(() => {});
}
function Bc(e) {
	var t;
	(t = navigator.clipboard) == null || t.readText().then((t) => {
		t && e(t);
	}).catch(() => {});
}
function Vc(e, t = {}) {
	let { onPaste: n } = t;
	e.attachCustomKeyEventHandler((t) => {
		if (t.type !== "keydown" || !(t.ctrlKey || t.metaKey) || t.altKey || t.shiftKey) return !0;
		let r = t.key.toLowerCase();
		if (r === "c" && e.hasSelection()) {
			let n = e.getSelection();
			return n && zc(n), e.clearSelection(), t.preventDefault(), !1;
		}
		return r === "v" && n ? (Bc(n), t.preventDefault(), !1) : !0;
	});
}
var Hc = "tokimo-terminal-session-id", Uc = {
	connected: "Connected",
...
function Wc({ wsUrl: e, borderless: t = !1, sessionStorageKey: n = Hc, onConnect: r, onDisconnect: i, t: a, height: o = "100%", minHeight: s = 300 }) {
	let c = f(null), l = f(null), d = f(null), m = f(null), _ = f(null), [v, ee] = p("connecting"), te = f(a), ne = f(r), y = f(i);
	te.current = a, ne.current = r, y.current = i;
	let re = (e) => a ? a(e) : Uc[e];
	u(() => {
		if (!c.current) return;
		let t = !1, r = null;
		return (async () => {
			let { Terminal: i } = await Promise.resolve().then(() => (Tc(), Te)), { FitAddon: a } = await Promise.resolve().then(() => (Ac(), Ec)), { WebLinksAddon: o } = await Promise.resolve().then(() => (Rc(), jc));
			...
			s.loadAddon(u), s.loadAddon(new o((e, t) => {
				window.open(t, "_blank", "noopener,noreferrer");
			})), s.open(c.current), requestAnimationFrame(() => {
				if (!t) try {
					u.fit();
				} catch {}
			}), l.current = s, m.current = u, Vc(s, { onPaste: (e) => {
				r && r.readyState === WebSocket.OPEN && r.send(new TextEncoder().encode(e));
			} });
			let f = sessionStorage.getItem(n), p = f ? `${e}${e.includes("?") ? "&" : "?"}session_id=${encodeURIComponent(f)}` : e;
			r = new WebSocket(p), r.binaryType = "arraybuffer", d.current = r, r.onopen = () => {
				var e;
				t || (ee("connected"), Gc(r, s.cols, s.rows), s.focus(), (e = ne.current) == null || e.call(ne));
			}, r.onmessage = (e) => {
				if (!t) if (typeof e.data == "string") {
					...
					s.write(e.data);
				} else e.data instanceof ArrayBuffer && s.write(new Uint8Array(e.data));
			}, r.onclose = () => {
				var e;
				if (t) return;
				ee("disconnected");
				let n = te.current ? te.current("disconnected") : Uc.disconnected;
				s.write(`\r
\x1B[33m${n}\x1B[0m\r
`), (e = y.current) == null || e.call(y);
			}, r.onerror = () => {
				t || ee("error");
			}, s.onData((e) => {
				r && r.readyState === WebSocket.OPEN && r.send(new TextEncoder().encode(e));
			...
			}), s.onResize(({ cols: e, rows: t }) => {
				r && r.readyState === WebSocket.OPEN && Gc(r, e, t);
			});
			...
			h.observe(c.current), _.current = h;
		})(), () => {
			var e, n, r;
			t = !0, (e = _.current) == null || e.disconnect(), _.current = null, (n = d.current) == null || n.close(), d.current = null, (r = l.current) == null || r.dispose(), l.current = null, m.current = null;
		};
	}, [e, n]);
	let ie = re(v === "connected" ? "connected" : v === "connecting" ? "connecting" : v === "error" ? "connectFailed" : "disconnectedStatus");
	return /* @__PURE__ */ g("div", {
		className: `relative ${t ? "flex h-full flex-col" : ""}`,
		children: [!t && /* @__PURE__ */ g("div", {
			className: "absolute top-2 right-3 z-10 flex items-center gap-1.5 text-xs",
			children: [/* @__PURE__ */ h("span", { className: `inline-block h-2 w-2 rounded-full ${v === "connected" ? "bg-green-500" : v === "connecting" ? "bg-yellow-500 animate-pulse" : v === "error" ? "bg-red-500" : "bg-zinc-500"}` }), /* @__PURE__ */ h("span", {
				className: "text-zinc-400",
				children: ie
			})]
		}), /* @__PURE__ */ h("div", {
			ref: c,
			className: `overflow-hidden p-2 [&_.xterm-viewport]:!overflow-y-auto [&_.xterm-viewport]:!bg-transparent [&_.xterm]:!bg-transparent [&_.xterm]:!p-0 ${t ? "min-h-0 flex-1" : "rounded-lg border border-zinc-800"}`,
			style: t ? void 0 : {
				height: o,
				minHeight: s
			}
...
//#endregion
//#region src/components/SystemPanel.tsx
function Kc({ terminalId: e }) {
	let [t, n] = p("stats"), r = c(async () => t === "stats" ? b.stats(e) : t === "processes" ? b.ps(e) : t === "storage" ? b.df(e) : b.net(e), [e, t]), i = ae(r, [r]);
	return /* @__PURE__ */ g("div", {
		...
		children: [
			/* @__PURE__ */ g("div", {
				...
				children: [[
					...
					type: "button",
					className: `cursor-pointer rounded-md px-3 py-1.5 text-xs capitalize ${t === e ? "bg-violet-600 text-white" : "text-zinc-400 hover:bg-white/10"}`,
					onClick: () => n(e),
					children: e
				}, e)), /* @__PURE__ */ h("button", {
					type: "button",
					...
					onClick: i.reload,
					children: /* @__PURE__ */ h(xe, { className: "h-4 w-4" })
				})]
			}),
			i.error && /* @__PURE__ */ h("div", {
				className: "m-3 rounded border border-red-500/30 bg-red-500/10 p-3 text-sm text-red-200",
				children: i.error
			}),
			i.loading ? /* @__PURE__ */ h("div", {
				className: "p-4 text-sm text-zinc-500",
				children: "Loading…"
			}) : /* @__PURE__ */ h(qc, { value: i.data })
		]
	});
}
function qc({ value: e }) {
	return /* @__PURE__ */ h("pre", {
		className: "min-h-0 flex-1 overflow-auto p-4 text-xs leading-relaxed text-zinc-200",
		children: JSON.stringify(e, null, 2)
	});
}
//#endregion
//#region src/components/DockerPanel.tsx
function Jc({ terminalId: e }) {
	let [t, n] = p("ps"), r = c(() => b.docker(e, t), [e, t]), i = ae(r, [r]);
	return /* @__PURE__ */ g("div", {
		className: "flex h-full flex-col bg-zinc-950",
		children: [
			/* @__PURE__ */ g("div", {
...
//#endregion
//#region src/components/FilesPanel.tsx
function Yc({ terminalId: e }) {
	let [t, n] = p("/"), [r, i] = p(null), [a, o] = p(""), s = c(() => b.ls(e, t), [e, t]), l = ae(s, [s]), u = (r) => {
		let a = Xc(t, r.name);
		if (i(r), r.isDir) {
			n(a), o("");
			return;
		}
		b.readFile(e, a).then((e) => o(e.content)).catch((e) => o(e instanceof Error ? e.message : String(e)));
	}, d = () => {
		!r || r.isDir || b.writeFile(e, Xc(t, r.name), a).then(() => l.reload());
	}, f = (n) => {
		confirm(`Delete ${n.name}?`) && b.rm(e, Xc(t, n.name)).then(() => l.reload());
	};
	return /* @__PURE__ */ g("div", {
		className: "grid h-full grid-cols-[320px_1fr] bg-zinc-950",
		children: [/* @__PURE__ */ g("section", {
			...
			children: [
				/* @__PURE__ */ g("div", {
					...
					children: [
						/* @__PURE__ */ h("button", {
							type: "button",
							className: "cursor-pointer rounded px-2 py-1 text-xs text-zinc-300 hover:bg-white/10",
							onClick: () => n(Zc(t)),
							children: "Up"
						}),
						/* @__PURE__ */ h("button", {
							...
							onClick: () => {
								...
								n && b.mkdir(e, Xc(t, n)).then(() => l.reload());
							},
							children: "New folder"
						}),
						/* @__PURE__ */ h("button", {
				...
				/* @__PURE__ */ h("div", {
					className: "border-b border-white/10 px-3 py-2 font-mono text-xs text-zinc-400",
					children: t
				}),
				/* @__PURE__ */ g("div", {
					className: "min-h-0 flex-1 overflow-auto p-2",
					children: [l.error && /* @__PURE__ */ h("div", {
						className: "p-2 text-xs text-red-300",
						children: l.error
					}), (l.data?.entries ?? []).map((e) => /* @__PURE__ */ g("div", {
						className: "flex items-center gap-2 rounded-md px-2 py-1.5 hover:bg-white/5",
						children: [/* @__PURE__ */ g("button", {
							type: "button",
							className: "flex min-w-0 flex-1 cursor-pointer items-center gap-2 text-left",
							onClick: () => u(e),
							children: [e.isDir ? /* @__PURE__ */ h(ge, { className: "h-4 w-4 text-sky-400" }) : /* @__PURE__ */ h(he, { className: "h-4 w-4 text-zinc-400" }), /* @__PURE__ */ h("span", {
								className: "truncate text-sm text-zinc-200",
								children: e.name
							})]
						}), /* @__PURE__ */ h("button", {
							type: "button",
							className: "cursor-pointer rounded p-1 text-zinc-500 hover:bg-red-500/10 hover:text-red-300",
							onClick: () => f(e),
							children: /* @__PURE__ */ h(Ce, { className: "h-3.5 w-3.5" })
						})]
					}, e.name))]
			...
			children: [/* @__PURE__ */ g("div", {
				className: "flex items-center justify-between border-b border-white/10 px-3 py-2 text-xs text-zinc-400",
				children: [/* @__PURE__ */ h("span", { children: r?.isDir ? "Directory" : r?.name ?? "Select a file" }), /* @__PURE__ */ h("button", {
					type: "button",
					className: "cursor-pointer rounded bg-violet-600 px-2 py-1 text-white disabled:opacity-50",
					disabled: !r || r.isDir,
					onClick: d,
					children: "Save"
				})]
			}), /* @__PURE__ */ h("textarea", {
				className: "min-h-0 flex-1 resize-none bg-zinc-950 p-3 font-mono text-xs text-zinc-100 outline-none",
				value: a,
				onChange: (e) => o(e.target.value),
				placeholder: "File preview/editor"
			})]
		})]
	});
}
...
function Qc({ selected: e }) {
	let [t, n] = p("terminal"), r = d(() => crypto.randomUUID(), [e?.id]), i = d(() => crypto.randomUUID(), []);
	return e ? /* @__PURE__ */ g("main", {
		className: "flex min-w-0 flex-1 flex-col bg-zinc-950 text-zinc-100",
		children: [/* @__PURE__ */ g("header", {
			className: "flex items-center justify-between border-b border-white/10 px-4 py-3",
			children: [/* @__PURE__ */ g("div", {
				className: "flex min-w-0 items-center gap-2",
				children: [/* @__PURE__ */ h(Se, { className: "h-4 w-4 text-violet-400" }), /* @__PURE__ */ g("div", {
					className: "min-w-0",
				...
				className: "flex rounded-lg border border-white/10 bg-zinc-900 p-1 text-xs",
				children: [
					"terminal",
					"files",
					"system",
					...
					type: "button",
					className: `cursor-pointer rounded-md px-3 py-1.5 capitalize ${t === e ? "bg-violet-600 text-white" : "text-zinc-400 hover:text-zinc-100"}`,
					onClick: () => n(e),
					children: e
				}, e))
			})]
			...
			children: [
				t === "terminal" && /* @__PURE__ */ h(Wc, {
					wsUrl: ie(`/connections/ws?id=${encodeURIComponent(e.id)}&session_id=${encodeURIComponent(r)}`),
					borderless: !0,
					minHeight: 500
				}),
				t === "files" && /* @__PURE__ */ h(Yc, { terminalId: e.id }),
				t === "system" && /* @__PURE__ */ h(Kc, { terminalId: e.id }),
				t === "docker" && /* @__PURE__ */ h(Jc, { terminalId: e.id })
			]
		})]
	}) : /* @__PURE__ */ h("main", {
		className: "flex min-w-0 flex-1 flex-col bg-zinc-950 text-zinc-100",
		children: /* @__PURE__ */ g("div", {
			className: "flex flex-1 flex-col items-center justify-center gap-3 text-zinc-500",
			children: [
				/* @__PURE__ */ h(_e, { className: "h-10 w-10" }),
				/* @__PURE__ */ h("div", {
					className: "text-sm",
					children: "Select an SSH connection, or use the local terminal below."
				}),
				/* @__PURE__ */ h("div", {
					className: "h-80 w-[min(900px,80%)] overflow-hidden rounded-xl border border-white/10 bg-black",
					children: /* @__PURE__ */ h(Wc, {
						wsUrl: ie(`/local-ws?session_id=${encodeURIComponent(i)}`),
						borderless: !0,
						minHeight: 320
					})
				})
...
//#endregion
//#region src/components/TerminalApp.tsx
function $c() {
	let e = c(() => b.list(), []), t = ae(e, [e]), [n, r] = p(null), [i, a] = p(null), [o, s] = p(!1), [l, u] = p(!1), f = d(() => t.data?.find((e) => e.id === n) ?? null, [n, t.data]), m = o || i !== null;
	return /* @__PURE__ */ g("div", {
		className: "flex h-full min-h-0 bg-zinc-950 text-zinc-100",
		children: [/* @__PURE__ */ h(we, {
			...
			onDelete: (e) => {
				confirm(`Delete ${e.name}?`) && b.delete(e.id).then(() => {
					n === e.id && r(null), t.reload();
				});
			}
		}), /* @__PURE__ */ g("div", {
			className: "relative flex min-w-0 flex-1",
			children: [
				/* @__PURE__ */ h(Qc, { selected: f }),
				m && /* @__PURE__ */ h("div", {
					className: "absolute inset-y-0 right-0 w-[420px] overflow-auto border-l border-white/10 bg-zinc-950/95 p-4 shadow-2xl",
					children: /* @__PURE__ */ h(x, {
						...
						onSave: async (e) => {
							u(!0);
							try {
								r((i ? await b.update(i.id, e) : await b.create(e)).id), s(!1), a(null), t.reload();
							} finally {
								u(!1);
							}
						}
				...
				t.error && /* @__PURE__ */ h("div", {
					className: "absolute bottom-3 left-3 rounded border border-red-500/30 bg-red-500/10 px-3 py-2 text-sm text-red-200",
					children: t.error
				})
			]
		})]
...
var el = t({
	...
	mount(t, a) {
		let o = m(t);
		return o.render(/* @__PURE__ */ h(i, { children: /* @__PURE__ */ h(e, {
			value: a,
			children: /* @__PURE__ */ h(te, {
				value: a,
				children: /* @__PURE__ */ h(n, { children: /* @__PURE__ */ h(r, { children: /* @__PURE__ */ h($c, {}) }) })
			})
		}) })), () => o.unmount();
	}
});
